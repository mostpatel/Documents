	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=addPayment($_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],0,0,$_POST['ref'],$_POST['ref_type'],$_POST['oc_id'],$_POST['payment_mode_id'],$_POST['cheque_date'],$_POST['cheque_no'],$_POST['bank_name'],$_POST['branch_name']); // $cheque_return is 0 when inserting a payment			
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updatePayment($_POST["lid"],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['ref'],$_POST['ref_type'],NULL,$_POST['payment_mode_id'],$_POST['cheque_date'],$_POST['cheque_no'],$_POST['bank_name'],$_POST['branch_name']);
				if($result=="success")
				{	
