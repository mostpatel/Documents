...
<div class="mainInvoiceContainer" style="width:95%;page-break-after: always;">
   ...
   <div class="sectionOne">
          ...
          <div class="leftSectionOne">
             <img src="<?php echo WEB_ROOT."images/cash-memo.png" ?>" style="min-width:300px;min-height:48px" />   
          
          </div>   <!-- End of LeftSectionOne -->
        
          <div class="rightSectionOne">
          	
             <img src="<?php echo WEB_ROOT."images/tata-logo.png" ?>" style="max-width:500px;float:right;top:20px;position:relative" id="tata_logo" />   
