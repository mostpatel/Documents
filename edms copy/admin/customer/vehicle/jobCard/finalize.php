...
<td width="220px">Invoice No<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="invoice_no" id="invoice_no" placeholder="Only Digits!" value="<?php echo $invoice_counter; ?>" readonly="readonly" />
                            </td>
</tr> 
...
<tr>
<td width="220px">Next Service Date (<?php if($next_service_date) echo date('d/m/Y',strtotime($next_service_date)); else echo "-"; ?>) : </td>
				<td>
                <div id="datetimepicker5" class="input-append date">
