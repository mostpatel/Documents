...
<td>
<input type="text" name="customer_name" id="customer_name" class="person_name" placeholder="Only Letters" onblur="checkForDuplicateCustomerName(this.value);" autofocus="autofocus" />
</td>
</tr>
