		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=insertRelItemUnitForItemArray($_POST["items"],$_POST["base_unit_id"],$_POST["unit_id"],$_POST["rel"]);
				
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Unit Relation successfully added!";
...
$jsArray=array("jquery.validate.js","validators/addInventoryItem.js","generateBarcodeItemPage.js","dropDown.js");
