...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalSalesJObCardReports($from,$to,$city_id,$area_id_string,$agency_id_string,$type);
		
		$_SESSION['cAllSalesReport']['emi_array']=$reportArray;
		$_SESSION['cAllSalesReport']['to']=$to;
		$_SESSION['cAllSalesReport']['from']=$from;
		$_SESSION['cAllSalesReport']['city_id']=$city_id;
		$_SESSION['cAllSalesReport']['area_id_array']=$area_array;
		$_SESSION['cAllSalesReport']['agency_id']=$agency_id_array;
		$_SESSION['cAllSalesReport']['ledger_id']=$id;
		$_SESSION['cAllSalesReport']['type']=$id;
		$_SESSION['cAllSalesReport']['outstanding_amount']=$_POST['outstanding_amount'];
