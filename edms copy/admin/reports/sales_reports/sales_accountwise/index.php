...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$city_id=null;
			...
			if(isset($_POST['outstanding_amount']))
		{
		...
		$reportArray=generalSalesReports($id,$from,$to,$city_id,$area_id_string,$agency_id_string,$outstanding_amount,NULL,$group_id);
		...
		$_SESSION['cSalesReport']['group_id']=$_POST['group_id'];
	...
	else if($_GET['action']=='sendSMS')
	{
		...
		sendOutstandingForInvoiceToCustomers($customer_id_Array);
