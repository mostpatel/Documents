...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=getAllACDeliveryChallans($from,$to,$invoice);
		
		$_SESSION['cUninvoicedDeliveryChallanReport']['emi_array']=$reportArray;
		$_SESSION['cUninvoicedDeliveryChallanReport']['to']=$to;
		$_SESSION['cUninvoicedDeliveryChallanReport']['invoice']=$invoice;
		$_SESSION['cUninvoicedDeliveryChallanReport']['from']=$from;
		$_SESSION['cUninvoicedDeliveryChallanReport']['city_id']=$city_id;
		$_SESSION['cUninvoicedDeliveryChallanReport']['area_id_array']=$area_array;
		$_SESSION['cUninvoicedDeliveryChallanReport']['agency_id']=$agency_id_array;
		$_SESSION['cUninvoicedDeliveryChallanReport']['ledger_id']=$id;
		$_SESSION['cUninvoicedDeliveryChallanReport']['type']=$id;
		$_SESSION['cUninvoicedDeliveryChallanReport']['outstanding_amount']=$_POST['outstanding_amount'];
