<div class="jvp"><?php if(isset($_SESSION['cFormIssuableReport']['agency_id']) && $_SESSION['cFormIssuableReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cFormIssuableReport']['agency_id']);  } ?></div>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment no_print">Tax Form Issuable Reports</h4>
<?php 
...
<td> From Date : </td>
				<td>
				 <input autocomplete="off" type="text"  name="from_date" id="from_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cFormIssuableReport']['from'])) echo $_SESSION['cFormIssuableReport']['from']; ?>"/>	
                 </td>
</tr>
...
<td> To Date : </td>
				<td>
				 <input autocomplete="off" type="text"  name="to_date" id="to_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cFormIssuableReport']['to'])) echo $_SESSION['cFormIssuableReport']['to']; ?>"/>	
                 </td>
</tr>
...
<hr class="firstTableFinishing" />
	...
	<div class="no_print">
 <?php if(isset($_SESSION['cFormIssuableReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cFormIssuableReport']['emi_array'];
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>  
    ...
    <tr>
    	<td> From : <?php if(isset($_SESSION['cFormIssuableReport']['from']) && $_SESSION['cFormIssuableReport']['from']!="") echo $_SESSION['cFormIssuableReport']['from']; else echo "NA"; ?></td>
        <td> To : <?php if(isset($_SESSION['cFormIssuableReport']['to']) && $_SESSION['cFormIssuableReport']['to']!="") echo $_SESSION['cFormIssuableReport']['to']; else echo "NA"; ?></td>
    </tr>
    </table> 
