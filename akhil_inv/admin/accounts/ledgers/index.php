...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		...
		$result=insertLedger($_POST["name"],$_POST["postal_name"], $_POST["address"], $_POST["city"], $_POST["area"],  $_POST["pincode"], $_POST["head_id"], $_POST["contactNo"],$_POST["pan_no"],$_POST["sales_no"],$_POST['notes'],$_POST['opening_balance'],$_POST['opening_balance_cd'],NULL,0,$_POST['tax_class_id'],$_POST['cst_no'],$_POST['service_tax_no']);
		if($result!="error")
				{
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateLedger($_POST["lid"],$_POST["name"],$_POST["postal_name"], $_POST["address"], $_POST["city"], $_POST["area"],  $_POST["pincode"], $_POST["head_id"], $_POST["contactNo"],$_POST["pan_no"],$_POST["sales_no"],$_POST['notes'],$_POST['opening_balance'],$_POST['opening_balance_cd'],$_POST['tax_class_id'],$_POST['cst_no'],$_POST['service_tax_no']);
				if($result=="success")
				{
...
$jsArray=array("jquery.validate.js","jquery-ui/js/jquery-ui.min.js","validators/addLedger.js");
