...
<h4 class="headingAlignment"> <?php echo BROKER_NAME; ?>   Details</h4>
<?php 
...
<a href="<?php echo WEB_ROOT ?>admin/accounts/ledgers/broker"><input type="button" value="back" class="btn btn-success" /></a>
</td>
</tr>
</table>
</form>
