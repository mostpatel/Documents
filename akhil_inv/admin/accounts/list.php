...
<div class="rowOne">
  ...
  <div class="package">
     ...
     <a href="transactions/multi_receipt/">
     <div class="squareBox">
         <div class="imageHolder">
         </div>
     </div>
...
<div class="rowOne">
     ...
     <a href="transactions/inventory_jv/">
     <div class="squareBox">
         <div class="imageHolder">
         </div>
     </div>
...
<h4 class="headingAlignment">Accounts Settings</h4>
...
<div class="rowOne">
     ...
     <a href="account_settings/head_settings/">
     <div class="squareBox">
         <div class="imageHolder">
         </div>
     </div>
     ...
     <a href="account_settings/jv_type_settings/">
     <div class="squareBox">
         <div class="imageHolder">
         </div>
     </div>
     ...
     <a href="account_settings/inventory_jv_type_settings/">
     <div class="squareBox">
         <div class="imageHolder">
         </div>
     </div>
