...
<h4 class="headingAlignment"> Payment For <?php if(validateForNull($ledger_name)) echo $ledger_name; ?></h4>
<?php 
...
<td>By (Debit)<span class="requiredField">* </span> : </td>
				<td>
					...
					<input type="hidden" id="to_ledger_id" name="from_ledger_id" value="<?php if(is_numeric($to_ledger_id)) echo "L".$to_ledger_id; else echo "C".$to_customer_id; ?>"  /> 
