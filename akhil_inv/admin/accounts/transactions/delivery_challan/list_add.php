...
$from = date('d/m/Y',strtotime(getTodaysDateTimeBeforeDays(3)));
...
{	
$sales = getDeliveryChallansBetweenDates($from,$today);
}
...
<h4 class="headingAlignment"> <?php echo DELIVERY_CHALLAN_NAME; ?> For  <?php echo $customer['customer_name']; ?> </h4>
<?php 
...
<?php if(is_numeric($customer_id)) { ?>
<h4 class="headingAlignment">List of <?php echo DELIVERY_CHALLAN_NAME; ?> For <?php echo $customer['customer_name']; ?> </h4>
<?php } else { ?>
<h4 class="headingAlignment">List of <?php echo DELIVERY_CHALLAN_NAME; ?> For Period <?php echo "(".$from." - ".$today.")"; ?> </h4>
<?php } ?>
