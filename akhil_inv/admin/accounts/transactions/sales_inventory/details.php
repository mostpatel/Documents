...
?>
<div class="addDetailsBtnStyling no_print"> <a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/sales_inventory/index.php?view=invoice&id=<?php echo $sales_id; ?>"><button class="btn btn-success">Print Invoice</button></a>
<?php if(is_numeric($sale['to_customer_id'])) { ?>
<a href="<?php echo WEB_ROOT; ?>admin/customer/index.php?view=details&id=<?php echo $sale['to_customer_id']; ?>">
<?php } ?>
<button class="btn btn-success">Back to customer profile</button></a>    </div> 
