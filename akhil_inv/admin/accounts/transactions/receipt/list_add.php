...
if($oc_id!=$sales['oc_id'] && is_numeric($sales_id))
{
?>
<script type="text/javascript">
alert('Invoice Company Differ from current Company! Please Change The Company Before Procedding!');
</script>
<?php } ?>
...
<h4 class="headingAlignment"> Receipt For <?php if(validateForNull($ledger_name)) echo $ledger_name; ?> </h4>
<?php 
...
<?php } ?>
<?php if((isset($_GET['sales_id']) && is_numeric($_GET['sales_id']))) { ?>
<input type="hidden" name="from_sales" value="<?php echo $sales_id ?>" />
<?php } ?>
