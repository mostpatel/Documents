...
<td>Customer / Purchase Dealer<span class="requiredField">* </span> : </td>
				<td>
                    	...
                    	<option value="C<?php echo $customer_id; ?>" <?php if($payment['from_customer_id']==$customer_id) { ?> selected="selected" <?php } ?>><?php $customer = getCustomerDetailsByCustomerId($customer_id);  echo $customer['customer_name']; ?></option>
                      <?php if(is_numeric($from_ledger_id) || is_numeric($from_customer_id)) { ?>
                        <option <?php if(is_numeric($from_ledger_id)) {  ?> value="L<?php echo $from_ledger_id; ?>" <?php }else { ?> value="C<?php echo $from_customer_id; ?>"<?php } ?> <?php if($payment['from_customer_id']==$from_customer_id) { ?> selected="selected" <?php } ?> <?php if($payment['from_ledger_id']==$from_ledger_id) { ?> selected="selected" <?php } ?> ><?php echo $ledger_name; ?></option><?php } ?>
                    </select> 
