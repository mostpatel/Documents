...
<td width="220px">Invoice No<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="invoice_no" id="invoice_no" placeholder="Only Digits!" value="<?php echo $invoice_no; ?>" readonly />
                            </td>
</tr> 
...
<td width="220px">Next Service Kms<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="next_service_kms" id="next_service_kms" placeholder="Only Digits!" value="<?php echo $job_card_detials['next_service_kms']; ?>"  />
                            </td>
</tr> 
