...
<div class="mainInvoiceContainer">
    ...
    <div class="borderAround">
        ...
        <div class="sectionOne" style="min-height:0%;">
        
          <div class="leftSectionOne" style="width:50%;min-height:0%;">
                   <b style="font-size:40px;">KHUSHBU AUTO PVT. LTD.</b><br />
                   Blue Star Building, Navrangpura.
                   Ph(o) : 07926407738
          </div>   <!-- End of LeftSectionOne -->
          
          <div class="rightSectionOne" style="width:50%;">
          
            <div class="companyName"> <img src="<?php echo WEB_ROOT."images/ambica-only-logo.png" ?>" style="width:300px;float:right;padding-right:100px" />    </div>
        ...
        <div class="sectionThree">
         ...
         <br />
           ...
           Kargil Pump Gali, S.G.Highway, Sola, 
           Ahmedabad.
            <br> Mob : 99988 06696, 9974044838
         </div>
...
ટેન્ક નંબર : <?php echo $vehicle["cng_cylinder_no"]; ?>
        ...
        <div class="sectionFive" style="margin:0;">
