...
<td>Customer <span class="requiredField">* </span> : </td>
				<td>
					<input type="hidden" id="to_ledger" name="from_ledger_id" value="C<?php echo $customer_id; ?>" /> 
...
<td>Payment Type<span class="requiredField">* </span> : </td>
				<td>
					...
					{
					?>
                    <option value="<?php echo $bank_cash_ledger['receipt_type_id']; ?>" <?php if($payment['auto_rasid_type']==$bank_cash_ledger['receipt_type_id']) { ?> selected="selected" <?php } ?>><?php echo $bank_cash_ledger['receipt_type']; ?></option>			
                    <?php	
						}
					 ?>
                    </select>
