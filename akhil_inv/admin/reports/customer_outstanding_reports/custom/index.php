...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generateOutstandingReportForCustomer($to,$broker_id_string,$city_id,$area_id_string,$agency_id_string,$group_id);
		
		$_SESSION['cToBCReport']['emi_array']=$reportArray;
		$_SESSION['cToBCReport']['to']=$to;
		$_SESSION['cToBCReport']['city_id']=$city_id;
		$_SESSION['cToBCReport']['area_id_array']=$area_array;
		$_SESSION['cToBCReport']['broker_id_array']=$broker_array;
		$_SESSION['cToBCReport']['agency_id']=$agency_id_array;
		$_SESSION['cToBCReport']['group_id']=$group_id;
		$_SESSION['cToBCReport']['customer_outstanding']=$_POST['customer_outstanding'];
		header("Location: index.php");		
		exit;
	}
	else if($_GET['action']=='sendSMS')
	{
		
		$customer_id_Array = $_POST['selectTR'];
		sendOutstandingToCustomers($customer_id_Array);
		
		$_SESSION['ack']['msg']="SMS Sent Successfully!";
