...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=listJobCardsBetweenDate($from,$to,$vehicle_id);
		
		$_SESSION['cJobCardReport']['emi_array']=$reportArray;
		$_SESSION['cJobCardReport']['to']=$to;
		$_SESSION['cJobCardReport']['from']=$from;
		$_SESSION['cJobCardReport']['reg_no']=$reg_no;
