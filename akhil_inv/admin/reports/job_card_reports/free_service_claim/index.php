...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalJobCardFSCReports($from,$to,$broker_id_string,$city_id,$area_id_string,$agency_id_string,5);
		
		$_SESSION['cFreeServiceReport']['emi_array']=$reportArray;
		$_SESSION['cFreeServiceReport']['to']=$to;
		$_SESSION['cFreeServiceReport']['from']=$from;
		$_SESSION['cFreeServiceReport']['city_id']=$city_id;
		$_SESSION['cFreeServiceReport']['area_id_array']=$area_array;
		$_SESSION['cFreeServiceReport']['broker_id_array']=$broker_array;
		$_SESSION['cFreeServiceReport']['agency_id']=$agency_id_array;
