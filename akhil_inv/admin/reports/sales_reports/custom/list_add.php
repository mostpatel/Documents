...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>  
 <div id="deleteSelectedDiv"><button id="deleteSelected" class="btn viewBtn">delete selected rows</button></div>      
    <div class="showColumns">
     ...
     <input class="showCB" type="checkbox" id="6" checked="checked"   /><label class="showLabel" for="6">Reg No</label> 
     <input class="showCB" type="checkbox" id="7" checked="checked"   /><label class="showLabel" for="7">Amount</label> 
     <input class="showCB" type="checkbox" id="8" checked="checked"   /><label class="showLabel" for="8">Amount Received</label> 
     <input class="showCB" type="checkbox" id="9" checked="checked"   /><label class="showLabel" for="9">Amount Left</label> 
	...
	$total =0;
        ...
        <td class="no_print"><input type="checkbox" class="selectTR" name="selectTR"  /></td>
           ...
           <td><?php echo $sales['invoice_no'] ?></td>
            ...
            <td><?php if(is_numeric($job_card['to_ledger_id'])) echo $job_card['to_ledger_name']; else echo $job_card['customer_name']; ?><?php if($type==1) echo "CASH "; ?>
            </td>
              <?php if(TAX_MODE==1) { ?>
            ...
            <td><?php echo ($sales['amount']+$tax_amount)." Rs"; ?>
             ...
             <td align="center" ><?php echo number_format($remaining_amount)." Rs"; ?>  <br />  <?php if($type!=1 || !isset($type)) { ?> <a class="no_print" href="<?php echo WEB_ROOT.'admin/accounts/transactions/receipt/index.php?sales_id='.$receipt['sales_id'] ?>"><button title="View this entry" class="btn viewBtn btn-warning">Add Payment</button></a> <?php } ?>
            </td>
             <td class="no_print"> <a c href="<?php echo WEB_ROOT.'admin/accounts/transactions/sales_inventory/index.php?view=invoice&id='.$sales['sales_id'] ?>"><button title="View this entry" class="btn viewBtn btn-success">Invoice</button></a>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/sales_inventory/index.php?view=details&id='.$sales['sales_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
