...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=getItemWarrantyReports($from,$to,$broker_id_string,$city_id,$area_id_string,$agency_id_string);
		
		$_SESSION['cWarrantyClaimReport']['emi_array']=$reportArray;
		$_SESSION['cWarrantyClaimReport']['to']=$to;
		$_SESSION['cWarrantyClaimReport']['from']=$from;
		$_SESSION['cWarrantyClaimReport']['city_id']=$city_id;
		$_SESSION['cWarrantyClaimReport']['area_id_array']=$area_array;
		$_SESSION['cWarrantyClaimReport']['broker_id_array']=$broker_array;
		$_SESSION['cWarrantyClaimReport']['agency_id']=$agency_id_array;
