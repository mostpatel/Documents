...
if($_GET['action']=='generateReport')
	{
		...
		if(isset($_POST['jv_type']))
		{
		$jv_type=$_POST['jv_type'];
		}
		else
		$jv_type=null;
		...
		$_SESSION['cInventoryJVReport']['to']=$to;
		$_SESSION['cInventoryJVReport']['from']=$from;
		$_SESSION['cInventoryJVReport']['jv_type']=$jv_type;
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$to_ledger_id=getCustomerLedgerIDFromLedgerNameLedgerId($_POST['to_ledger_id']);
				$result=updateInventoryNonStockItemJV($_POST["id"],$_POST["item_id"],$_POST['rate'],$_POST['quantity'],$_POST["ns_item_id"],$_POST['ns_rate'],$_POST['ns_quantity'],$_POST['payment_date'],$_POST['remarks'],$_POST['godown_id'],$_POST['ns_godown_id'],$_POST['jv_type'],$to_ledger_id,$_POST['unit_id']);
				if($result=="success")
				{	
