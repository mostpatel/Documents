...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalWRCReports($from,$to,$broker_id_string,$city_id,$area_id_string,$agency_id_string);
		
		$_SESSION['cWRCReport']['emi_array']=$reportArray;
		$_SESSION['cWRCReport']['to']=$to;
		$_SESSION['cWRCReport']['from']=$from;
		$_SESSION['cWRCReport']['city_id']=$city_id;
		$_SESSION['cWRCReport']['area_id_array']=$area_array;
		$_SESSION['cWRCReport']['broker_id_array']=$broker_array;
		$_SESSION['cWRCReport']['agency_id']=$agency_id_array;
