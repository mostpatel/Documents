...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cFSCReport']['emi_array']=$reportArray;
		$_SESSION['cFSCReport']['to']=$to;
		$_SESSION['cFSCReport']['from']=$from;
		$_SESSION['cFSCReport']['city_id']=$city_id;
		$_SESSION['cFSCReport']['area_id_array']=$area_array;
		$_SESSION['cFSCReport']['broker_id_array']=$broker_array;
		$_SESSION['cFSCReport']['agency_id']=$agency_id_array;
