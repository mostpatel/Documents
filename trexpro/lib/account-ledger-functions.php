...
function listPurchaseLedgers($like_term=false)
{
...
function listSalesLedgers($like_term=false)
{
...
function listLedgers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listSuppliers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 1 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id ";
...
function listOutsideLabourProviders($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 4 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listSalesman($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 2 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listFinancers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 3 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listDealers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 5 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listBrokers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 6 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id  ";
...
function listBranches($like_term=false){
...
function listBranchIds($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 5 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listTruckOwners($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 8 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listTruckDrivers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 7 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listExpenseLedgers($like_term=false){
	...
	try
	{
		...
		$our_company_id=$_SESSION['edmsAdminSession']['oc_id'];
		$current_company=getCurrentCompanyForUser($admin_id);
		$in_direct_expense_head_id=getInDirectExpensesId();
		$direct_expense_head_id=getDirectExpensesId();
		if($current_company[1]==0) // if current company is our company
		{
		$oc_id=$current_company[0];	
		}
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE (head_id = $in_direct_expense_head_id OR head_id = $direct_expense_head_id) AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listExpenseLedgerIds($like_term=false){
...
function listAgents($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 6 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listAgentIds($like_term=false){
...
function getCustomerLedgerIDFromLedgerNameLedgerId($name)
{
	if(validateForNull($name))
	{
		...
		$sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name, ' | [C',edms_customer.customer_id,']') as full_ledger_name FROM edms_customer  HAVING full_ledger_name='$name'";
...
function getCustomerLedgerNameFromLedgerNameLedgerId($id)
{
	if(validateForNull($id))
	{
		...
		$sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name, ' | [C',edms_customer.customer_id,']') as full_ledger_name FROM edms_customer  WHERE edms_customer.customer_id = $suffix";
...
function listFinancersDealersBrokers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE (ledger_type = 3 OR ledger_type = 5 OR ledger_type = 6) AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listNonAccountingLedgers($like_term=false) // normal ledgers without cash and bank
{
...
if($like_term!=false)
{
	$sql=$sql."AND ledger_name LIKE '%$like_term%' ";
		  ...
		  $sql=$sql." UNION ALL 
		  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name) as name, edms_city.city_id,  oc_id, our_company_id,city_name
		  FROM edms_customer
		  LEFT JOIN edms_city ON edms_customer.city_id=edms_city.city_id
		  WHERE 
		  our_company_id=$our_company_id  AND 
		  ";
		if(ONLY_TO_BE_BILLED_CUSTOMERS==1)
		{
			$sql=$sql." customer_id IN (SELECT from_customer_id FROM edms_lr WHERE lr_type = 3 UNION SELECT to_customer_id FROM edms_lr WHERE lr_type = 3) AND ";
		}
if(is_numeric($oc_id))
{
	$sql=$sql." oc_id=$oc_id  ";
...
function listCustomerLegders()
{
	...
	$sql=$sql."  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name) as name, edms_city.city_id,  oc_id, our_company_id,city_name
		  FROM edms_customer
		  LEFT JOIN edms_city ON edms_customer.city_id=edms_city.city_id
...
function listCustomerAndLedgersWithoutPurchaseAndSales($like_term=false)
{
	try
	{
		$bank_head_id=getBankAccountsHeadId();
...
if($like_term!=false)
{
	$sql=$sql."AND (customer_name LIKE '%$like_term%')";
} 
...
function listAccountingLedgerIDs() // bank or cash
{
...
function insertLedger($name,$postal_name,$address,$city_id,$area,$pincode,$head_id,$contact_no,$pan_no,$sales_no,$notes,$opening_balance,$opening_balance_cd,$oc_id=null,$type=0,$bd2=false){
	...
	try
	{
		...
		if(!is_numeric($admin_id) && $bd2)
		{
		$admin_id = DEFAULT_ADMIN_ID;
		}
		if(!is_numeric($our_company_id) && $bd2)
		{
		$our_company_id = DEFAULT_OC_ID;
		}
		...
		{
			$city_id=insertCityIfNotDuplicate("NA",$bd2);
			}	
		...
		if(!validateForNull($area))
		{
			...
			$area_id=insertArea("NA",$city_id,$bd2);
			}
		else
		{
			$area_id=insertArea($area,$city_id,$bd2);
			}		
		...
		$duplicate = checkForDuplicateLedger($name,$bd2);
		if($name!=null && $name!=''  && checkForNumeric($head_id) && strlen($pincode)==6 && !$duplicate)
			{
			...
			$sql="INSERT INTO edms_ac_ledgers
					(ledger_name, head_id, postal_name,  address, city_id, area_id,pincode, pan_no, sales_no,opening_balance,opening_cd, opening_date, notes,  oc_id, our_company_id, created_by, last_updated_by, date_added, date_modified, ledger_type)
					VALUES
					('$name',$head_id,'$postal_name','$address',$city_id,$area_id,$pincode,'$pan_no','$sales_no',$opening_balance, $opening_balance_cd, '$opening_date','$notes' , $oc_id, $our_company_id ,$admin_id,$admin_id,NOW(),NOW(), $type)";
			
			dbQuery($sql,$bd2);
			$ledger_id=dbInsertId($bd2);
			addledgerContactNo($ledger_id,$contact_no,$bd2);
			if($type==5)
			{
				insertBranchCounter($ledger_id,substr($name,0,3));
			}
			return $ledger_id;
			}
		else if($duplicate)
...
function getLedgerIdForLedgerName($ledger_name,$type=NULL,$bd2=false)
{
	if(validateForNull($ledger_name))
	{
		$sql="SELECT ledger_id FROM edms_ac_ledgers WHERE ledger_name = '$ledger_name'";
		if(validateForNull($type))
		$sql=$sql." AND ledger_type = $type";
...
function checkforDuplicateLedger($ledger_name,$bd2=false)
{
	if(validateForNull($ledger_name))
	{
	$admin_id=$_SESSION['edmsAdminSession']['admin_id'];	
...
function getLedgerById($id,$bd2=false){
	
	try
	{
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance,opening_cd,opening_date,current_balance,current_balance_cd,notes,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name,oc_id
		  FROM edms_ac_ledgers,edms_city
...
function addLedgerContactNo($ledger_id,$contact_no,$bd2=false)
{
	try
	{
		if(is_array($contact_no))
		{
			foreach($contact_no as $no)
			{
				...
				{
				insertContactNoLedger($ledger_id,$no,$bd2); 
				}
			}
		}
		else
		{
			if($contact_no!="" && $contact_no!=null && is_numeric($contact_no))
				{
				insertContactNoLedger($ledger_id,$contact_no,$bd2); 
				}
...
function insertContactNoLedger($id,$contact_no,$bd2=false)
{
	try
	{
		if(checkForNumeric($id,$contact_no) && !checkForDuplicateContactNoledger($id,$contact_no))
		{
...
function getLedgerHeadType($ledger_id) // returns 0 if bank or cash  2 = tax_head_id or 3 = purchase or 4 = sales else 1
{
	if(checkForNumeric($ledger_id))
	{
		...
		if($ledger_head_id==$bank_head_id || $ledger_head_id==$cash_head_id)
		return 0;
...
function getLedgersForHeadId($head_id)
{
	...
	$sql="SELECT ledger_id,ledger_name,head_id
	      FROM edms_ac_ledgers
		  WHERE head_id IN (".$head_id_String.") AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
	...
	try
	{
		...
		else if($current_company[1]==2) // if combined agency
		{
			...
			$oc_ids=implode(',',$oc_id_array);
			  ...
			  $sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name) as name, oc_id, our_company_id
			  FROM edms_customer
			  WHERE 
			  our_company_id=$our_company_id AND 
			  ";
...
{
			  $sql=$sql." UNION ALL 
			  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name) as name,  oc_id, our_company_id
			  FROM edms_customer
			  WHERE 
			  our_company_id=$our_company_id AND 
			  ";
