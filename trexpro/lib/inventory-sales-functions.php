...
function insertInventoryNonStockSale($item_id_array,$rate_array,$quantity_array,$discount_array,$item_id_ns_array,$amount_ns_array,$discount_ns_array,$trans_date,$delivery_date,$to_ledger,$from_ledger,$remarks,$godown_id_array,$tax_group_array,$tax_group_ns_array,$sales_ref="NA",$sales_ref_type=0,$invoice_no=NULL)
{
	...
	$sales_id = insertSale($total_nett_amount,$trans_date,$trans_date,$to_ledger,$from_ledger,$remarks,2,0,$sales_ref,$sales_ref_type,0,$invoice_no);
...
function getNonStockItemForSaleId($sales_id)
{
	...
	{
		$return_array = array();
		$sql="SELECT edms_ac_sales_nonstock.sales_non_stock_id,item_id,discount,amount,net_amount,edms_ac_sales_nonstock.sales_id,created_by,last_updated_by,date_added,date_modified , edms_tax_grp.tax_group_id, tax_group_name, in_out, SUM(tax_amount) as tax_amount,item_desc FROM edms_ac_sales_nonstock 
