...
function insertInventoryItem($name,$alias,$item_code,$item_unit_id,$manufacturer_id,$mfg_item_code,$dealer_price,$mrp,$opening_quantity,$opening_rate,$remarks,$item_type_id,$min_quantity,$opening_godown_id,$tax_group_id,$sku_array){
...
function insertSkuToItem($item_id,$sku)
{
	...
	{
	   $sql="INSERT INTO edms_item_skus (sku) VALUES ('$sku')";
	   dbQuery($sql);	
	   return "success";
	}
	else
