...
function addJV($amount,$trans_date,$to_ledger,$from_ledger,$remarks,$auto_rasid_type=0,$auto_id=0,$oc_id=NULL) //$from_ledger should start with C for customer or L for ledger to_ledger = by(debit) and from_ledger = to(credit)  
{
...
function updateJV($id,$amount,$trans_date,$to_ledger,$from_ledger,$remarks,$oc_id=NULL)
{
	$admin_id=$_SESSION['edmsAdminSession']['admin_id'];
