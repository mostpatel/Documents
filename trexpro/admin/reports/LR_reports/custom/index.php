...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalLrReports($from,$to,$from_branch_ledger_id,$to_branch_ledger_id,$area_array,$untripped);
		
		$_SESSION['cEMIReport']['emi_array']=$reportArray;
		
		$_SESSION['cEMIReport']['from']=$from;
		$_SESSION['cEMIReport']['to']=$to;
		$_SESSION['cEMIReport']['from_branch_ledger_id']=$from_branch_ledger_id;
		$_SESSION['cEMIReport']['to_branch_ledger_id']=$to_branch_ledger_id;
		
		$_SESSION['cEMIReport']['area_id_array']=$area_array;
			$_SESSION['cEMIReport']['untripped']=$untripped;
