...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalTripReports($from,$to,$from_branch_ledger_id,$to_branch_ledger_id);
		
		$_SESSION['cIncomingTripReport']['emi_array']=$reportArray;
		
		$_SESSION['cIncomingTripReport']['from']=$from;
		$_SESSION['cIncomingTripReport']['to']=$to;
		$_SESSION['cIncomingTripReport']['from_branch_ledger_id']=$from_branch_ledger_id;
		$_SESSION['cIncomingTripReport']['to_branch_ledger_id']=$to_branch_ledger_id;
		
		$_SESSION['cIncomingTripReport']['area_id_array']=$area_array;
	...
	$to=$to->format('d/m/Y');
		...
		$_SESSION['cIncomingTripReport']['from']=$from;
		$_SESSION['cIncomingTripReport']['to']=$to;
		$_SESSION['cIncomingTripReport']['win_gt']=$win_gt;
		$_SESSION['cIncomingTripReport']['win_lt']=$win_lt;
		$_SESSION['cIncomingTripReport']['emi_gt']=$emi_gt;
		$_SESSION['cIncomingTripReport']['emi_lt']=$emi_lt;
		$_SESSION['cIncomingTripReport']['balance_gt']=$balance_gt;
		$_SESSION['cIncomingTripReport']['balance_lt']=$balance_lt;
		$_SESSION['cIncomingTripReport']['city_id']=$city_id;
		$_SESSION['cIncomingTripReport']['area_id_array']=$area_array;
		$_SESSION['cIncomingTripReport']['agency_id']=$agency_id;
		$_SESSION['cIncomingTripReport']['file_status']=$file_status;
