...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$branch_array=$_POST['branch'];
		
		$branch_id_string=implode(',',$branch_array);
		}
		else
		$branch_id_string=null;
		...
		$reportArray=generateBranchOutstandingReport($to,$branch_id_string,$city_id,$area_id_string,$agency_id_string);
		
		$_SESSION['cToBCReport']['emi_array']=$reportArray;
		$_SESSION['cToBCReport']['to']=$to;
		$_SESSION['cToBCReport']['branch_id_array']=$branch_array;
