...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalLRPaidReports($from,$to,$from_branch_ledger_id);
		
		$_SESSION['cPaidLRReport']['emi_array']=$reportArray;
		
		$_SESSION['cPaidLRReport']['from']=$from;
		$_SESSION['cPaidLRReport']['to']=$to;
		$_SESSION['cPaidLRReport']['from_branch_ledger_id']=$from_branch_ledger_id;
		
		
		$_SESSION['cPaidLRReport']['area_id_array']=$area_array;
	...
	$to=$to->format('d/m/Y');
		...
		$_SESSION['cPaidLRReport']['from']=$from;
		$_SESSION['cPaidLRReport']['to']=$to;
		$_SESSION['cPaidLRReport']['win_gt']=$win_gt;
		$_SESSION['cPaidLRReport']['win_lt']=$win_lt;
		$_SESSION['cPaidLRReport']['emi_gt']=$emi_gt;
		$_SESSION['cPaidLRReport']['emi_lt']=$emi_lt;
		$_SESSION['cPaidLRReport']['balance_gt']=$balance_gt;
		$_SESSION['cPaidLRReport']['balance_lt']=$balance_lt;
		$_SESSION['cPaidLRReport']['city_id']=$city_id;
		$_SESSION['cPaidLRReport']['area_id_array']=$area_array;
		$_SESSION['cPaidLRReport']['agency_id']=$agency_id;
		$_SESSION['cPaidLRReport']['file_status']=$file_status;
