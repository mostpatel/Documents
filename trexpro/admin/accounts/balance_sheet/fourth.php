				...
				{	
					...
					<td class="no_print"> <a href="<?php
					    ...
					    if($payment['auto_rasid_type']==3)
						{
						 ...
						 if($payment['auto_rasid_type']==0) { echo WEB_ROOT.'admin/accounts/transactions/receipt/index.php?view=details&id='.$payment['receipt_id']; } else if($payment['auto_rasid_type']==2) echo WEB_ROOT.'admin/customer/financer_receipt/index.php?view=details&id='.$payment['receipt_id']; else if($payment['auto_rasid_type']==3) echo WEB_ROOT.'admin/customer/vehicle/jobCard/receipt/index.php?view=details&id='.$payment['receipt_id']; else if($payment['auto_rasid_type']==4) echo WEB_ROOT.'admin/accounts/transactions/receipt/index.php?view=details&id='.$payment['receipt_id']; ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
					</td>
