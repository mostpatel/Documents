...
<h4 class="headingAlignment">Truck Owner Details</h4>
<?php 
...
<a href="<?php echo WEB_ROOT ?>admin/accounts/ledgers/dealer"><input type="button" value="back" class="btn btn-success" /></a>
</td>
</tr>
</table>
</form>
