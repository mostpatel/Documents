...
<h4 class="headingAlignment">Add a New Outside Labour Provider</h4>
<?php 
...
<td width="200px;">Head<span class="requiredField">* </span> : </td>
				<td>
                Sundry Credtors
					<input type="hidden" name="head_id" value="<?php echo getSundryCreditorsId(); ?>">
...
<h4 class="headingAlignment">List of Outside Labour Providers</h4>
    ...
    <tbody>
        ...
        <?php
		$dealers=listOutsideLabourProviders();
		$no=0;
