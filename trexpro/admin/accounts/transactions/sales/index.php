		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=insertSale($_POST["amount"],$_POST['payment_date'],$_POST['delivery_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks']); // $cheque_return is 0 when inserting a payment			
				...
				if($result=="success")
				{
					...
					header("Location: ".WEB_ROOT."admin/accounts/transactions/sales/index.php");
					exit;
				}
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateSale($_POST["lid"],$_POST["amount"],$_POST['payment_date'],$_POST['delivery_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks']);
				if($result=="success")
				{	
				$_SESSION['ack']['msg']="Sales updated Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
				header("Location: ".WEB_ROOT."admin/accounts/transactions/sales/index.php?view=details&id=".$_POST['lid']);
				exit;
				}
				else{
