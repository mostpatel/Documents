		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						if($_POST['sales_id']>0)
						$result = insertReceiptForSalesId($_POST['sales_id'],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['kasar_amount'],$_POST['kasar_type']);
						else
						$result=insertReceipt($_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['auto_rasid_type'],$_POST['sales_id']); // $cheque_return is 0 when inserting a payment			
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				if($_POST['sales_id']>0)
				$result=updateReceiptForSalesId($_POST['sales_id'],$_POST["lid"],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['kasar_amount'],$_POST['kasar_type']);
				else
