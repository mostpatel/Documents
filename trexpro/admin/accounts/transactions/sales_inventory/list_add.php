		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td><?php if(is_numeric($receipt['from_ledger_id']))echo $receipt['from_ledger_name']; else echo $receipt['from_customer_name']; ?>
             ...
             <br />
              <a href="<?php  echo WEB_ROOT.'admin/accounts/transactions/sales_inventory/index.php?view=allReceipts&id='.$sales_id; ?>"><button style="width:120px;" title="View this entry" class="btn  btn-success"><span class="">View Payment</span></button></a>
            </td>
             <td align="center" ><?php echo number_format($remaining_amount)." Rs"; ?>  <br /> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/receipt/index.php?sales_id='.$receipt['sales_id'] ?>"><button title="View this entry" class="btn viewBtn btn-warning">Add Payment</button></a>
            </td>
