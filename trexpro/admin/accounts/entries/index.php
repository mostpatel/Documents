...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['ledgerEntriess']['entries_array']=$reportArray;
		$_SESSION['ledgerEntriess']['from']=$from;
		$_SESSION['ledgerEntriess']['to']=$to;
		$_SESSION['ledgerEntriess']['transaction_array']=$transaction_array;
		$_SESSION['ledgerEntriess']['ledger_id']=$id;
