			...
			foreach($debit_details as $debit_detail)
{
	...
	$debit_string = $debit_string.$name." : ".$amount." <br>";
		...
		$from_ledger_id=$payment['credit_ledger_id'];
         ...
         <?php }
		  else if(isset($payment['sales_tax_id']) && is_numeric($payment['sales_tax_id'])) // sales
				{	
         ...
         <?php  }
		else if(isset($payment['credit_note_tax_id']) && is_numeric($payment['credit_note_tax_id'])) // sales
				{	
					$to_ledger_id=$payment['to_ledger_id'];
					$to_customer_id=$payment['to_customer_id'];
         ...
         <?php }
		else if(isset($payment['debit_note_tax_id']) && is_numeric($payment['debit_note_tax_id'])) // sales
				{	
