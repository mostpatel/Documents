		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=finalizeJobCard($_POST["job_card_id"],$_POST['invoice_no'],$_POST['bay_out'],$_POST['actual_delivery']); // $cheque_return is 0 when inserting a payment			
