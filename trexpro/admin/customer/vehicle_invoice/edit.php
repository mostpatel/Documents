...
<td>Invoice Type<span class="requiredField">* </span> : </td>
				<td>
					<select  id="retail_tax" name="retail_tax">
                    	<option value="-1">-- Please Select --</option>
                   		<option value="0" <?php if($invoice['retail_tax']==0) { ?> selected="selected" <?php } ?>>Retail</option>
                        <option value="1" <?php if($invoice['retail_tax']==1) { ?> selected="selected" <?php } ?>>Tax</option>
                    </select>
                            </td>
</tr>
