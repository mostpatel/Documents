		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=insertReceiptForLrId($_POST['lr_id'],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks']); // $cheque_return is 0 when inserting a payment			
				...
				if(is_numeric($result))
				{
					...
					header("Location: ".WEB_ROOT."admin/customer/lr_receipt/index.php?view=allReceipts&id=".$_POST["customer_id"]."&lid=".$_POST['lr_id']);
					exit;
				}
				...
				header("Location: ".WEB_ROOT."admin/customer/lr_receipt/index.php?view=allReceipts&id=".$_POST["customer_id"]);
				}
				else
				{
				$_SESSION['ack']['msg']="Invalid Input!";
				$_SESSION['ack']['type']=4; // 4 for error
				header("Location: ".WEB_ROOT."admin/customer/lr_receipt/index.php?view=index&id=".$_POST["customer_id"]);
				}
			}
			else
			{	
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				header("Location: ".WEB_ROOT."admin/customer/lr_receipt/index.php?view=allReceipts&id=".$_GET["customer_id"]);
				}
			}
			else
			{	
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateReceiptForLrId($_POST['lr_id'],$_POST["lid"],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks']);
...
if(isset($link))
$selectedLink=$link;
$jsArray=array("jquery.validate.js","jquery-ui/js/jquery-ui.min.js","addInsuranceProof.js","customerDatePicker.js","validators/addReceipt_Payment.js","dropDown.js","cScript.ashx","transliteration.I.js");
