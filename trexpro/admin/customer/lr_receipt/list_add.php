...
$receipts=getReceiptsForLRId($lr_id);
...
<input type="hidden" id="customer_id" name="lr_id" value="<?php echo $lr_id; ?>" />
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
    ...
    <tbody>
		...
		foreach($receipts as $receipt)
		{
			...
			$to_ledger_id = $receipt['to_ledger_id'];
			$to_customer_id = $receipt['to_customer_id'];
			...
			$vehicle = getLRById($receipt['auto_id']);
		 ?>
          <tr class="resultRow">
        	<td><?php echo ++$no; ?>
            </td>
            ...
            <td><?php echo $by_account['ledger_name']; ?>
             ...
             <td><?php echo $vehicle['lr_no']; ?>
            </td>
             <td><?php echo $receipt['remarks']; ?>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/lr_receipt/index.php?view=details&id='.$receipt['receipt_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/lr_receipt/index.php?view=edit&id='.$receipt['receipt_id']; ?>"><button title="Edit this entry" class="btn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/customer/lr_receipt/index.php?action=delete&lid='.$receipt['receipt_id'];  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
