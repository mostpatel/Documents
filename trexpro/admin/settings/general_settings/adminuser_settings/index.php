...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		$result=insertAdminUser($_POST["name"], $_POST["username"], $_POST["password"], $_POST["email"], $_POST["right"],$_POST["branch"]);
	...
	if($_GET['action']=='edit')
	{
		updateAccessRightsForUser($_POST["lid"],$_POST["right"],$_POST["branch"]);
