...
<td>Report Rights : </td>
<td><?php $admin_rights_report=listBranches();

foreach($admin_rights_report as $right)
{
	?>
  <input id="<?php echo $right['ledger_id'] ?>" type="checkbox" name="branch[]" value="<?php echo $right['ledger_id'] ?>" class="insertCheckBox" /> <label class="insertCheckBoxLabel" for="<?php echo $right['ledger_id'] ?>"><?php echo $right['ledger_name'] ?></label> 
<?php    
}?></td>
</tr>
