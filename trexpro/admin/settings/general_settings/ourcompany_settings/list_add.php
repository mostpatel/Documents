    	...
    	<tr>
            ...
            <th class="heading">City</th>
             <th class="heading">Contact No</th>
              <th class="heading">LR Counter</th>
               <th class="heading">Memo Counter</th>
		...
		foreach($ourCompanies as $ourCompanyDetails)
		{
         ...
         <tr class="resultRow">
           ...
           <td><?php $contact_nos=getContactNoForOurCompany($ourCompanyDetails['our_company_id']); 
            ...
            <td><?php echo getLRCounterForOCID($ourCompanyDetails['our_company_id']); ?></td>
             <td><?php echo getTripMemoCounterForOCID($ourCompanyDetails['our_company_id']); ?></td>
             <td><?php echo getInvoiceCounterForOCID($ourCompanyDetails['our_company_id']); ?></td>
