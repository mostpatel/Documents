...
<h4 class="headingAlignment">Cash Received</h4>
<?php 
...
<tr>
<td width="230px;">Paid Date<span class="requiredField">* </span> : </td>
				<td>
					
                  <input type="text" id="lr_date" class="datepicker1" name="lr_paid_date" value="<?php echo date('d/m/Y',strtotime(getTodaysDate())); ?>" />
                            </td>
</tr>

<tr>
<td>Page No<span class="requiredField">* </span> : </td>
				<td>
					
                  <input type="text" id="lr_no"  name="page_no" value="<?php echo getPageCounterForBranchID($admin_branches[0]['branch_id']); ?>" />
                            </td>
</tr>
 ...
 <table id="adminContentReport" class="adminContentTable no_print">
    <thead>
        ...
        <th class="heading no_print no_sort"><input type="checkbox" id="selectAllTR" name="selectAllTR"  /></th>
            ...
            <th class="heading">Cash Memo No</th>
    ...
    <tbody>
        ...
        <?php
		$total=0;
		$untripped_lrs  = getUnPaidLrsByBranch($admin_branch_id_string);
		...
		foreach($untripped_lrs as $emi)
		{
         ...
         <td class="no_print"><input type="checkbox" class="selectTR" name="selectTR[]" value="<?php echo $emi['lr_id']; ?>" /></td>
        	...
        	<td><?php echo ++$i; ?></td>
             <td ><input type="text" name="cash_memo_no[]" style="width:70px" /></td>
...
<td width="230px;"></td>
<td>
<input type="submit" value="Mark Lrs Paid"  class="btn btn-warning">
