...
<h4 class="headingAlignment">Make Trip Summary</h4>
<?php 
...
<td>Summary No<span class="requiredField">* </span> : </td>
				<td>
                  ...
                  <input type="text" id="invoice_no"  name="invoice_no" value="<?php echo getSummaryCounterForBranchID($admin_branches[0]['branch_id']); ?>" />
                            </td>
</tr>
