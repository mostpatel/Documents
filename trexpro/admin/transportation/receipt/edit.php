...
<input type="hidden" id="ledger_id" name="ledger_id" value="<?php echo $state; ?>" />
...
<td>Ledger<span class="requiredField">* </span> : </td>
				<td>
					<input type="hidden" id="to_ledger" name="to_ledger_id" value="<?php echo $ledger_customer_id; ?>" /> 
...
<a href="<?php echo "index.php?id=".$invoice_id."&state=".$state; ?>"><input type="button" class="btn btn-success" value="Back"/></a>
</td>
</tr>
