...
<td> Customer : </td>
				<td>
					<?php echo $customer['customer_name']; ?></a>
                            </td>
</tr>
<?php } ?>                          
<tr>
...
<td width="250px;"></td>
<td>
 <a href="<?php echo 'index.php?view=edit&lid='.$receipt_id."&id=".$invoice_id."&state=".$state; ?>"><button title="Edit this entry" class="btn editBtn"><span class="delete">E</span></button></a>
<a href="index.php?action=delete&lid=<?php echo $receipt_id."&id=".$invoice_id."&state=".$state; ?>"><button class="btn delBtn" ><span class="delete">X</span></button></a>
