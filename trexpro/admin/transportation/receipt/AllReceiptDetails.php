		...
		foreach($receipts as $receipt)
		{
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/receipt/index.php?view=edit&id='.$receipt['receipt_id']; ?>"><button title="Edit this entry" class="btn splEditBtn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/customer/index.php?action=delete&lid='.$receipt['receipt_id'];  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
