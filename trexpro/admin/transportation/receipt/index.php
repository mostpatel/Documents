		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=insertReceipt($_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['auto_rasid_type'],$_POST['invoice_id']); // $cheque_return is 0 when inserting a payment			
				...
				if($result=="success")
				{
					...
					header("Location: ".WEB_ROOT."admin/transportation/receipt/index.php?&id=".$_POST["invoice_id"]."&state=".$_POST['ledger_id']);
					exit;
				}
				...
				header("Location: ".WEB_ROOT."admin/transportation/receipt/index.php?view=details&id=".$_POST["invoice_id"]."&state=".$_POST['ledger_id']);
				}
				else
				{
				$_SESSION['ack']['msg']="Invalid Input!";
				$_SESSION['ack']['type']=4; // 4 for error
				header("Location: ".WEB_ROOT."admin/transportation/receipt/index.php?view=index&id=".$_POST["invoice_id"]."&state=".$_POST['ledger_id']);
				}
			}
			else
			{	
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				header("Location: ".WEB_ROOT."admin/transportation/receipt/index.php?id=".$_GET["id"]."&state=".$_GET['state']);
				}
			}
			else
			{	
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				header("Location: ".WEB_ROOT."admin/transportation/receipt/index.php?view=details&lid=".$_POST['lid']."&id=".$_POST["invoice_id"]."&state=".$_POST['ledger_id']);
				}
				else{
			...
			{	
					$_SESSION['ack']['msg']="Authentication Failed! Not enough access rights!";
					$_SESSION['ack']['type']=5; // 5 for access
					header("Location: ".WEB_ROOT."admin/customer/receipt/index.php?view=details&id=".$_POST["invoice_id"]."&state=".$_POST['ledger_id']);
			}
