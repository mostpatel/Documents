		...
		foreach($receipts as $receipt)
		{
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/customer/vehicle_payment/index.php?action=delete&lid='.$receipt['payment_id'];  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
