...
{	
$insurances=getInsurancesDetailsForVehicleID($vehicle_id);
if($insurances=="error")
{
...
<div class="addDetailsBtnStyling no_print"><a href="index.php?id=<?php echo $file_id; ?>&state=<?php echo $customer_id; ?>"><button class="btn btn-success">+ Add Insurance</button></a> <a href="<?php echo WEB_ROOT; ?>admin/customer/index.php?view=details&id=<?php echo $customer_id; ?>"><button class="btn btn-warning">Go to Customer</button></a> <a href="<?php echo WEB_ROOT; ?>admin/customer/vehcile/index.php?view=details&id=<?php echo $vehicle_id; ?>"><button class="btn btn-warning">Go to Vehicle</button></a></div>
...
<tr>
	<td></td>
  <td class="no_print"> <a href="<?php echo $_SERVER['PHP_SELF'].'?view=insuranceDetails&id='.$vehicle_id.'&state='.$insurance['insurance_id']; ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            
             <a href="<?php echo $_SERVER['PHP_SELF'].'?view=editInsurance&id='.$vehicle_id.'&state='.$insurance['insurance_id']; ?>"><button title="Edit this entry" class="btn splEditBtn editBtn"><span class="delete">E</span></button></a>
            </td>
</tr>    
