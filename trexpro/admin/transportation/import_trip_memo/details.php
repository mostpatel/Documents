...
<h4 class="headingAlignment">Cash Received Details</h4>
<?php 
...
<tr>
<td width="230px;">Paid Lr Date : </td>
				<td>
					
                  <?php echo date('d/m/Y',strtotime($trip_memo['paid_lr_date'])); ?>
                            </td>
</tr>
...
<h4 class="headingAlignment no_print">Cash Received Details</h4>
