		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertTripInvoice($_POST["invoice_date"],$_POST['invoice_no'],$_POST['selectTR'],$_POST['agent_name'],$_POST['agent_amount'],$_POST['expense_name'],$_POST['expense_amount'],$_POST['remarks']);
				
				if(is_numeric($result))
				{
				$_SESSION['ack']['msg']="Invoice successfully added!";
				$_SESSION['ack']['type']=1; // 1 for insert
				header("Location: ".WEB_ROOT."admin/transportation/trip_invoice/index.php?view=details&id=".$result);
				exit;
				}
				else{
				...
				header("Location: ".WEB_ROOT."admin/transportation/trip_invoice/index.php");
				exit;
				}
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				if($result!="error")
				{
				$_SESSION['ack']['msg']="Trip Invoice deleted Successfuly!";
			...
			{	
					$_SESSION['ack']['msg']="Authentication Failed! Not enough access rights!";
					$_SESSION['ack']['type']=5; // 5 for access
					header("Location: ".WEB_ROOT."admin/transportation/trip_invoice/index.php?view=details&id=".$customer_id);
			exit;
			}
		}
	if($_GET['action']=='edit')
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateTripInvoice($_POST['trip_invoice_id'],$_POST["invoice_date"],$_POST['invoice_no'],$_POST['selectTR'],$_POST['agent_name'],$_POST['agent_amount'],$_POST['expense_name'],$_POST['expense_amount'],$_POST['remarks']);
				
				if($result=="success" && is_numeric($_POST["trip_invoice_id"]))
				{
				$_SESSION['ack']['msg']="Trip Invoice successfully updated!";
				$_SESSION['ack']['type']=1; // 1 for insert
				header("Location: ".WEB_ROOT."admin/transportation/trip_invoice/index.php?view=details&id=".$_POST["trip_invoice_id"]);
				exit;
				}
				else{
