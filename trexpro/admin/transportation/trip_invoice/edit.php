...
<tr>
<td width="230px;">Invoice Date<span class="requiredField">* </span> : </td>
				<td>
					
                  <input type="text" id="lr_date" class="datepicker1" name="invoice_date" value="<?php echo date('d/m/Y',strtotime(getTodaysDate())); ?>" />
                            </td>
</tr>
...
<td>Invoice No<span class="requiredField">* </span> : </td>
				<td>
                  ...
                  <input type="text" id="invoice_no"  name="invoice_no" value="<?php echo getInvoiceCounterForOCID($_SESSION['edmsAdminSession']['oc_id']); ?>" />
                            </td>
</tr>
...
<h4 class="headingAlignment no_print">Agent Commision Details</h4>
<table id="insertAgentTable" class="insertTableStyling no_print">
<tbody id="regenrateAgent" style="display:none;">
<tr >
<td width="230px;">Agent<span class="requiredField">* </span> : </td>
				<td>
					
                  <input type="text" class="agent" name="agent_name[]"  />
                            </td>
                            <td>Amount :</td>
                            	<td>
					
                  <input type="text"  name="agent_amount[]"  /><span class="addContactSpan"><input type="button" title="add more contact no" value="+" class="btn btn-success addContactbtnCustomer" onclick="generateAgentDetails(this)"/></span>
                            </td>
</tr>
</tbody>
...
<h4 class="headingAlignment no_print">Expenses Details</h4>
<table id="insertExpenseTable" class="insertTableStyling no_print">
<tbody id="regenrateExpense" style="display:none;">
<tr >
<td width="230px;">Expense<span class="requiredField">* </span> : </td>
				<td>
					
                  <input type="text" class="expense_name" name="expense_name[]"  />
                            </td>
                            <td>Amount :</td>
                            	<td>
					
                  <input type="text"  name="expense_amount[]"  /><span class="addContactSpan"><input type="button" title="add more contact no" value="+" class="btn btn-success addContactbtnCustomer" onclick="generateExpenseDetails(this)"/></span>
                            </td>
</tr>
</tbody>
...
<h4 class="headingAlignment no_print">Trip Memo Details</h4>
 <table id="adminContentReport" class="adminContentTable no_print">
    ...
    <tbody>
        ...
        <?php
		$total=0;
		$untripped_lrs=getUnInvoicesTrips();
...
<td width="230px;"></td>
<td>
<input type="submit" value="Insert Trip Invoice"  class="btn btn-warning">
