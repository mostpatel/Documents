...
<h4 class="headingAlignment">Edit Cash Received</h4>
<?php 
...
<td>Trip Memo No<span class="requiredField">* </span> : </td>
				<td>
                  ...
                  <input type="text" id="lr_no"  name="trip_memo_no" value="<?php echo $trip_memo['trip_memo_no']; ?>" />
                            </td>
</tr>
...
<td>Driver Name<span class="requiredField">* </span> : </td>
				<td>
					...
					foreach($truck_drivers as $branch)
					{
					?>
                    <option value="<?php echo $branch['ledger_id']; ?>" <?php if($trip_memo['driver_id']==$branch['ledger_id'])  { ?> selected="selected" <?php } ?>><?php echo $branch['ledger_name']; ?></option>			
                    <?php	
						}
					 ?>
                    </select><span class="DateError customError">Please select a Branch!</span>
