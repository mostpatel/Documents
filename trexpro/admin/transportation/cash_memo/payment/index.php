...
require_once "../../../../lib/cash-memo-functions.php";
	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=insertCashMemo($_POST["memo_no"],$_POST['memo_date'],$_POST['lr_id'],$_POST['amount'],$_POST['labour'],$_POST['other']); // $cheque_return is 0 when inserting a payment			
				
				if(is_numeric($result))
				{
					$_SESSION['ack']['msg']="Cash Memo successfully added!";
					$_SESSION['ack']['type']=1; // 1 for insert
					header("Location: ".WEB_ROOT."admin/transportation/cash_memo/payment/index.php?view=details&id=".$result);
					exit;
				}
				...
				header("Location: ".WEB_ROOT."admin/admin/transportation/cash_memo/index.php");
				exit;
				}
				else
				{
				...
				$_SESSION['ack']['type']=4; // 4 for error
				header("Location: ".WEB_ROOT."admin/transportation/cash_memo/index.php");
				exit;
				}
			}
			else
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				header("Location: ".WEB_ROOT."admin/transportation/cash_memo/index.php?view=details&id=".$_POST['lid']);
				exit;
				}
				else{
