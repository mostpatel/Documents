		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertLrPaid($_POST["lr_paid_date"],$_POST['page_no'],$_POST['selectTR'],$_POST['cash_memo_no']);
				
				if(is_numeric($result))
				{
				$_SESSION['ack']['msg']="Lr Paid Records successfully added!";
				$_SESSION['ack']['type']=1; // 1 for insert
				header("Location: ".WEB_ROOT."admin/transportation/paid_lrs/index.php?view=trip_memo&id=".$result);
				exit;
				}
				else{
				...
				header("Location: ".WEB_ROOT."admin/transportation/paid_lrs/index.php");
				exit;
				}
