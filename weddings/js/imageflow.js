...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		opacityArray:       [10,7,2,0,1],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
		percentLandscape:   158,            /* Scale landscape format */
		...
		scrollbarP:         0.88,            /* Width of the scrollbar in percent */
		slider:             true,           /* Toggle slider */
		sliderCursor:       'e-resize',     /* Slider cursor type - default is 'default' */
		sliderWidth:        12,             /* Width of the slider in px */
		...
		for(var index = 0; index < max; index++)
		{
			...
			if (node && node.nodeType == 1 && node.nodeName == 'IMG')
			{
				...
				if(my.reflections === true)
				{
					...
					src = my.reflectPath+'reflect'+version+'.html?img='+src+my.reflectionGET;
	...
	this.glideTo = function(imageID)
	{
		...
		if (my.MouseDrag.busy === false)
		{
			...
			my.sliderDiv.style.marginLeft = (my.newSliderX - my.sliderWidth - 20) + 'px';
		}
