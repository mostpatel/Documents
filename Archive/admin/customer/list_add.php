...
<td> 
<input type="text" name="customer_name" id="customer_name" class="customer_name" placeholder="Only Letters" <?php if(is_numeric($customer_id) && isset($customerDetails['customer_name'])) { ?> value="<?php echo $customerDetails['customer_name']; ?>" disabled="disabled" <?php } ?>/>
