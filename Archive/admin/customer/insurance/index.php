...
require_once "../../../lib/cng-functions.php";
		...
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertVehicleInsurance($_POST["insurance_issue_date"], $_POST['insurance_company_id'],$_POST['rate'],$_POST['idv'],$_POST['discount'],$_POST['cngIDV'],$_POST['electricIDV'],$_POST['ncb'],$_POST['ncbCNG'], $_POST['ncbelectric'], $_POST['lPremium'], $_POST['cPA'], $_POST['driverPA'], $_POST['finalAmount'], $_POST['vehicle_id'], $_POST['customer_id']);
...
if(isset($link))
$selectedLink=$link;
$jsArray=array("jquery.validate.js", "getInsurancePercentage.js", "scanProof.js","jquery-ui/js/jquery-ui.min.js", "generateCNGDetails.js", "generateElectronicDetails.js", "validators/searchCustomer.js","addInsuranceProof.js","customerDatePicker.js","validators/addNewInsurance.js");
