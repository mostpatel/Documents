...
require_once "../../../lib/quotation-customer-functions.php";
require_once "../../../lib/quotation-functions.php";
require_once "../../../lib/quotation-rel-subcat-enquiry-functions.php";
...
if(isset($_GET['view']))
{
	...
	else if($_GET['view']=="quotationFinal")
	{
		$showTitle=false;
		$content="quotationFinal.php";
	}		
	else
	{
		$content="list_add.php";
	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{   
				...
				$result=insertQuotation($_POST["name"], $_POST["product_array"], $_POST["mrp_array"], $_POST["quantity_id_array"], $_POST["customerContact"], $_POST["email"], $_POST["address"], $_POST["city"], $_POST["customer_id"], $_POST["enquiry_id"], $_POST["quotation_date"] );
				
				if(is_numeric($result))
				{
				$_SESSION['ack']['msg']="Quotation successfully added!";
				$_SESSION['ack']['type']=1; // 1 for insert
				header("Location: ".WEB_ROOT."admin/customer/quotation/index.php?view=quotationFinal&id=".$result);
				exit;
