...
if(!isset($_GET['lid']))
header("Location: ".WEB_ROOT."admin/customer/index.php?view=addRemainder&id=".$enquiry_form_id);
...
<input name="enquiry_form_id" value="<?php echo $enquiry_form_id; ?>" type="hidden">
...
<td></td>
<td>
<input type="submit" class="btn btn-warning" value="Save"/> <a href="<?php echo WEB_ROOT; ?>admin/customer/index.php?view=addRemainder&id=<?php echo $enquiry_form_id; ?>"><input type="button" class="btn btn-success" value="Back" /></a>
</td>
</tr>
