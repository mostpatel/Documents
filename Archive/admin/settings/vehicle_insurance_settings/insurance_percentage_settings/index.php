...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		...
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
		
			{
				...
				$result=insertInsurancePercentage($_POST["vehicle_type_id"], $_POST["cc_id"], $_POST["period_id"], $_POST["company"], $_POST["percentage"], $_POST["lPremium"], $_POST["CPA"], $_POST["paDriver"]);
				
				if($result!="error")
				{
				$_SESSION['ack']['msg']="Insurance Percentage successfully added!";
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateVehicleModel($_POST["lid"],$_POST["name"],$_POST["vehicle_company_id"], $_POST["vehicle_type_id"], $_POST["cc_id"]);
				if($result=="success")
				{
...
$jsArray=array("jquery.validate.js","validators/vehicleModel.js", "dropDown.js");
