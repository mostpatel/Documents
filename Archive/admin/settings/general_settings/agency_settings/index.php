...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertAgency($_POST["agencyName"], $_POST["agencyPrefix"],$_POST['auto_pay'], $_POST["contactPerson"], $_POST["contactNumber"], $_POST["contactAddress"]);
				if($result=="success")
				{
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateAgency($_POST["lid"],$_POST["agencyName"], $_POST["agencyPrefix"],$_POST['auto_pay'], $_POST['rasid_counter'], $_POST["contactPerson"], $_POST["contactNumber"], $_POST["contactAddress"]);
				if($result=="success")
				{
