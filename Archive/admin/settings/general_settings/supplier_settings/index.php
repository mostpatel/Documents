...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertSupplier($_POST["supplier_name"], $_POST["supplier_email"], $_POST["supplier_phone"]);
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=deleteSupplier($_GET["lid"]);
				if($result=="success")
				{
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateSupplier($_POST["lid"], $_POST["supplier_name"], $_POST["supplier_email"], $_POST["supplier_phone"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Profession updated Successfuly!";
