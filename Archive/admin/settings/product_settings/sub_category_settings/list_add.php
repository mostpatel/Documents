...
<td>
Rs. &nbsp;<input type="text" name="mrp" id="txtName"/>
</td>
</tr>
...
<td></td>
<td>
<input type="submit" value="Add Sub Category" class="btn btn-warning">
		...
		foreach($subCategories as $subCategory)
		{
		 ...
		 ?>
          <tr class="resultRow">
			...
			<?php 
			echo $subCategory['subCategory_price']; 
			?>
            </span>
            </td>
