...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$doneCustomFollowUps=viewDoneFollowUps($_POST['from_date'],$_POST['to_date']);
			
				$_SESSION['cFollowUpReport']['leadsReminder_array']=$doneCustomFollowUps;
				$_SESSION['cFollowUpReport']['from_date']=$_POST['from_date'];
				$_SESSION['cFollowUpReport']['to_date']=$_POST['to_date'];
