...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$doneFollowUps = viewDoneFollowUps($_POST['from_date'],$_POST['to_date']);
			
			
			
				$_SESSION['dailyDoneFollowUpReport']['followUp_array']=$doneFollowUps;
				$_SESSION['dailyDoneFollowUpReport']['from_date']=$_POST['from_date'];
				$_SESSION['dailyDoneFollowUpReport']['to_date']=$_POST['to_date'];
