...
<td>
<input type="text" id="datepicker" size="12" autocomplete="off"  name="from_date" class="datepicker1 datepick" value="<?php if(isset($_SESSION['cLeadReminderReport']['from_date']) && validateForNull($_SESSION['cLeadReminderReport']['from_date']))
		 { echo $_SESSION['cLeadReminderReport']['from_date'];} ?>" placeholder="Click to Select!" /><span class="customError DateError">Please select a date!</span>
</td>
</tr>
...
<td>
<input type="text" id="datepicker1" size="12" autocomplete="off"  name="to_date" class="datepicker2 datepick" value="<?php if(isset($_SESSION['cLeadReminderReport']['to_date']) && validateForNull($_SESSION['cLeadReminderReport']['to_date']))
		 { echo $_SESSION['cLeadReminderReport']['to_date'];} ?>" placeholder="Click to Select!" /><span class="customError DateError">Please select a date!</span>
</td>
...
<?php
		...
		if(isset($_SESSION['cLeadReminderReport']['leadsReminder_array']) && is_array($_SESSION['cLeadReminderReport']['leadsReminder_array']))
		{
			$leadsReminder=$_SESSION['cLeadReminderReport']['leadsReminder_array'];
		$i=0;
?>
...
<h4 class="headingAlignment"> Reminder List</h4>
