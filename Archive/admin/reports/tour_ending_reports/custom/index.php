...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$purchaseDates=viewTourEndingDates($_POST['from_date'],$_POST['to_date']);
			
				$_SESSION['cTourEndDateReport']['tourEndDate_array']=$purchaseDates;
				$_SESSION['cTourEndDateReport']['from_date']=$_POST['from_date'];
				$_SESSION['cTourEndDateReport']['to_date']=$_POST['to_date'];
