...
<?php
		...
		if(isset($_SESSION['cPurchaseDateReport']['purchaseDate_array']) && is_array($_SESSION['cPurchaseDateReport']['purchaseDate_array']))
		{
			$purchaseDates=$_SESSION['cPurchaseDateReport']['purchaseDate_array'];
		$i=0;
?>
...
<h4 class="headingAlignment">Purchase Date List</h4>
