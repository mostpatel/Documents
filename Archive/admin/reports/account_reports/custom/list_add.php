...
<h4 class="headingAlignment no_print">General Account Reports</h4>
<?php 
...
<td>Area : </td>
				<td>
					<input type="text" name="area" class="city_area" id="city_area1" placeholder="Only Letters" value="<?php if(isset($_SESSION['cAccountReport']['area_id'])) echo $_SESSION['cAccountReport']['area_id']; ?>" />
                            </td>
</tr>
