...
<div class="insideCoreContent adminContentWrapper wrapper"> 
 <div class="widgetContainer">
   ...
   <div class="quoteDisplay" style="margin-bottom:30px;">
  <span style="color:#000"> Today's Follow-ups : </span> <?php  echo countTodaysFollowUps(); ?>  <br />
  <span style="color:#000"> Expired Follow-ups : </span><?php  echo countExpiredFollowUps(); ?>  <br /> <br />
