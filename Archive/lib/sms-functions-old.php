...
function sendanSMSTemp($mobile_no,$message)
{
	...
	$params = array('APIKEY' => 'UHL7FYSvUYb', 'MobileNo' => '91'.$mobile_no, 'SenderID' => 'SIDDHI', 'Message' => $message , 'ServiceName' => 'PROMOTIONAL_HIGH');
...
function checkCredits($type)
{
	...
	if($type==1)
	{
    $params = array('EmailID' => 'lileshbhai',  'Password' => '26871370', 'ServiceName' => 'PROMOTIONAL_HIGH');
	}
	
	else if($type==2)
	{
	$params = array('EmailID' => 'lileshbhai',  'Password' => '26871370', 'ServiceName' => 'TEMPLATE_BASED');	
	}
...
function sendSiteAddress($customer_name, $address, $customer_mobile_no)
{
	...
	$address = "Siddhi Vinayak Elegance, From S.G. Highway YMCA Club to straight Ujala Circle, Right Turn Sanaathal Circle (Ring Road), To Left Turn Concord (Baakrol) Circle, To Right Turn Kaasindra Parshwanath Jain Temple & DVP Hight School. Time : 10AM to 7PM";
...
function sendSiteAddress2($customer_name, $address, $customer_mobile_no)
{
	
	
	
	$address = "Siddhi Vinayak Elegance, Bopal (Ring Road) To Shantipura Circle. Straight to Sanathal Circle to Straight to Concord (Baakrol) Circle, To right turn. Satya Sai Heart Hospital. Kaasindra Parshwnath Jain Mandir & DVP High School. Our site is near This Mandir and School. Time : 10AM to 7PM";
