...
<link href="<?php echo WEB_ROOT ?>css/notifcenter.css" rel="stylesheet">
...
<script src="<?php echo WEB_ROOT; ?>js/jquery.notificationcenter.js"></script>
...
<?php } ?>
	<div id="mainDiv">
		<div id="header" class="no_print">
			<a href="<?php echo WEB_ROOT; ?>"><div id="logo">VCARRY <?php if(defined('HEADING_SUFFIX')) echo HEADING_SUFFIX; ?></div></a>
				<div id="navigation">
            		<div id="nav">
...
<div id="noticationcentermain"></div>
<div style="padding-bottom:10px;" class="no_print">Current Company : <b><?php echo $our_company_name; ?></b> (Ctrl + F2) To change<br />
...
<script>
       $('body').notificationcenter({
				...
				type_max_display:0,
				alert_hidden_sound: "/vcarry/sounds/glass",
				types:[
					{
						type: 'sticky',
						img: '<?php echo WEB_ROOT; ?>img/alarm.png',
						imgtype: 'image',
						display_time: 0
         ...
         <script type="text/javascript" src="<?php echo WEB_ROOT; ?>js/vcarry.js"></script>