...
$no_of_sms = getNumberOfSMSRecordsForJobCardId($job_card_id);
}
else
exit;
 ?>
...
<a href="<?php echo WEB_ROOT.'admin/customer/vehicle/jobCard/index.php?view=editFinalize&id='.$job_card_id; ?>"><button title="Finalize this entry" class="btn delBtn btn-danger">Edit Finalize</button></a>
...
<?php if(defined('SEND_SMS') && SEND_SMS==1)
		{ ?>
<a href="<?php echo WEB_ROOT.'admin/customer/vehicle/jobCard/index.php?action=finalize_sms&id='.$job_card_id; ?>"><button title="Finalize this entry" class="btn btn-success">Send Sms - <?php echo $no_of_sms; ?> Sent </button></a>
<?php } ?>
<?php } ?>
