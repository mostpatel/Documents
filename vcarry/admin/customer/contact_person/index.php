...
require_once "../../../lib/contact-person-functions.php";
	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=insertContactPerson($_POST['customer_name'],$_POST['cp_con_no'],$_POST['cp_con_no_2'],$_POST['cp_dob'],$_POST['email'],$_POST['customer_id'],$_POST['prefix'],0,$_POST['cp_anniversary']); // $cheque_return is 0 when inserting a payment			
				
				if(is_numeric($result))
				{
					$_SESSION['ack']['msg']="Contact Person successfully added!";
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=editContactPerson($_POST['cp_id'],$_POST['customer_name'],$_POST['cp_con_no'],$_POST['cp_con_no_2'],$_POST['cp_dob'],$_POST['email'],$_POST['customer_id'],$_POST['prefix'],0,$_POST['cp_anniversary']);
				if($result=="success")
				{	
