	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=insertShippingLocation($_POST['customer_name'],$_POST['customer_address'],$_POST['customer_city_id'],$_POST['customer_area'],$_POST['cp_name'],$_POST['cp_con_no'],$_POST['recess_from'],$_POST['recess_to'],$_POST['goods_type'],$_POST['goods_weight_range'],$_POST['customer_id'],$_POST['primary_location'],$_POST['customer_address2']); // $cheque_return is 0 when inserting a payment			
				
				if(is_numeric($result))
				{
					$_SESSION['ack']['msg']="Shipping Location successfully added!";
					$_SESSION['ack']['type']=1; // 1 for insert
					header("Location: ".WEB_ROOT."admin/customer/shipping_locations/index.php?id=".$_POST['customer_id']);
					exit;
				}
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=editShippingLocation($_POST['lid'],$_POST['customer_name'],$_POST['customer_address'],$_POST['customer_city_id'],$_POST['customer_area'],$_POST['cp_name'],$_POST['cp_con_no'],$_POST['recess_from'],$_POST['recess_to'],$_POST['goods_type'],$_POST['goods_weight_range'],$_POST['primary_location'],$_POST['customer_address2']);
				if($result=="success")
				{	
				$_SESSION['ack']['msg']="Shipping Location updated Successfuly!";
...
if(isset($link))
$selectedLink=$link;
$jsArray=array("jquery.validate.js","jquery-ui/js/jquery-ui.min.js","addInsuranceProof.js","customerDatePicker.js","validators/addReceipt_Payment.js","cScript.ashx","transliteration.I.js","jquery.timepicker.min.js","dropDown.js");
$cssArray=array("jquery-ui.css","jquery.timepicker.min.css");
