...
$selected_customer_group_names = getBrokersForCustomerId($customer_id);

foreach($selected_customer_group_names as $selected_customer_group_name)
		
		{
		  $selected_customer_group_name_array[] = $selected_customer_group_name['ledger_id'];  
		}  
...
<h4 class="headingAlignment no_print">Add To <?php echo BROKER_NAME; ?> Group</h4>
<?php 
...
?>
<form id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=addToBrokerGroup'; ?>" method="post">
...
<tr>
<td> Add To <?php echo BROKER_NAME; ?> Group<span class="requiredField">* </span>: </td>
				<td>
