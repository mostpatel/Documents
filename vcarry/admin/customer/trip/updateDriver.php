...
<td>Driver Name :</td>
            <td > 
            <form action="index.php?action=updateDriver" method="post">
            <input type="hidden" name="trip_id" value="<?php echo $trip_id; ?>">
            <select name="driver_id" id="driver_id" >
           <?php  $accepted_drivers = getAllDriversForTrip($trip_id); 
...
<td width="250px;"></td>
<td>
<input type="submit"  class="btn editBtn" value="Confirm Driver" />
</form>
