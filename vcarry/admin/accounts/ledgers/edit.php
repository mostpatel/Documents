...
<?php if(TAX_CLASS==1) { ?>
<tr id="tax_class_tr"  <?php if($ledger['head_id']!=$purchase_head_id && $ledger['head_id']!=$sales_head_id) { ?> style="display:none;" <?php } ?>>
					...
					<select id="head" name="tax_class_id">
                        ...
                        <?php
                            ...
                            foreach($heads as $head)
                             ...
                             <option value="<?php echo $head['tax_class_id']; ?>" <?php if($ledger['tax_class_id']==$head['tax_class_id']){ ?> selected="selected" <?php } ?>><?php echo $head['tax_class'] ?></option>
                             <?php } ?>
...
<td> <input type="text" name="cst_no" value="<?php if(isset($ledger['cst_no']) && $ledger['cst_no']!=0)  echo $ledger['cst_no']; ?>"/> </tr>
</tr>

<tr>
<td> Service Tax Number : </td>
<td> <input type="text" name="service_tax_no" value="<?php if(isset($ledger['service_tax_no']) && $ledger['service_tax_no']!=0)  echo $ledger['service_tax_no']; ?>" /> </tr>
</tr>
