...
<h4 class="headingAlignment">Inventory JV Details</h4>
<?php 
...
<h4 class="headingAlignment">Credit Total : <span id="in_total"><?php echo $total_credit_amount ?> Rs</span></h4>
...
<h4 class="headingAlignment">Debit Total : <span id="ns_total"><?php echo $total_debit_amount; ?> Rs</span></h4>
<?php } ?>
