	...
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable ns_inventory_table" id="productPurchaseTable">
            ...
            <tbody style="display:none" id="p0">
            	<tr>
                    <td><input type="text" name="ns_item_id[]" class="inventory_item_autocomplete1" placeholder="Select Only From Avl Suggestions" /></td>
            ...
            <tbody id="ns<?php echo $i; ?>">
            	<tr >
                    <td><input type="text" name="ns_item_id[]" class="inventory_item_autocomplete" placeholder="Select Only From Avl Suggestions"  /></td>
                    <td><select  name="ns_godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);">
...
<h4 class="headingAlignment">Inwards (Debit) Total : <span id="ns_total"></span></h4>
