...
$regular_ns_items = getNonStockItemForCreditNoteId($sales_id);
}
else
exit; ?>
<div class="insideCoreContent adminContentWrapper wrapper">

<h4 class="headingAlignment">Credit Note Details</h4>
<?php 
...
<tr>
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable" id="nonStockSaleTable">
			...
			$sales_item=$regular_ns_items[$i-1]['credit_note_item_details'];
