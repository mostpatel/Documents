...
<h4 class="headingAlignment"> Purchase </h4>
<?php 
    	...
    	<table width="100%" class="adminContentTable productPurchaseTable" id="productPurchaseTable">
            ...
            <tbody style="display:none" id="p0">
            	<tr>
                    ...
                    <td><input type="text" name="quantity[]" class="item_quantity1" style="width:35px;" value="1" onchange="onchangeQuantity(this);" /><span style="color:#f00;font-size:12px;"></span><select name="unit_id[]" style="width:35px;" class="item_unit">
            ...
            <tbody style="display:none" id="ns0">
            	<tr>
                    <td><input type="text" name="ns_item_id[]" class="inventory_ns_item_autocomplete1" /></td>
                     ...
                     <td><input type="text" name="ns_rate[]" class="item_rate1" style="width:35px;" value="0" onchange="onchangeRateNS(this);" /></td>
                     
                     <td><input type="text" name="ns_disc[]" class="item_disc1" style="width:25px;" value="0" onchange="onchangeDiscNS(this);" /> %</td>
            ...
            <tbody id="ns<?php echo $i; ?>">
            	<tr >
                    <td><input type="text" name="ns_item_id[]" class="inventory_ns_item_autocomplete" /></td>
                     ...
                     <td><input type="text" name="ns_rate[]" class="item_ns_rate" style="width:35px;" value="0" onchange="onchangeRateNS(this);" /></td>
...
<td>Bill Date : </td>
				<td>
					<input type="text" id="bill_date" name="bill_date" class="datepicker4" /> 
