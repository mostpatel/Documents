...
$regular_ns_items = getNonStockItemForDebitNoteId($purchase_id);

}
else
exit; ?>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment"> Debit Note Details</h4>
<?php 
...
<tr>
<td width="220px">Debit Note Date : </td>
				<td>
	...
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable" id="productPurchaseTable">
            ...
            <tbody id="p<?php echo $i; ?>">
            	<tr >
                    <td><?php echo getItemNameFromItemId($purchase_item['item_id']); $barcode = $purchase_item['barcode']; if(validateForNull($barcode))  echo "<br> <img  src='".WEB_ROOT."lib/barcode.php?text=".$barcode."' />"."<br>".$barcode; ?></td>
                    <td align="center"><?php echo number_format($purchase_item['quantity']); ?></td>
...
<tr>
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable" id="nonStockSaleTable">
			...
			$sales_item=$regular_ns_items[$i-1]['debit_note_item_details'];
...
<td width="220px;">Amount : </td>
				<td>
					<?php echo number_format(round($purchase['amount'])); ?> Rs
                            </td>
</tr>
...
<td >Net Amount : </td>
				<td>
					<?php echo number_format(round($purchase['amount']+$total_tax_amount)); ?> Rs
                            </td>
</tr>
...
<a href="<?php echo $_SERVER['PHP_SELF'].'?action=delete&lid='.$purchase_id; ?>"><button title="Edit this entry" class="btn delBtn"><span class="delete">X</span></button></a>
