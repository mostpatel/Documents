...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generateItemWisePurchaseReports($from,$to,$oc_id_string_id,$type,$item_name_array);
		$_SESSION['cPurchaseItemReport']['emi_array']=$reportArray;
		$_SESSION['cPurchaseItemReport']['item_id']=$item_name_array;
		$_SESSION['cPurchaseItemReport']['to']=$to;
		$_SESSION['cPurchaseItemReport']['from']=$from;
		$_SESSION['cPurchaseItemReport']['type']=$type;
		$_SESSION['cPurchaseItemReport']['oc_id']=$oc_id_string;
