...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$id = getItemIdFromFullItemName($_POST['item_name'],1);
		...
		$_SESSION['cStockTransactionReport']['emi_array']=$reportArray;
		$_SESSION['cStockTransactionReport']['to']=$to;
		$_SESSION['cStockTransactionReport']['from']=$from;
		$_SESSION['cStockTransactionReport']['item_id']=$id;
		$_SESSION['cStockTransactionReport']['item_name'] = $name;
		$_SESSION['cStockTransactionReport']['outstanding_amount']=$_POST['outstanding_amount'];
