...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$vehicle_id = getVehicleIdFromRegNo($reg_no);
		
		$reportArray=listJobCardsBetweenDate($from,$to,NULL,$customer_id);
		
		$_SESSION['cJobCardReportCustomerWise']['emi_array']=$reportArray;
		$_SESSION['cJobCardReportCustomerWise']['to']=$to;
		$_SESSION['cJobCardReportCustomerWise']['from']=$from;
		$_SESSION['cJobCardReportCustomerWise']['reg_no']=$reg_no;
