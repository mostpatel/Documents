...
<h4 class="headingAlignment no_print">Edit Tax Class Details</h4>
<?php 
...
<input type="text" name="grp_name" id="txtbank" value="<?php echo $grp['tax_class']; ?>"/> 
</td>
</tr>
					...
					<select id="head" name="tax_form_id">
                        ...
                        <?php
                            ...
                            foreach($heads as $head)
                             ...
                             <option value="<?php echo $head['tax_form_id']; ?>" <?php if( $head['tax_form_id']==$grp['tax_form_id']) { ?> selected="selected" <?php } ?> ><?php echo $head['form_name'] ?></option>
                             <?php } ?>
