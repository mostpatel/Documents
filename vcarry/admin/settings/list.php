     ...
     Manage Customer Groups 
        ...
        <?php if(TAX_MODE==0) { ?>
            <!--  <div class="package">
             ...
             <a href="../accounts/ledgers/driver">
             <div class="squareBox">
                 <div class="imageHolder">
                 </div>
             </div>
...
<h4 class="headingAlignment">Route Settings</h4>
...
<div class="rowOne">
 ...
 <div class="package">
    ...
    Manage Vehicle Types
     ...
     <a href="route_settings/fare_category_settings/">
     <div class="squareBox">
     ...
     <a href="route_settings/route_group_settings/">
     <div class="squareBox">
     ...
     <a href="route_settings/route_settings/">
     <div class="squareBox">
     ...
     <a href="route_settings/sub_route_settings/">
     <div class="squareBox">
     ...
     <a href="route_settings/route_fare_settings/">
     <div class="squareBox">
