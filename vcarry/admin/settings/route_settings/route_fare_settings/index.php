...
require_once "../../../../lib/sub-route-functions.php";
...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertRouteFare($_POST['route_id'],$_POST['vehicle_type_id'],$_POST['fare'],$_POST['fare_category_id'],$_POST['driver_fare']);
				
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Route Group successfully added!";
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=deleteRouteGroup($_GET["lid"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Route Group deleted Successfuly!";
				$_SESSION['ack']['type']=3; // 3 for delete
				}
				else
				{
					$_SESSION['ack']['msg']="Cannot delete Route Group! Route Group already in use!";
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=updateRouteGroup($_POST["lid"],$_POST["name"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Route Group updated Successfuly!";
...
$jsArray=array("jquery.validate.js","validators/fareCategories.js");
