...
function createDropDownModelCompany(vehicle_company_id)
{	
		var xmlhttp1;
...
document.getElementById("vehicle_model").options.add(optn);
  ...
  xmlhttp1.open('GET', "getRelatedModels.php?id="+vehicle_company_id, true );    
  xmlhttp1.send(null);
...
document.getElementById("dealer").options.add(optn1);
  ...
  xmlhttp2.open('GET', "getRelatedDealers.php?id="+vehicle_company_id, true );    
  xmlhttp2.send(null);
