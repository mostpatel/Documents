...
<body>
<div id="backdrop" style="position:fixed;width:100%;height:100%;background:rgba(0,0,0,0.4);z-index:10000000;color:#000;text-align:center;"><div style="position:fixed;top:50%;width:100%;text-align:center;color:#fff;font-family:myFont;font-size:25px;letter-spacing:2px;">Processing...</div></div>
