	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{   
				...
				$result=insertDirectInvoice($_POST["name"], $_POST["product_array"], $_POST["mrp_array"], $_POST["quantity_id_array"], $_POST["customerContact"], $_POST["email"], $_POST["address"], $_POST["city"], $_POST["customer_id"], $_POST["enquiry_id"], $_POST["invoice_date"] );
