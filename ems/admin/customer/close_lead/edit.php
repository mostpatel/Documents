...
<table>
<tr><td>
<input type="radio" name="productStatus" value="1" <?php if($is_bought_var==1) { ?> checked="checked" <?php }?>  onchange="toggleProductStatus(this.value)" id="running"></td><td><label for="running"><?php echo booked ?></label></td></tr>
<tr><td>
<input type="radio" name="productStatus" value="2" <?php if($is_bought_var==2) { ?> checked="checked" <?php }?> id="completed"  onchange="toggleProductStatus(this.value)"></td><td><label for="completed"><?php echo not_booked ?></label></td></tr></table></td>
</tr>
