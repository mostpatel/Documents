...
$noteDetails=getCustomerNoteById($_GET['id']);
...
?>
<form id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=editCustomerNote'; ?>" method="post">
...
<?php echo $noteDetails['customer_note'];?>
</textarea>
</td> 
</tr>
