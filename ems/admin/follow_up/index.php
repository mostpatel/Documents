...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		...
		$_SESSION['DirectFollowUpReport']['leadsReminder_array']=$leadsReminder;
		
		$_SESSION['DirectFollowUpReport']['from_date']=$_POST['from_date'];
		$_SESSION['DirectFollowUpReport']['to_date']=$_POST['to_date'];
