...
<td>
<input type="text" id="datepicker" size="12" autocomplete="off"  name="from_date" class="datepicker1 datepick" value="<?php if(isset($_SESSION['DirectFollowUpReport']['from_date']) && validateForNull($_SESSION['DirectFollowUpReport']['from_date']))
		 { echo $_SESSION['DirectFollowUpReport']['from_date'];} ?>" placeholder="Click to Select!" /><span class="customError DateError">Please select a date!</span>
</td>
</tr>
...
<td>
<input type="text" id="datepicker1" size="12" autocomplete="off"  name="to_date" class="datepicker2 datepick" value="<?php if(isset($_SESSION['DirectFollowUpReport']['to_date']) && validateForNull($_SESSION['DirectFollowUpReport']['to_date']))
		 { echo $_SESSION['DirectFollowUpReport']['to_date'];} ?>" placeholder="Click to Select!" /><span class="customError DateError">Please select a date!</span>
</td>
</tr>
...
<?php
		...
		if(isset($_SESSION['DirectFollowUpReport']['leadsReminder_array']) && is_array($_SESSION['DirectFollowUpReport']['leadsReminder_array']))
		{
			$leadsReminder=$_SESSION['DirectFollowUpReport']['leadsReminder_array'];
		$i=0;
?>
...
<h4 class="headingAlignment">Weekly Follow Up List</h4>
