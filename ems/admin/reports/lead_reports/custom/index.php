...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$leads=viewLeads($_POST['from_date'],$_POST['to_date'], $_POST['min_amount'], $_POST['max_amount'], $_POST['user_id'], $_POST['customer_type_id'], $_POST['leadStatus'], $_POST['product'], $_POST['super_cat_id'], $_POST['cat_id'],$_POST['attribute_name_array'], $_POST['enquiry_group_id'], $_POST['customer_group_id']);
				...
				$_SESSION['cLeadReport']['super_cat_id']=$_POST['super_cat_id'];
				$_SESSION['cLeadReport']['cat_id']=$_POST['cat_id'];
				$_SESSION['cLeadReport']['attribute_name_array']=$_POST['attribute_name_array'];
				$_SESSION['cLeadReport']['enquiry_group_id']=$_POST['enquiry_group_id'];
				$_SESSION['cLeadReport']['customer_group_id']=$_POST['customer_group_id'];
	...
	else if($_GET['action']=='fromHomeUpcomingLeads')
	{
		...
		$_SESSION['cLeadReport']['from_date']=$from;
		$_SESSION['cLeadReport']['to_date']=$to;	
