...
<?php
		...
		if(isset($_SESSION['dailyDoneFollowUpReport']['followUp_array']) && is_array($_SESSION['dailyDoneFollowUpReport']['followUp_array']))
		{
			$leadsReminder=$_SESSION['dailyDoneFollowUpReport']['followUp_array'];
		$i=0;
?>
...
<h4 class="headingAlignment">Daily Done Follow Up List</h4>
