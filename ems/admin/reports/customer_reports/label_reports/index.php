...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$customers=viewCustomersForLabelPrinting($_POST['from_date'],$_POST['to_date'], $_POST['min_amount'], $_POST['max_amount'], $_POST['city_id'], NULL, $_POST['from_date_added'],$_POST['to_date_added'] );
