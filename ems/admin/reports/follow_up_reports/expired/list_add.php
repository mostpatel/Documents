...
<td>
<input type="text" id="datepicker" size="12" autocomplete="off"  name="from_date" class="datepicker1 datepick" value="<?php if(isset($_SESSION['expiredReminderReport']['from_date']) && validateForNull($_SESSION['expiredReminderReport']['from_date']))
		 { echo $_SESSION['expiredReminderReport']['from_date'];} ?>" placeholder="Click to Select!" /><span class="customError DateError">Please select a date!</span>
</td>
</tr>
...
<?php
		...
		if(isset($_SESSION['expiredReminderReport']['followUp_array']) && is_array($_SESSION['expiredReminderReport']['followUp_array']))
		{
			$leadsReminder=$_SESSION['expiredReminderReport']['followUp_array'];
		$i=0;
?>
