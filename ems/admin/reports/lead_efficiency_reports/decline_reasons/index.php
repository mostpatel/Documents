...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$declineReasonsEfficiency = declineReasonAnalysis($_POST['from_date'],$_POST['to_date']);
			
				$_SESSION['dReasonsEfficiencyReport']['dReasons_array']=$declineReasonsEfficiency;
				
				$_SESSION['dReasonsEfficiencyReport']['from_date']=$_POST['from_date'];
				$_SESSION['dReasonsEfficiencyReport']['to_date']=$_POST['to_date'];
