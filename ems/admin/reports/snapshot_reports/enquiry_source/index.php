...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$sourceWiseReport = sourceOfEnquiryWiseReporting($_POST['from_date'],$_POST['to_date']);
			
				$_SESSION['sWiseReport']['sWise_array']=$sourceWiseReport;
				
				$_SESSION['sWiseReport']['from_date']=$_POST['from_date'];
				$_SESSION['sWiseReport']['to_date']=$_POST['to_date'];
