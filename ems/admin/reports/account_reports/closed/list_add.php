...
<td>Area : </td>
				<td>
					<input type="text" name="area" class="city_area" id="city_area1" placeholder="Only Letters" value="<?php if(isset($_SESSION['clFileReport']['area_id'])) echo $_SESSION['clFileReport']['area_id']; ?>" />
                            </td>
</tr>
