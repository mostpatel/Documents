...
<h4 class="headingAlignment no_print">Daliy Reminder Reports</h4>
<?php 
...
<?php
		...
		if(isset($_SESSION['dLeadReminderReport']['leadsReminder_array']) && is_array($_SESSION['dLeadReminderReport']['leadsReminder_array']))
		{
			$leadsReminder=$_SESSION['dLeadReminderReport']['leadsReminder_array'];
		$i=0;
?>
