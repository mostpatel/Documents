...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			...
			$leadsReminder=viewReminders($_POST['from_date'],$_POST['to_date'], NULL, NULL, NULL, NULL, NULL);
			
				$_SESSION['eLeadReminderReport']['leadsReminder_array']=$leadsReminder;
				$_SESSION['eLeadReminderReport']['from_date']=$_POST['from_date'];
				$_SESSION['eLeadReminderReport']['to_date']=$_POST['to_date'];
