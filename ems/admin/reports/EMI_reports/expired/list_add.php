					...
					<select id="customer_city_id" name="city_id" class="city" onchange="createDropDownAreaCustomer(this.value)">
                        ...
                        <?php
                            ...
                            foreach($cities as $super)
                             ...
                             <option value="<?php echo $super['city_id'] ?>" <?php if(isset($_SESSION['eEMIReport']['city_id'])) { if($_SESSION['eEMIReport']['city_id']==$super['city_id']){ ?> selected="selected" <?php }} ?>><?php echo $super['city_name'] ?></option					>
                             <?php } ?>
...
<td>Area : </td>
				<td>
					<input type="text" name="area" class="city_area" id="city_area1" placeholder="Only Letters" value="<?php if(isset($_SESSION['eEMIReport']['area'])) echo $_SESSION['eEMIReport']['area']; ?>" />
                            </td>
</tr>
...
<tr>
    ...
    <td>
    	...
    	<input  type="radio" name="file_status" id="both"  <?php if(isset($_SESSION['eEMIReport']['file_status'])){ if(  $_SESSION['eEMIReport']['file_status']!=1 && $_SESSION['eEMIReport']['file_status']!=2 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">Both</label>
    </td>
</tr>
