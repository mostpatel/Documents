...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertDataFrom($_POST["data_from"]);
				
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Data From successfully added!";
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=deleteDataFrom($_GET["lid"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Data From deleted Successfuly!";
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateDataFrom($_POST["lid"],$_POST["data_from"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Data From updated Successfuly!";
