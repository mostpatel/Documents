...
if(isset($_GET['action']))
{
		if($_GET['action']=='add')
		{
			...
			$result=insertOurCompany($_POST["name"], $_POST["address"], $_POST["pincode"], $_POST["city"], $_POST["prefix"],$_POST["contact"]);
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=updateOurCompany($_POST["id"],$_POST["name"], $_POST["address"], $_POST["pincode"], $_POST["city"], $_POST["prefix"],$_POST["contact"]);
