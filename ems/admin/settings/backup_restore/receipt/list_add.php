...
<td >
<input type="text" id="datepicker" size="12" autocomplete="off"  name="invoice_date" class="datepicker1 datepick" placeholder="Click to Select!" value=<?php $todayDate = getTodaysDate(); echo date('d/m/Y H:i:s',strtotime($todayDate)) ?>/><span class="customError DateError">Please select a date!</span>
