...
if(isset($_GET['action']))
{
		...
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(2, $admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=insertAttributeName($_POST["name"], $_POST["attribute_type_id"], $_POST["super_cat_id"], $_POST["cat_id"], $_POST["sub_cat_id"]);
				
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Attribute Name successfully added!";
	...
	
	{
		...
		if(isset($_SESSION['EMSadminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateSubCategory($_POST["lid"], $_POST["name"],  $_POST["mrp"], $_POST["super_cat_id"], $_POST["cat_id"] );
...
$jsArray=array("jquery.validate.js", "bootstrap-select.js", "getAttributeType.js", "validators/vehicleCompanies.js");
