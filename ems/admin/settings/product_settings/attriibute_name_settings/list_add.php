...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
    ...
    <tbody>
		...
		{
			 $attrNameId = $attributeName['attribute_name_id'];
			 $attributeNameDetails = getAttributeNameById($attrNameId);
			 
			 $attributeName = $attributeNameDetails['attribute_name'];
			 
			 $attributeTypeId = $attributeNameDetails['attribute_type_id'];
			 $attributeTypedetails = getAttributeTypeById($attributeTypeId);
			 $attributeType = $attributeTypedetails['attribute_type'];
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td>
            <span  class="editLocationName" id="<?php echo $attrNameId ?>"><?php echo $attributeName; ?></span>
            </td>
            
            <td>
            <span  class="editLocationName" id="<?php echo $attrNameId ?>"><?php echo $attributeType; ?></span>
            </td>
		  ...
		  $superCat_array = getSuperCatIdsByAttributeTypeIdAndAttributeNameId($attributeTypeId, $attrNameId);
		  ...
		  $cat_array = getCatIdsByAttributeTypeIdAndAttributeNameId($attributeTypeId, $attrNameId);
		  ...
		  $subCat_array = getSubCatIdsByAttributeTypeIdAndAttributeNameId($attributeTypeId, $attrNameId);
