...
function createDropDownCategory(super_cat_id)
{	
		var xmlhttp1;
...
document.getElementById("category").options.add(plsOptn);
...
document.getElementById("category").options.add(optn);

} 
    }
  }
  
  xmlhttp1.open('GET', "getRelatedCategory.php?id="+super_cat_id, true );    
  xmlhttp1.send(null);
...
document.getElementById("dealer").options.add(optn1);
  ...
  xmlhttp2.open('GET', "getRelatedDealers.php?id="+super_cat_id, true );    
  xmlhttp2.send(null);
