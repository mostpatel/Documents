...
function UploadImagee($image, $uploadDir, $max_width=150 , $max_height=150,$prefix=false)
{
    ...
    if (trim($image['tmp_name']) != '') {
		...
		if (($image["type"] == "image/gif") || ($image["type"] == "image/jpeg") || ($image["type"] == "application/vnd.ms-excel") || ($image["type"] == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") || ($image["type"] == "image/jpg") || ($image["type"] == "image/png") || ($image["type"] == "application/pdf"))
		{
		...
		$path_parts = pathinfo($image['tmp_name']);
		 ...
		 chmod($uploadDir.$imagePath,0777);
