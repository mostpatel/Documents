				...
				<ul class="nav navbar-nav">
                   ...
                   <!-- <li class="dropdown">
                    ...
                    <li class="<?php if($page=="categories") echo "active"; ?>">
                   		<a href="categories.php"> Products & Services <i class="fa fa-angle-down"></i></a>
                        
                       <!-- <div class="dropdown-menu">
							<ul>
	                             <li><a href="/building-installations.html">Rail Automation</a></li>
				                <li><a href="/welding-automation.html">Ship Building</a></li>
				                <li><a href="#">Security & Control</a></li>
				                <li><a href="#">Elevators & Escalotors</a></li>
				                <li><a href="#">Transmission & Distribution</a></li>
				                <li><a href="#">Renewables</a></li>
				                <li><a href="#">Oil & Gas</a></li>
				                <li><a href="#">Chemical</a></li>
				                <li><a href="#">Water Treatment</a></li>
                                <li><a href="#">Conveying System</a></li>
				                <li><a href="#">Automative</a></li>
