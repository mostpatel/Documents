...
if(isset($_GET['view']))
{
	...
	else if($_GET['view']=='notice')
	{
		...
		else if($_GET['view']=='finish_notice')
	{
		$showTitle=false;
		$content="finish_notice.php";
		$link="searchEMI";
		}		
	else
	{
...
if(isset($_GET['action']))
{
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateLegalNotice($_POST['legal_notice_id'],$_POST['file_id'],$_POST["notice_date"],$_POST['case_no'],$_POST['remarks'],$_POST['advocate_id'],$_POST['case_type_id'],$_POST['court_id'],$_POST['stage'],$_POST['next_date'],$_POST['type'],$_POST['cheque_return_id'],$_POST['case_petetionar_id'],$_POST['warrant']);
					if($result=="success" )
				{
	...
	if($_GET['action']=='finnish')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=finishLegalNotice($_POST['legal_notice_id'],$_POST['finnish_date'],$_POST["remarks"]);
				
				$_SESSION['ack']['msg']="Case Finnished Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
