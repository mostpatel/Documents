...
<div style="text-align:center; font-weight:bolder; text-decoration:underline; line-height:20px; width:100%;float:left;font-size:20px;">WELCOME LETTER ( પાર્ટી )</div>
...
<div class="prati" style="padding-bottom:0;">રેફ નં. <b><?php echo $file['file_number']; ?> (Party)</b></div>

<div class="customer_address" style="float:left"><b><?php echo $notice['customer_name']; ?></b><br /><pre><?php echo $notice['customer_address'] ?></pre></div>
</div>
...
<b style="text-align:center;width:100%;display:block;">બાબત - વાહન  <?php if ($vehicle) echo "નં. ".$vehicle['vehicle_reg_no']; else echo $notice['vehicle_model']; ?> સંબંધે કરેલ કરાર બાબત</b>          
                                &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; આથી આપશ્રીને આ પત્ર દ્વારા જાણ કરવાની કે, આપશ્રી દ્વારા અમારી પેઢી સાથે વાહન <?php if ($vehicle) echo "નં. ".$vehicle['vehicle_reg_no']." ( ";  echo $notice['vehicle_model']." ) "; ?> ઉપર કરાર કરી અમારી પેઢી સાથે વ્યવહાર પ્રસ્થાપિત કરેલ છે અને અમારી પેઢી સાથે કરેલ કરાર મુજબ ના રોજ માસિક રૂ 
...
<br /><br /><br />   Authorized Signatory  </div> <br /><br />        
