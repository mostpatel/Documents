...
<td class="firstColumnStyling">
Location Image For Map :
</td>

<td>
<img style="background:rgba(0,0,0,0.5);padding:10px;" src="<?php echo WEB_ROOT."images/location_icons/".$city['img_href']; ?>" />
</td>
</tr>
<?php $car_images = getCarosalImagesForLocation($city_id);
...
<br /><br />
<a href="<?php echo $_SERVER['PHP_SELF'].'?action=deleteCarosalImage&id='.$car_image['location_image_id'].'&lid='.$city_id ?>"><button title="Delete this Image" class="btn delBtn"><span class="delete">X</span></button></a>
</td>
</tr>
<?php } ?>
<tr class="no_print">
