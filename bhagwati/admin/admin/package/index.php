...

	{
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))

			{
				...
				$result=insertPackage($_POST["name"],$_POST['location'],$_POST['places'],$_POST['days'],$_POST['nights'], $_POST['currency'], $_FILES['thumb_img'],$_POST['itenary_heading'],$_POST['itenary_description'],$_POST['package_types'],$_POST['tariff'],$_POST['inclusions'],$_POST['exclusions']);
...

	{
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))

			{
				...
				$result=updatePackage($_POST['lid'],$_POST["name"],$_POST['location'],$_POST['places'],$_POST['days'],$_POST['nights'],$_FILES['thumb_img'],$_POST['itenary_heading'],$_POST['itenary_description'],$_POST['package_types'],$_POST['tariff'],$_POST['inclusions'],$_POST['exclusions'],$_POST['currency']);
