		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$reportArray=listStartJourneyInquiries($from,$to,$location_type);
		
				$_SESSION['cStartJourneyReport']['emi_array']=$reportArray;
				
				$_SESSION['cStartJourneyReport']['from']=$from;
				$_SESSION['cStartJourneyReport']['to']=$to;
				$_SESSION['cStartJourneyReport']['location_type']=$location_type;
