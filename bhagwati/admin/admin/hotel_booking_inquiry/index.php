		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$reportArray=listHotelBookingInquiries($from,$to,$location_type);
		
				$_SESSION['cHotelBookingReport']['emi_array']=$reportArray;
				
				$_SESSION['cHotelBookingReport']['from']=$from;
				$_SESSION['cHotelBookingReport']['to']=$to;
				$_SESSION['cHotelBookingReport']['location_type']=$location_type;
