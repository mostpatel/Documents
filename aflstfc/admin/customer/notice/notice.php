...
<?php } else  if($notice['notice_type']==1) { ?>
<div class="guarantor_address" style="float:left;widht:48%;"><?php echo $notice['guarantor_name']; ?>,<br /><pre><?php echo $notice['guarantor_address'] ?></pre></div> <div style="clear:both;"></div> 
<?php } ?>
</div><br /><br /><br /><br />       
