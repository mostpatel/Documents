...
if(isset($_GET['action']))
{
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=updateOurCompany($_POST["id"],$_POST["name"], $_POST["address"], $_POST["pincode"], $_POST["city"], $_POST["prefix"], $_POST['sub_heading'],$_POST["contact"],0,"NA","1970-01-01",0,"1970-01-01",$_POST["retail_invoice_counter"],$_POST["tax_invoice_counter"]);
