...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalSalesReports($from,$to);
		
		$_SESSION['cJobCardWSalesReport']['emi_array']=$reportArray;
		$_SESSION['cJobCardWSalesReport']['to']=$to;
		$_SESSION['cJobCardWSalesReport']['from']=$from;
