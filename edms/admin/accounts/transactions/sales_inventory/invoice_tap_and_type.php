...
<span style="width:95%;text-align:center;font-size:20px;text-transform:uppercase;position:relative;display:block;"><?php echo $our_company['our_company_address']; ?></span>
</div>
<?php } ?>
   <div class="sectionOne" style=" text-transform: uppercase;min-height:0;border-bottom:0;<?php if(!isset($_GET['show_header'])) { ?> margin-top:220px;  <?php } ?>">
       ...
       <div class="leftSectionOne" style="width:69.55%;text-align:left;padding:0;box-sizing:border-box;">
           ...
           <?php if(is_numeric($sales['to_ledger_id']))  echo getLedgerNameFromLedgerId($sales['to_ledger_id']); else
		{
				 ...
				 echo $customer['customer_name'];}   ?> </span>
            </div>
