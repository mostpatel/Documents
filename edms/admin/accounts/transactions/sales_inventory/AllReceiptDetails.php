...
<a href="<?php echo  WEB_ROOT."admin/customer/index.php?view=details&id=".$sales['to_customer_id']; ?>"><input type="button" class="btn btn-success" value="Back to customer Profile"/></a>
