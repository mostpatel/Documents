...
<?php } ?>
   <div class="sectionOne" style=" text-transform: uppercase;min-height:0;border-bottom:0;<?php if(!isset($_GET['show_header'])) { ?> margin-top:220px;  <?php } ?>">
       ...
       <div class="leftSectionOne" style="width:69.55%;text-align:left;padding:0;box-sizing:border-box;">
        ...
        <div class="sectionFour" style="margin:0">
          ...
          <table class="vaibhavTable" style="border-right:2px solid #000;border-left:2px solid #000;">
            ...
            <td align="left" style="font-size:24px;"> <b><?php echo getItemNameFromItemId($inventory_item['item_id']); ?><?php echo $inventory_item['item_desc'] ?></b></td>
