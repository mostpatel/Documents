		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				if(checkForNumeric($result))
				{
					...
					if(isset($_POST['http_referrer']) && $_POST['http_referrer']=="customer")
					{
					header("Location: ".WEB_ROOT."admin/accounts/transactions/sales_inventory/index.php?cid=".$_POST['referrer_id']);
					exit;
					}
					else if(isset($_POST['http_referrer']) && $_POST['http_referrer']=="challan")
					{
					header("Location: ".WEB_ROOT."admin/accounts/transactions/sales_inventory/index.php?id=".$_POST['referrer_id']);
					exit;
					}
					else
					{
