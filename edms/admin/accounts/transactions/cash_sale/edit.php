...
<h4 class="headingAlignment">Edit Sales </h4>
<?php 
...
<td width="220px">Sales Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="payment_date" id="payment_date" class="datepicker1" placeholder="click to select date!" value="<?php echo date('d/m/Y',strtotime($sale['trans_date'])); ?>"/><span class="DateError customError">Please select a date!</span>
                            </td>
</tr>
<!--<tr>
...
<td>By (Debit)<span class="requiredField">* </span> : </td>
				<td>
                   ...
                   <select id="to_ledger" name="to_ledger_id" >
                    <option value="L<?php echo $sale['to_ledger_id']; ?>" ><?php echo  getLedgerNameFromLedgerId($sale['to_ledger_id']); ?></option>			
                      ...
                      <?php 
							...
							{ ?>
                                <select class="sales_ledger_item_wise" name="sales_ledger_id[]" onchange="changeSalesPurchaseLedger(this);" style="margin-bottom:5px;width:170px;">
                                    ...
                                    <?php
                                    $bank_cash_ledgers=listSalesLedgers($sale['oc_id']);
                                    foreach($bank_cash_ledgers as $bank_cash_ledger)
                                    {
                                    ?>
...
<tr>
	<td>Kasar :</td>
    <td><input type="text" name="kasar_amount" id="kasar_amount" placeholder="Only Digits!" value="<?php echo $kasar_payment['amount']; ?>" /><select name="kasar_type">
...
<td width="250px;"></td>
<td>
<input id="disableSubmit" type="submit" value="Edit Sales"  class="btn btn-warning">
<a href="<?php echo  WEB_ROOT."admin/accounts/transactions/cash_sale"; ?>"><input type="button" class="btn btn-success" value="Back"/></a>
</td>
</tr>
