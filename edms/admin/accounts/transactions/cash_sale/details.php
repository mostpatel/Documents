...
$regular_ns_items = getNonStockItemForSaleId($sales_id);
...
<h4 class="headingAlignment">Sales Details</h4>
<?php 
...
<td >Paid : </td>
				<td>
					<?php  echo number_format(round($sale['amount']+$total_tax_amount-$kasar_amount)); ?> Rs
                            </td>
</tr>
...
<td >Kasar : </td>
				<td>
					<?php echo number_format($kasar_amount); ?> Rs
                            </td>
</tr>
