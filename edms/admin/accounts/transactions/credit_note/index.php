...
if(isset($_GET['view']))
{
	...
	else if($_GET['view']=='details')
	{
		...
		if(!is_numeric($sale['credit_note_id']))
		{
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=insertInventoryNonStockCreditNote($_POST["item_id"],$_POST['rate'],$_POST['quantity'],$_POST['disc'],$_POST["ns_item_id"],$_POST['ns_rate'],$_POST['ns_disc'],$_POST['payment_date'],$_POST['delivery_date'],$to_ledger_id,$_POST['from_ledger_id'],$_POST['remarks'],$_POST['godown_id'],$_POST['tax_group_id'],$_POST['ns_tax_group_id'],$_POST['ref'],$_POST['ref_type'],$_POST['unit_id'],$_POST['sales_ledger_id'],$_POST['tax_class_id'],$_POST['ns_sales_ledger_id'],$_POST['ns_tax_class_id'],$_POST['form_no'],$_POST['form_date']); // $cheque_return is 0 when inserting a payment			
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				header("Location: ".WEB_ROOT."admin/accounts/transactions/credit_note/index.php?view=details&id=".$_GET['lid']);
				exit;
				}
			}
			else
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateInventoryNonStockItemCreditNote($_POST["id"],$_POST["item_id"],$_POST['rate'],$_POST['quantity'],$_POST['disc'],$_POST["ns_item_id"],$_POST['ns_rate'],$_POST['ns_disc'],$_POST['payment_date'],$_POST['delivery_date'],$to_ledger_id,$_POST['from_ledger_id'],$_POST['remarks'],$_POST['godown_id'],$_POST['tax_group_id'],$_POST['ns_tax_group_id'],$_POST['ref'],$_POST['ref_type'],$_POST['unit_id'],$_POST['sales_ledger_id'],$_POST['tax_class_id'],$_POST['ns_sales_ledger_id'],$_POST['ns_tax_class_id'],$_POST['form_no'],$_POST['form_date']);
				if($result=="success")
				{	
...
if(isset($link))
$selectedLink=$link;
$jsArray=array("jquery.validate.js","jquery-ui/js/jquery-ui.min.js","addInsuranceProof.js","customerDatePicker.js","validators/addSales.js","validators/addTrans.js","generateProductPurchase.js","getRateQuantityAndTaxForSales.js","getUnitsForItem.js");
