...
<h4 class="headingAlignment">Add a New  <?php echo BROKER_NAME; ?>  </h4>
<?php 
...
<td class="firstColumnStyling">
 <?php echo BROKER_NAME; ?>  Name<span class="requiredField">* </span> : 
</td>
...
<tr>
<td> Opening Balance on <?php echo date('01/04/Y',strtotime(getCurrentDateForUser($_SESSION['edmsAdminSession']['admin_id']))); ?> : </td>
