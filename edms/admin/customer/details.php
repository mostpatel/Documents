...
if(is_array($customer) && $customer!="error")
{
	...
	$receipts = getAllReceiptsForCustomerId($customer_id);
...
<a href="<?php echo WEB_ROOT; ?>admin/customer/delivery_challan/index.php?id=<?php echo $customer_id; ?>"><button class="btn btn-warning">Sell Vehicle / Make Delivery Challan</button></a> <a href="<?php echo WEB_ROOT; ?>admin/customer/vehicle/index.php?id=<?php echo $customer_id; ?>"><button class="btn btn-warning">+ Add Vehicle</button></a> 
...
<?php } else { ?>
<a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/multi_receipt/index.php?cid=<?php echo $customer_id; ?>"><button class="btn btn-success"> Receipt</button></a> 
<?php } ?> 
<a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/delivery_challan/index.php?cid=<?php echo $customer_id; ?>"><button class="btn btn-success"><?php echo DELIVERY_CHALLAN_NAME; ?> </button></a>

 <a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/sales_inventory/index.php?cid=<?php echo $customer_id; ?>"><button class="btn btn-success"><?php echo SALES_NAME; ?></button></a>
 <?php  if(defined('EDMS_MODE') && EDMS_MODE==0) { ?>
 <a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/payment/index.php?cid=<?php echo $customer_id; ?>"><button class="btn btn-success"> Payment</button></a> <a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/jv/index.php?id=<?php echo $customer_id; ?>"><button class="btn btn-success"> JV </button></a>
...
<tr>
<td>Email : </td>
<td><?php if(validateForNull($customer['email'])) echo $customer['email']; else echo "NA"; ?></td>
</tr>
...
<div class="printBtnDiv no_print"><button class="printSectionBtn btn"><i class="icon-print"></i> Print</button></div>
	<div class="no_print">
    <table id="adminContentTable<?php echo $no_of_tables; $no_of_tables++; ?>" class="adminContentTable">
    <thead>
    	<tr>
    ...
    <tbody>
       ...
       <table id="to_print<?php echo $no_of_tables; $no_of_tables++; ?>" class="to_print adminContentTable"></table> 
</div> 
<?php } ?>
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
    ...
    <div class="detailStyling" style="width:100%;">
<hr class="firstTableFinishing" />    
   <h4 class="headingAlignment">List of All Receipts</h4>
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
	<div class="no_print">
		...
		foreach($receipts as $receipt)
		{
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/multi_receipt/index.php?view=details&id='.$receipt['receipt_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/multi_receipt/index.php?view=edit&lid='.$receipt['receipt_id']; ?>"><button title="Edit this entry" class="btn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/multi_receipt/index.php?action=delete&lid='.$receipt['receipt_id'].'&customer_id='.$customer_id;  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
...
document.no_of_tables=<?php echo $no_of_tables;  ?>;
</script>