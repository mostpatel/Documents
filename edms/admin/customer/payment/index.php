	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=addPayment($_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['auto_rasid_type'],0,$_POST['ref'],$_POST['ref_type']); // $cheque_return is 0 when inserting a payment			
				
				if(is_numeric($result))
				{
					$_SESSION['ack']['msg']="Payment successfully added!";
					$_SESSION['ack']['type']=1; // 1 for insert
					header("Location: ".WEB_ROOT."admin/customer/payment/index.php?id=".$_POST["customer_id"]);
					exit;
				}
				...
				header("Location: ".WEB_ROOT."admin/customer/payment/index.php");
				exit;
				}
				else
				{
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				header("Location: ".WEB_ROOT."admin/customer/payment/index.php?id=".$_GET['customer_id']);
				exit;
				}
			}
			else
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updatePayment($_POST["lid"],$_POST["amount"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['from_ledger_id'],$_POST['remarks'],$_POST['ref'],$_POST['ref_type']);
				updateAutoRasidTypeForPaymentId($_POST['lid'],$_POST['auto_rasid_type']);
				if($result=="success")
				{	
				$_SESSION['ack']['msg']="Payment updated Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
				header("Location: ".WEB_ROOT."admin/customer/payment/index.php?view=details&id=".$_POST['lid']);
				exit;
				}
				else{
