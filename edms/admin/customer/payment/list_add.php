...
{
$customer_id=$_GET['id'];
$receipts=getAllNormalPaymentsForCustomer($customer_id);
}
?>
...
<td>Customer <span class="requiredField">* </span> : </td>
				<td>
					<input type="hidden" id="from_ledger" name="from_ledger_id" value="C<?php echo $customer_id; ?>" /> 
		...
		foreach($receipts as $receipt)
		{
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/payment/index.php?view=details&id='.$receipt['payment_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/payment/index.php?view=edit&id='.$receipt['payment_id']; ?>"><button title="Edit this entry" class="btn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/customer/payment/index.php?action=delete&lid='.$receipt['payment_id'].'&customer_id='.$customer_id;  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
