...
<div class="mainInvoiceContainer" style="width:95%;page-break-after: always;">
  ...
  <div class="" style="height:150px;border-bottom:1px solid #000;">
        ...
        <br />
        Next Service Km : <?php echo $job_card_detials['next_service_kms']; ?> Kms
        </div>   <!-- End of cusName -->
        ...
        Date : <?php echo date('d/m/Y',strtotime($job_card_detials['job_card_datetime'])); ?>
         <br />
        Next Service Date : <?php echo date('d/m/Y',strtotime($job_card_detials['next_service_date'])); ?>
        </div>   <!-- End of date -->
