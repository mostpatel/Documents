...
$invoice_counter = $invoice_type['invoice_counter'];
}
else
exit;
 ?>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment"> Finalize Job Card No <?php echo $job_card_detials['job_card_no']; ?> For <?php echo $customer['customer_name']; echo " ( ".$vehicle['vehicle_reg_no']." - ".getModelNameById($vehicle['model_id'])." )"; ?>  </h4>
<?php 
...
<td width="220px">Invoice No<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="invoice_no" id="invoice_no" placeholder="Only Digits!" value="<?php echo $invoice_counter; ?>" readonly />
                            </td>
</tr> 
...
<input type="text" name="bay_out" id="bay_out" class="datetimepicker1" data-format="dd/MM/yyyy hh:mm:ss" placeholder="click to select date!" value="<?php echo date('d/m/Y H:i:s',strtotime(getTodaysDateTime())); ?>" />
 <span class="add-on">
...
<input type="text" name="actual_delivery" id="actual_delivery" class="datetimepicker1" data-format="dd/MM/yyyy hh:mm:ss" placeholder="click to select date!" value="<?php echo date('d/m/Y H:i:s',strtotime(getTodaysDateTime())); ?>" />
 <span class="add-on">
      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
      </i>
    </span>
...
<tr>
<td width="220px">Next Service Date (<?php if($next_service_date && $next_service_date!="1970-01-01") echo date('d/m/Y',strtotime($next_service_date)); else echo "-"; ?>) : </td>
				<td>
                <div id="datetimepicker5" class="input-append date">
<input type="text" name="next_service_date" id="next_service_date" class="datetimepicker2" data-format="dd/MM/yyyy hh:mm:ss" placeholder="click to select date!" value="<?php echo date('d/m/Y H:i:s',strtotime(getTodaysDateTime())); ?>" />
 <span class="add-on">
      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
      </i>
    </span>
...
<tr>
<td width="220px">Next Service Kms<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="next_service_kms" id="next_service_kms" placeholder="Only Digits!" value=""  />
                            </td>
</tr> 
...
<td width="250px;"></td>
<td>
<input id="disableSubmit" type="submit" value="Finalize Job Card"  class="btn btn-warning">
