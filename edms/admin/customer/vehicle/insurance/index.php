...
if(isset($_GET['action']))
{
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertInsurance($_POST["issue_date"],$_POST['exp_date'],$_POST['idv'],$_POST['premium'],$_POST['insurance_company_id'],$_POST['vehicle_id'],$_POST['customer_id'],$_FILES['insuranceImg'],$_POST['insuranceImg']);
				...
				header("Location: ".WEB_ROOT."admin/customer/vehicle/insurance/index.php?id=".$_POST['vehicle_id']."&state=".$_POST['customer_id']);
				exit;
				}
			}
			else
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=updateInsurance($_POST["lid"],$_POST['vehicle_id'],$_POST["issue_date"],$_POST['exp_date'],$_POST['idv'],$_POST['premium'],$_POST['insurance_company_id'],$_FILES['insuranceImg'],$_POST['insuranceImg']);
				
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Insurance updated Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
				header("Location: ".WEB_ROOT."admin/customer/vehicle/insurance/index.php?view=insuranceDetails&id=".$_POST['vehicle_id']."&state=".$_POST['lid']);
				exit;
				}
				else
				{
