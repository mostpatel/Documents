...
<tr>
  ...
  <td class="no_print"> 
             ...
             <a href="<?php echo $_SERVER['PHP_SELF'].'?view=editInsurance&id='.$vehicle_id.'&state='.$insurance_id; ?>"><button title="Edit this entry" class="btn splEditBtn editBtn"><span class="delete">E</span></button></a>
            <a href="<?php echo $_SERVER['PHP_SELF'].'?view=details&id='.$vehicle_id.'&state='.$customer_id; ?>"><button  class="btn btn-success">Back</button></a>
            </td>
</tr> 
...
<tr>
  ...
  <td class="no_print">
             ...
             <a href="<?php echo $_SERVER['PHP_SELF'].'?action=delInsuranceImg&id='.$vehicle_id.'&state='.$img['insurance_img_id']; ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
  </td>          
</tr>        
