...
function insertInventoryItem($name,$alias,$item_code,$item_unit_id,$manufacturer_id,$mfg_item_code,$dealer_price,$mrp,$opening_quantity,$opening_rate,$remarks,$item_type_id,$min_quantity,$opening_godown_id,$tax_group_id,$use_barcode,$barcode_prefix,$barcode_counter,$barcode_array,$gen_barcode,$tax_calculation=0){
