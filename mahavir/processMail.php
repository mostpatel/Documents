...
if($_SERVER['REQUEST_METHOD'] == "POST" && $_GET['action'] == "start_journey")  
{
	...
	$package_type=$_POST['contact_package_type'];
	...
	$result=insertStartJourneyInquiry($name,$email,$phone,$booking_date,$location_type,$package_type,$destination,$no_nights,$inquiry,$adult,$child);
