...
function listAreas(){
	...
	try
	{
		$sql="SELECT area_id,area_name,city_id,pincode
		      FROM fin_city_area";
		$result=dbQuery($sql);	 
...
function listAreasAlpha(){
	...
	try
	{
		$sql="SELECT area_id,city_id,area_name,pincode
		      FROM fin_city_area
			  ORDER BY area_name";
		$result=dbQuery($sql);	 
		$resultArray=dbResultToArray($result);
...
function insertArea($name,$city_id,$pincode="000000"){
	...
	try
	{
		...
		$sql="INSERT INTO
		      fin_city_area (area_name, city_id,pincode)
			  VALUES
...
function insertAreaExternally($name,$city_id,$pincode="000000"){
...
function updateArea($id,$name,$city_id,$pincode){
	...
	try
	{
		...
		$sql="UPDATE fin_city_area
			  SET area_name='$name', city_id=$city_id, pincode = '$pincode'
			  WHERE area_id=$id";	  
		dbQuery($sql);
		return "success";	
		}
