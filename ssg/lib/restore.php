...
while($query_done==0)
{
$sql="SELECT vehicle_type_id FROM fin_vehicle_type";
$result=dbQuery($sql);

if(is_numeric(dbNumRows($result)) && dbNumRows($result)>0)
$query_done=0;
else
$query_done=1;
}
...
$query_array=explode("INSERT",$query);
