...
function insertInsurance($issue_date,$issue_exp_date,$idv,$premium,$insurance_company_id,$file_id,$customer_id,$insurance_img_array,$scanImg,$policy_no="NA",$cover_note_no="NA"){
	...
	try
	{
		...
		$sql="INSERT INTO fin_vehicle_insurance
		      (insurance_issue_date, insurance_expiry_date, idv, insurance_premium, insurance_company_id, policy_no, cover_note_no,  file_id, customer_id, created_by, last_updated_by, date_added, date_modified)
			  VALUES ('$issue_date', '$issue_exp_date', $idv, $premium, $insurance_company_id, '$policy_no', '$cover_note_no',  $file_id, $customer_id, $admin_id, $admin_id, NOW(), NOW())";
		dbQuery($sql);
...
function updateInsurance($id,$issue_date,$issue_exp_date,$idv,$premium,$insurance_company_id,$file_id,$insurance_img_array,$scanImg,$policy_no="NA",$cover_note_no="NA"){
	...
	try
	{
		...
		$sql="UPDATE fin_vehicle_insurance
		      SET insurance_issue_date = '$issue_date', insurance_expiry_date = '$issue_exp_date', idv = $idv, insurance_premium = $premium, insurance_company_id = $insurance_company_id, policy_no ='$policy_no', cover_note_no = '$cover_note_no', last_updated_by = $admin_id,  date_modified = NOW()
