...
<div id="unReceivedWelcomeLetterModal" style="z-index:1000000;" class="modal fade no_print"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" >
    <div class="modal-content" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Unreceived Welcome Letters are pending!</h4>
      </div>
      <div class="modal-body">
...
<div style="padding-bottom:10px;">Current Company : <b><?php echo $our_company_name; ?></b> (Ctrl + F2) To change</div> <?php } ?>