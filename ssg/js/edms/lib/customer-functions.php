...
function insertCustomer($name,$address,$city_id,$area,$pincode,$contact_no,$human_proof_type_id,$proofno,$proofImg,$pan_no="NA",$tin_no="NA",$notes="NA",$opening_balance=0,$opening_cd=0){	
	try
	{
		...
		$name = ucwords(strtolower($name));
			...
			if(validateForNull($name,$address,$contact_no) && checkForNumeric($city_id,$pincode,$our_company_id,$area_id)  && !empty($contact_no))
			{
