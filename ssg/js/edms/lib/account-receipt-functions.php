...
function insertReceiptForSalesId($sales_id,$amount,$trans_date,$to_ledger,$from_ledger,$remarks,$kasar_amount,$kasar_type) // type =5
{
...
function updateReceiptForSalesId($sales_id,$id,$amount,$trans_date,$to_ledger,$from_ledger,$remarks,$kasar_amount=0,$kasar_type=0) // $to_ledger should start with C for customer or L for ledger
{
	$admin_id=$_SESSION['edmsAdminSession']['admin_id'];
