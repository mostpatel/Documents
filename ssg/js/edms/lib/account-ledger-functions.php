...
function listLedgers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listSuppliers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 1 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listOutsideLabourProviders($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 4 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listSalesman($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 2 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function listFinancers($like_term=false){
	...
	try
	{
		...
		$sql="SELECT ledger_id, ledger_name,address,head_id,postal_name, edms_city.city_id, area_id, pincode, pan_no, sales_no,opening_balance, opening_date, opening_cd,notes,  edms_ac_ledgers.oc_id, edms_ac_ledgers.our_company_id,edms_ac_ledgers.date_added, edms_ac_ledgers.date_modified, edms_ac_ledgers.last_updated_by, city_name
		  FROM edms_ac_ledgers,edms_city";
		$sql=$sql." WHERE ledger_type = 3 AND edms_ac_ledgers.city_id=edms_city.city_id  AND edms_ac_ledgers.our_company_id=$our_company_id AND ";
...
function getCustomerLedgerIDFromLedgerNameLedgerId($name)
{
	if(validateForNull($name))
	{
		...
		$sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',IFNULL(vehicle_reg_no,''), ' | [C',edms_customer.customer_id,']') as full_ledger_name FROM edms_customer LEFT JOIN edms_vehicle ON edms_vehicle.customer_id = edms_customer.customer_id HAVING full_ledger_name='$name'";
...
function getCustomerLedgerNameFromLedgerNameLedgerId($id)
{
	if(validateForNull($id))
	{
		...
		$sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',IFNULL(vehicle_reg_no,''), ' | [C',edms_customer.customer_id,']') as full_ledger_name FROM edms_customer LEFT JOIN edms_vehicle ON edms_vehicle.customer_id = edms_customer.customer_id WHERE edms_customer.customer_id = $suffix";
...
if($like_term!=false)
{
	$sql=$sql."AND ledger_name LIKE '%$like_term%' ";
		  ...
		  $sql=$sql." UNION ALL 
		  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',IFNULL(vehicle_reg_no,'')) as name, edms_city.city_id,  oc_id, our_company_id,city_name
		  FROM edms_customer
...
function listCustomerLegders()
{
	...
	$sql=$sql."  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',IFNULL(vehicle_reg_no,'')) as name, edms_city.city_id,  oc_id, our_company_id,city_name
		  FROM edms_customer
		  LEFT JOIN edms_city ON edms_customer.city_id=edms_city.city_id
		  LEFT JOIN edms_vehicle ON edms_vehicle.customer_id=edms_customer.customer_id
		  WHERE 
...
function insertLedger($name,$postal_name,$address,$city_id,$area,$pincode,$head_id,$contact_no,$pan_no,$sales_no,$notes,$opening_balance,$opening_balance_cd,$oc_id=null,$type=0){
...
function checkforDuplicateLedger($ledger_name)
{
	if(validateForNull($ledger_name))
	{
	$admin_id=$_SESSION['edmsAdminSession']['admin_id'];	
	...
	try
	{
		...
		else if($current_company[1]==2) // if combined agency
		{
			...
			$oc_ids=implode(',',$oc_id_array);
			  ...
			  $sql="SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',file_number,' ',IFNULL(vehicle_reg_no,'')) as name, oc_id, our_company_id
			  FROM edms_customer
...
{
			  $sql=$sql." UNION ALL 
			  SELECT CONCAT('C',edms_customer.customer_id) as id, CONCAT(customer_name,' ',file_number,' ',IFNULL(vehicle_reg_no,'')) as name,  oc_id, our_company_id
			  FROM edms_customer
			  LEFT JOIN edms_file ON edms_customer.file_id=edms_file.file_id
			  LEFT JOIN edms_vehicle ON edms_vehicle.file_id=edms_customer.file_id
			  WHERE 
