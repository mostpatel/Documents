			...
			foreach($payments as $payment)
			{
				...
				$from_customer_id=$payment['from_customer_id'];
				 ...
				 <tr class="resultRow">
				   ...
				   <td><?php if($head_type==1) $openingBalance=$openingBalance+$payment['amount']; else if($head_type==0) $openingBalance=$openingBalance-$payment['amount']; if($openingBalance>=0) echo round($openingBalance)." Dr"; else echo round(-$openingBalance,2)." Cr";  ?>
					</td>
				...
				{	
					...
					$to_customer_id=$payment['to_customer_id'];
					 ...
					 <tr class="resultRow">
					   ...
					   <td><?php if($head_type==0) $openingBalance=$openingBalance+$payment['amount']; else if($head_type==1) $openingBalance=$openingBalance-$payment['amount']; if($openingBalance>=0) echo round($openingBalance,2)." Dr"; else echo round(-$openingBalance,2)." Cr";  ?>
						</td>
                         <td><?php echo $payment['remarks']; ?></td>
                    <td><?php echo getAdminUserNameByID($payment['last_updated_by']); ?></td>
	...
	$credit_string = $credit_string.$name." <br>";
		...
		?>
         <tr class="resultRow">
            ...
            <td><?php if($jv_type==0) // if it is a accounts ledger and a debit jv
             ...
             <td><?php if($jv_type==0) $openingBalance=$openingBalance+$payment['amount']; else if($jv_type==1) $openingBalance=$openingBalance-$payment['amount']; if($openingBalance>=0) echo round($openingBalance,2)." Dr"; else echo round(-$openingBalance,2)." Cr";  ?>
            </td>
            <td><?php echo $payment['remarks']; ?></td>
                    <td><?php echo getAdminUserNameByID($payment['last_updated_by']); ?></td>
             <td class="no_print"> <a href="<?php 
		...
		$from_ledger_id=$payment['from_ledger_id'];
         ...
         <tr class="resultRow">
           ...
           <td><?php if($to_ledger_id==$ledger_id) $openingBalance=$openingBalance+$payment['amount']; else if($from_ledger_id==$ledger_id) $openingBalance=$openingBalance-$payment['amount']; if($openingBalance>=0) echo round($openingBalance,2)." Dr"; else echo round(-$openingBalance,2)." Cr";  ?>
            </td>
             <td><?php echo $payment['remarks']; ?></td>
                    <td><?php echo getAdminUserNameByID($payment['last_updated_by']); ?></td>
