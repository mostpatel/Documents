...
<a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/contra/index.php"><button class="btn btn-success"> Contra</button></a>
    <a href="<?php echo WEB_ROOT; ?>admin/accounts/transactions/multi_jv/index.php"><button class="btn btn-success"> Multi JV</button></a>
     <a href="<?php echo WEB_ROOT; ?>admin/accounts/ledgers/index.php"><button class="btn btn-success"> Add Ledger</button></a>
      <button class="btn btn-success" id="change_ac_settings"> Change Account Settings</button>
...
<td width="220px">Payment Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="payment_date" id="payment_date" class="datepicker1" placeholder="click to select date!" value="<?php echo date('d/m/Y',strtotime(getCurrentDateForUser($_SESSION['adminSession']['admin_id']))); ?>" autofocus="autofocus"/><span class="DateError customError">Please select a date!</span>
                            </td>
</tr>
...
<td>By (Debit)<span class="requiredField">* </span> : </td>
				<td>
					<select id="by_ledger" name="from_ledger_id" onchange="getLedgerOpeningBalance(this.value,this,0)" >
...
<td width="220px">Amount<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="amount" id="amount" onchange="onChangeTransactionAmount('by_ledger','to_ledger')" placeholder="Only Digits!" value="<?php echo $emi; ?>" /><span class="DateError customError">Amount Should less than <?php echo -$balance; ?> Rs. !</span>
                            </td>
</tr>
      ...
      _createAutocomplete: function() {
        ...
        this._on( this.input, {
          autocompleteselect: function( event, ui ) {
			...
			getLedgerOpeningBalance(ui.item.option.value,this.element[0],1);	
