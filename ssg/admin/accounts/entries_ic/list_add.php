...
foreach($credit_details as $debit_detail)
{
   ...
   <table id="to_print" style="width:100%;" class="to_print adminContentTable"></table> 
    ...
    top:0;left:0;display:block;margin-top:50px;">Net Interest : <?php  if($total_debit_interest>=$total_credit_interest){ $net_interest= $total_debit_interest - $total_credit_interest; echo $net_interest." (IN)"; if($net_interest>=$tds_on_amount){ echo "TDS Payeable : "; echo $net_interest*$tds_rate/100; }} else { echo  $total_credit_interest - $total_debit_interest; echo "(IN)"; }  ?></span>
<?php  ?>      
</div>
