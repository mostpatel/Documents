		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertNotice($_POST['file_id'],$_POST["notice_date"],$_POST['customer_name'],$_POST['customer_address'],$_POST['guarantor_name'],$_POST['guarantor_address'],$_POST['bucket'],$_POST['bucket_amount'],$_POST['note']);
