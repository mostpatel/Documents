		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				,$_POST['cash_amount'],$_POST['agency_amount'],$_POST['agency_emi'],$_POST['agency_duration'],$_POST['duration_unit'],$_POST['secondary_customer_name'],$_POST['secondary_guarantor_name'],$_POST['secondary_customer_address'],$_POST['secondary_guarantor_address']);
