...
?>
<div class="addDetailsBtnStyling no_print"><a href="<?php echo WEB_ROOT ?>admin/customer/welcome/index.php?id=<?php echo $file_id; ?>"><button class="btn btn-success">Issue Welcome Letter</button></a></div>
