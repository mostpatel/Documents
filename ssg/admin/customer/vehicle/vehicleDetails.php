...
<td>
<?php echo date('d/m/Y',strtotime($vehicle["tax_exp_date"])); ?>
...
<tr>
       <td width="150px">RTO Papers :</td>
           
           
        <td>
              <table>
               <tr><td><input type="radio"   name="rto" readonly="readonly"  value="1" <?php if($vehicle['rto_papers']==1) { ?> checked="checked" <?php } ?> ></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="rto"  readonly="readonly"    value="0" <?php if($vehicle['rto_papers']==0) { ?> checked="checked" <?php } ?>></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Passing :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"  readonly="readonly"     name="passing"  value="1" <?php if($vehicle['passing']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  readonly="readonly"    name="passing"  value="0" <?php if($vehicle['passing']==0) { ?> checked="checked" <?php } ?> ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Permit :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"  readonly="readonly"    name="permit"  value="1" <?php if($vehicle['permit']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  readonly="readonly"    name="permit"  value="0" <?php if($vehicle['permit']==0) { ?> checked="checked" <?php } ?> ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Insurance :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"  readonly="readonly"    name="insurance"  value="1" <?php if($vehicle['insurance']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  readonly="readonly"    name="insurance"  <?php if($vehicle['insurance']==0) { ?> checked="checked" <?php } ?> value="0" ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 ...
 <tr>
       <td>HP :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"  readonly="readonly"    name="insurance"  value="1" <?php if($vehicle['hp']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  readonly="readonly"    name="insurance"  <?php if($vehicle['hp']==0) { ?> checked="checked" <?php } ?> value="0" ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
