...
<td>
<input type="text"  placeholder="Click to select Date!" name="tax_exp_date" class="datepicker3 date" onchange="onChangeDate(this.value,this)" value="<?php echo date('d/m/Y',strtotime($vehicle['tax_exp_date'])); ?>"/><span class="ValidationErrors contactNoError">Please select a date!</span>
</td>
</tr>
...
<tr>
       <td width="220px;">RTO Papers<span class="requiredField">* </span> :</td>
           
           
        <td>
              <table>
               <tr><td><input type="radio"   name="rto"  value="1" <?php if($vehicle['rto_papers']==1) { ?> checked="checked" <?php } ?> ></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="rto"  value="0" <?php if($vehicle['rto_papers']==0) { ?> checked="checked" <?php } ?>></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Passing<span class="requiredField">* </span> :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"   name="passing"  value="1" <?php if($vehicle['passing']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="passing"  value="0" <?php if($vehicle['passing']==0) { ?> checked="checked" <?php } ?> ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Permit<span class="requiredField">* </span> :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"   name="permit"  value="1" <?php if($vehicle['permit']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="permit"  value="0" <?php if($vehicle['permit']==0) { ?> checked="checked" <?php } ?> ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
 <tr>
       <td>Insurance<span class="requiredField">* </span> :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"   name="insurance"  value="1" <?php if($vehicle['insurance']==1) { ?> checked="checked" <?php } ?>></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="insurance"  <?php if($vehicle['insurance']==0) { ?> checked="checked" <?php } ?> value="0" ></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
  ...
  <tr>
       <td>HP<span class="requiredField">* </span> :</td>
        ...
        <td>
              <table>
               <tr><td><input type="radio"   name="hp"  value="1"  <?php if($vehicle['hp']==1) { ?> checked="checked" <?php } ?> ></td><td>Yes</td></tr>
            <tr><td><input type="radio"  name="hp"  value="0"  <?php if($vehicle['hp']==0) { ?> checked="checked" <?php } ?>></td><td>No</td>
               </tr> 
            </table>
        </td>
 </tr>
