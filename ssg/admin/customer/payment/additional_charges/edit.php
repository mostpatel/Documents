...
<td>By (Account)<span class="requiredField">* </span> : </td>
				<td>
					...
					{
					?>
                    <option value="<?php echo $bank_cash_ledger['ledger_id']; ?>" <?php if($cheque_details && $cheque_details['ledger_id']==$bank_cash_ledger['ledger_id']) { ?> selected="selected"<?php } else if(!$cheque_details && isset($default_bank) && is_numeric($default_bank) && $default_bank==$bank_cash_ledger['ledger_id']) { ?> selected="selected" <?php } ?>><?php echo $bank_cash_ledger['ledger_name']; ?></option>					
                    <?php	
						}
					 ?>
                    </select>
