...
<a href="<?php echo WEB_ROOT ?>admin/customer/payment/additional_charges/index.php?view=payments&id=<?php echo $file_id; ?>"><input type="button" value="Back" class="btn btn-success" /></a>
</td>
</tr>
