...
<td width="220px">Payment Amount<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" placeholder="Only Digits" name="amount" id="amount" value="<?php echo $totalPayment; ?>" <?php if(isset($_SESSION['adminSession']['admin_rights']) && !(in_array(9,$admin_rights)|| in_array(7,$admin_rights))) { ?> readonly="readonly" <?php } ?> /><span class="DateError customError">Amount Should less than <?php echo -$balance; ?> Rs. !</span>
                            </td>
</tr>
