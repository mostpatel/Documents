...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalFileReports($from,$to,$city_id,$area_id_string,$file_status,$agency_id,$noc_status);
		$_SESSION['clNonNocFileReport']['file_array']=$reportArray;
		
		$_SESSION['clNonNocFileReport']['from']=$from;
		$_SESSION['clNonNocFileReport']['to']=$to;
		$_SESSION['clNonNocFileReport']['remainder_status']=$remainder_status;
		$_SESSION['clNonNocFileReport']['city_id']=$city_id;
		$_SESSION['clNonNocFileReport']['area_id_array']=$area_array;
		$_SESSION['clNonNocFileReport']['agency_id']=$agency_id;
		$_SESSION['clNonNocFileReport']['file_status']=$file_status;
	$_SESSION['clNonNocFileReport']['noc_status']=$noc_status;
