...
<tr>
    ...
    <td>
		...
		<input  type="radio" name="noc_status" id="closed" value="2" <?php if(isset($_SESSION['clNonNocFileReport']['noc_status'])){ if( $_SESSION['clNonNocFileReport']['noc_status']==0 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed">No</label>
    	
    	<input  type="radio" name="noc" id="both"  <?php if(!isset($_SESSION['clNonNocFileReport']['noc_status']) || ($_SESSION['clNonNocFileReport']['noc_status']!=1 && $_SESSION['clNonNocFileReport']['noc_status']!=0 && $_SESSION['clNonNocFileReport']['noc_status']!=5 && $_SESSION['clNonNocFileReport']['noc_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    <div class="showColumns">
        ...
        <input class="showCB" type="checkbox" id="3" checked="checked"  /><label class="showLabel" for="3">Last Payment Date</label> 
