					...
					<select id="agency_id" name="agency_id[]" class="city_area selectpicker" multiple="multiple" >
                        ...
                        <?php
                            ...
                            foreach($agencies as $super)
                             ...
                             <option value="ag<?php echo $super['agency_id'] ?>" <?php if(isset($_SESSION['cRasidReportEntry']['agency_id'])){ if(in_array("ag".$super['agency_id'],$_SESSION['cRasidReportEntry']['agency_id']))  { ?> selected="selected" <?php }} ?>><?php echo $super['agency_name'] ?></option>
                             ...
                             <option value="oc<?php echo $com['our_company_id'] ?>" <?php if(isset($_SESSION['cRasidReportEntry']['agency_id'])){ if(in_array("oc".$com['our_company_id'],$_SESSION['cRasidReportEntry']['agency_id'])) { ?> selected="selected" <?php }} ?> ><?php echo $com['our_company_name'] ?></option>
...
<td>
	<select id="type_rasid" name="type[]" class="city_area selectpicker" multiple="multiple" >
                             ...
                             <option value="1" <?php if(isset($_SESSION['cRasidReportEntry']['type_array'])){ if(in_array(1,$_SESSION['cRasidReportEntry']['type_array']))  { ?> selected="selected" <?php }} ?>>EMI Payments</option>
                             
                              <option value="2" <?php if(isset($_SESSION['cRasidReportEntry']['type_array'])){ if(in_array(2,$_SESSION['cRasidReportEntry']['type_array']))  { ?> selected="selected" <?php }} ?>>Penalty / additional Payments</option>
                              
                               <option value="3" <?php if(isset($_SESSION['cRasidReportEntry']['type_array'])){ if(in_array(3,$_SESSION['cRasidReportEntry']['type_array']))  { ?> selected="selected" <?php }} ?>>File Closure Payments</option>
		...
		foreach($emi_array as $emi)
		{
         ...
         <td class="no_print"><input type="checkbox" class="selectTR" name="selectTR"  /></td>
            ...
            <td><?php echo $emi['file_agreement_no']; ?></td>
             ...
             <td><?php $chequeDetails=getChequeDetailsFromEmiPaymentId($emi['emi_payment_id']); $mode=$emi['payment_mode']; if($mode==1) { $total=$total+$emi['payment_amt']; echo "CASH";} else { echo "CHEQUE (".$chequeDetails['cheque_no']." )"; $cq_total=$cq_total+$emi['payment_amt']; } ?>
            </td>
