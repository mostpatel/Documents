<?php $payment_should_be_done_after_date = getTodaysDateTimeBeforeMonthsAndDays(3,5);
$payment_should_be_done_before_date = getTodaysDateTimeBeforeMonthsAndDays(2,15); ?>
...
<h4 class="headingAlignment no_print">Third Report</h4>
<?php 
