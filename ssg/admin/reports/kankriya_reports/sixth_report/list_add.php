<?php $payment_should_be_done_after_date = getTodaysDateTimeBeforeMonthsAndDays(5,0);
$payment_should_be_done_before_date = getTodaysDateTimeBeforeMonthsAndDays(4,0); ?>
...
<h4 class="headingAlignment no_print">Sixth Report</h4>
<?php 
