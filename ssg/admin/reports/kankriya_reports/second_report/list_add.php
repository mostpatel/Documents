<?php $payment_should_be_done_after_date = getTodaysDateTimeBeforeMonthsAndDays(2,0); $ten_days_befor_date = getTodaysDateTimeBeforeMonthsAndDays(1,10);
...
<h4 class="headingAlignment no_print">Office Notice Reports (Last Paid)</h4>
<?php 
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    ...
    <tbody>
		...
		foreach($emi_array as $emi)
		{
			...
			$seieze=false;
			if((($_SESSION['cEMIReport']['seized']==1 && $seieze) || !$seieze) && $last_payment_month!=$ten_days_befor_month)
			{
		 ?>
         <tr class="resultRow">
