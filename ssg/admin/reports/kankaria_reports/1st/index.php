...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$from = date('d/m/Y',strtotime(getTodaysDate()));
		$to = getTodaysDateTimeBeforeMonthsAndDays(2,10);
		$win_gt=0.01;
		...
		$_SESSION['cEMIReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cEMIReport']['agency_id']=$agency_id;
		$_SESSION['cEMIReport']['file_status']=$file_status;
		$_SESSION['cEMIReport']['seized']=$_POST['seized'];
