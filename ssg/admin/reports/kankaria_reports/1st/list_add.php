...
<td>From Date (EMI date) : </td>
				<td>
				 <select name="start_day" id="start_day"  >
                 	<?php for($i=1;$i<32;$i++) { ?>
                    	<option value="<?php echo $i; ?>" <?php if(isset($_SESSION['cEMIReport']['from'])) { ?> selected="selected" <?php } ?>><?php echo $i; ?></option>
                    <?php } ?>
                 </select>	
                 </td>
</tr>
...
<td>Up To Date (EMI date) : </td>
				<td>
				 <select name="end_day" id="end_day"  >
                 	<?php for($i=1;$i<32;$i++) { ?>
                    	<option value="<?php echo $i; ?>" <?php if(isset($_SESSION['cEMIReport']['to'])) { ?> selected="selected" <?php } ?>><?php echo $i; ?></option>
                    <?php } ?>
                 </select>	
                 </td>
</tr>
