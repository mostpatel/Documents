...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cbLoanReport']['remainder_array']=$reportArray;
		
		$_SESSION['cbLoanReport']['from']=$from;
		$_SESSION['cbLoanReport']['to']=$to;
		$_SESSION['cbLoanReport']['remainder_status']=$remainder_status;
		$_SESSION['cbLoanReport']['city_id']=$city_id;
		$_SESSION['cbLoanReport']['area_id_array']=$area_array;
		$_SESSION['cbLoanReport']['agency_id']=$agency_id;
		$_SESSION['cbLoanReport']['file_status']=$file_status;
