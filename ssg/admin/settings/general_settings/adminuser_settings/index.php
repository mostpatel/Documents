...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		$result=insertAdminUser($_POST["name"], $_POST["username"], $_POST["password"], $_POST["email"], $_POST["right"],$_POST["oc_id"],$_POST['agency_id']);
	...
	if($_GET['action']=='edit')
	{
		...
		updateCompaniesForUser($_POST["lid"],$_POST["oc_id"],$_POST['agency_id']);
