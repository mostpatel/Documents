...
{
	?>
  <input id="<?php echo $right['our_company_id'] ?>" type="checkbox" name="oc_id[]" value="<?php echo $right['our_company_id'] ?>" class="insertCheckBox"  /> <label class="insertCheckBoxLabel" for="<?php echo $right['our_company_id'] ?>"><?php echo $right['our_company_name'] ?></label> 
<?php    
}
...
{
	?>
  <input id="<?php echo $right['agency_id'] ?>" type="checkbox" name="agency_id[]" value="<?php echo $right['agency_id'] ?>" class="insertCheckBox"  /> <label class="insertCheckBoxLabel" for="<?php echo $right['agency_id'] ?>"><?php echo $right['agency_name'] ?></label> 
<?php    
}
?>
