 ...
 <div class="col-sm-12">
     ...
     <div class="departurelist" >
     	<div class="row voffset4">
			<div class="col-sm-9" ><h2><a href="#">Group Tours</a></h2>
        </div>
		<div class="row departureitem">  
			<div class="col-sm-12">	
   				 <?php for($i=0;$i<count($group_tours);$i++) { 
				 $car_images = getCarosalImagesForPackageCategory($group_tours[$i]['pkg_cat_id']);
				 ?>
                   
                      <div class="col-md-4 col-sm-6 col-xs-12" style="margin-top:10px;margin-bottom:20px;">
                          
                       <div class="imagebox"> <a href="packageCategory.php?id=<?php echo $group_tours[$i]['pkg_cat_id'] ?>" title="<?php echo $group_tours[$i]['pkg_cat_name']; ?>"><img src="<?php echo WEB_ROOT."images/car_images/".$car_images[0]['img_href']; ?>" alt="<?php echo $group_tours[$i]['pkg_cat_name']; ?>" class="img-responsive fullwidth"></a> </div>
          <div class="content clearfix" style="padding:7.5px;min-height:100px;padding-bottom:0px;">
            <h2  style="font-size:14px"><a style="font-size:14px" href="packageCategory.php?id=<?php echo $group_tours[$i]['pkg_cat_id'] ?>" title="<?php echo $group_tours[$i]['pkg_cat_name']; ?>"><?php echo $group_tours[$i]['pkg_cat_name'] ?></a></h2>
