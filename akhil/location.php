...
$package_category = getLocationByID($package_category_id);
$car_images = getCarosalImagesForLocation($package_category_id);
$packages = listPackagesForLocationId($package_category_id);
...
<div class="row body_content clearfix clr" style="padding-bottom:0px;">
     ...
     <h2 class="h_title"> PACKAGES FOR <?php  echo $package_category['location_name']; ?></h2>
     </div>
     <div class="col-sm-12">
                          ...
                          <option>Please Select</option>
                            ...
                            <?php
                                                ...
                                                foreach($locations as $super)
                                                 ...
                                                 <option value="<?php echo $super['location_id'] ?>" <?php if($super['location_id']==$package_category_id) { ?> selected="selected" <?php } ?>><?php echo $super['location_name'] ?></option>
