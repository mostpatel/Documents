		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$reportArray=listContactInquiries($from,$to);
		
				$_SESSION['cContactReport']['emi_array']=$reportArray;
				
				$_SESSION['cContactReport']['from']=$from;
				$_SESSION['cContactReport']['to']=$to;
				$_SESSION['cContactReport']['city_id']=$city_id;
				$_SESSION['cContactReport']['area_id_array']=$area_array;
				$_SESSION['cContactReport']['broker_id_array']=$broker_array;
				$_SESSION['cContactReport']['agency_id']=$agency_id;
				$_SESSION['cContactReport']['file_status']=$file_status;
