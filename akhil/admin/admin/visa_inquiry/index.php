...
require_once('../../lib/inquiry-location-type-functions.php');
require_once('../../lib/inquiry-package-type-functions.php');
require_once('../../lib/inquiry-hotel-type-functions.php');
require_once('../../lib/inquiry-visa-type-functions.php');
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$reportArray=listVisaInquiries($from,$to,$location_type);
		
				$_SESSION['cVisaReport']['emi_array']=$reportArray;
				
				$_SESSION['cVisaReport']['from']=$from;
				$_SESSION['cVisaReport']['to']=$to;
				$_SESSION['cVisaReport']['location_type']=$location_type;
