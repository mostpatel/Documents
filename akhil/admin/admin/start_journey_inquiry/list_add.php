...
<h4 class="headingAlignment no_print">List Of Holiday Package Inquiries</h4>
<?php 
...
<td width="230px">From Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="from" id="from_date" class="datepicker1"  value="<?php if(isset($_SESSION['cStartJourneyReport']['from'])) echo $_SESSION['cStartJourneyReport']['from']; ?>" placeholder="dd/mm/yyyy" />
                    </td>
...
<td width="230px">To Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="to" id="to_date" class="datepicker1" value="<?php if(isset($_SESSION['cStartJourneyReport']['to'])) echo $_SESSION['cStartJourneyReport']['to']; ?>" placeholder="dd/mm/yyyy" />
                    </td>
...
<select name="location_type" placeholder="no_of_nights" id="no_of_nights">
				...
				{
			  ?>
             	<option value="<?php echo $package_type['loc_type_id']; ?>" <?php if(isset($_SESSION['cStartJourneyReport']['location_type'])) { if($_SESSION['cStartJourneyReport']['location_type']== $package_type['loc_type_id']){ ?> selected="selected" <?php } } ?>><?php echo $package_type['loc_type']; ?></option>
...
<hr class="firstTableFinishing" />
	...
	<div class="no_print">
 <?php if(isset($_SESSION['cStartJourneyReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cStartJourneyReport']['emi_array'];
	 ?>    
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    <div class="showColumns">
        ...
        <input class="showCB" type="checkbox" id="9" checked="checked"  /><label class="showLabel" for="9">No Of Nights</label> 
         <input class="showCB" type="checkbox" id="10" checked="checked"  /><label class="showLabel" for="10">Package Type</label> 
    ...
    <thead>
        ...
        <th class="heading no_print">Print</th>
            ...
            <th class="heading">Package Type</th>
    ...
    <tbody>
		...
		foreach($emi_array as $emi)
		{
         ...
         <td><?php   echo $emi['package_type']; ?></td>
