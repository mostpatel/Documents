...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertLocation($_POST["location_name"],$_POST['super_location_id'],$_POST['about'],$_FILES['carosal_image']);
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=updateLocation($_POST["lid"],$_POST["location_name"],$_POST['super_location_id'],$_POST['about'],$_FILES['carosal_image']);
				if($result=="success")
				{
