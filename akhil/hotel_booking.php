...
<div  style="background:#fafafa;">
 ...
 <div class="col-sm-6" style="padding:30px; box-sizing:border-box;">
 <h2 class="h_title">Contact us </h2>
 
 <h2 class="h_title" style="font-size:17px;color:#d52737">Address</h2>
 
<pre>2nd Floor, “Surya Complex” Above Dena Bank,
Nr. Swastik Char Rasta, C.G. Road,
