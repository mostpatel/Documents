...
function createDropDownRtoAgentWork()  
{
var model_id = document.getElementById('vehicle_model').value;
var rto_agent_id = document.getElementById('rto_agent').value;


if(rto_agent_id>0 && model_id>0)
{
var id = "rto_work";
var xmlhttp;
var url = "getRtoAgentWorkRate.php?id="+model_id+"&state="+rto_agent_id;
if (window.XMLHttpRequest)
  {// code for IE7+, Firefox, Chrome, Opera, Safari
  xmlhttp = new XMLHttpRequest();
  }
