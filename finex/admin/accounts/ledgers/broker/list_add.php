...
<input type="hidden" name="head_id" value="<?php echo getSundryCredtorsId(); ?>">
...
<tr>
<td> Opening Balance on <?php echo date('01/04/Y',strtotime(getCurrentDateForUser($_SESSION['adminSession']['admin_id']))); ?> : </td>
