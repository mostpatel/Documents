...
<h4 class="headingAlignment">Interest Information</h4>
<table class="insertTableStyling no_print">

<tr>

<td width="200px;" class="firstColumnStyling">Input Interest : </td>
<td> <input type="text" name="in_percent" value="<?php echo $ledger['in_percent']; ?>"/> </td>
</tr>

<tr>
<td> Output Interest : </td>
<td> <input type="text" name="out_percent" value="<?php echo $ledger['out_percent']; ?>"/> </td>
</tr>
</table>
