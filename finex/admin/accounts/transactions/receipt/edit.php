...
<td>By (Debit)<span class="requiredField">* </span> : </td>
				<td>
					<select id="by_ledger" name="from_ledger_id" onchange="getLedgerOpeningBalance(this.value,this)">
                    ...
                    <?php	
					 ...
					 ?>
                    </select><span id="by_ledgerbal_span" style="margin-left:40px;"><?php $opening_balance = getOpeningBalanceForLedgerForDate("L".$by_account_id,$trans_date); if($opening_balance>=0) echo $opening_balance." DR"; else echo -$opening_balance." CR"; ?></span>
                            </td>
</tr>
				...
				<td>
                   <select id="to_ledger" name="to_ledger_id" >
                    ...
                    <?php	
					 ...
					 ?>
                    </select> <span id="to_ledgerbal_span" style="margin-left:40px;"><?php $opening_balance = getOpeningBalanceForLedgerForDate($ledger_customer_id,$trans_date); if($opening_balance>=0) echo $opening_balance." DR"; else echo -$opening_balance." CR"; ?></span>
                            </td>
</tr>
