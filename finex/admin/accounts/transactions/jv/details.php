...
<td colspan="2">
	<table border="1">
    	<tr>
        	<th width="500px">Particulars</th>
            <th width="125px">Debit</th>
             <th width="125px">Credit</th>
        </tr>
	...
	?>
    <tr>
    	<td><?php echo $name." ".$file_no." ".$reg_no; ?></td>
...
{
	 ?>
      <a href="<?php echo WEB_ROOT."admin/accounts/transactions/multi_jv/index.php?view=edit&lid=".$jv_id; ?>"><button title="Edit this entry" class="btn editBtn"><span class="delete">E</span></button></a>
     <?php } else { ?>
