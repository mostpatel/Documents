	...
	if($_GET['action']=='add')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{			
				...
				$result=addMultiJV($_POST['payment_date'],$_POST['to_ledger_id'],$_POST['to_ledger_id_amount'],$_POST['from_ledger_id'],$_POST['from_ledger_id_amount'],$_POST['remarks'],0,0,$_POST['qty']); 		
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateMultiJV($_POST["lid"],$_POST['payment_date'],$_POST['to_ledger_id'],$_POST['to_ledger_id_amount'],$_POST['from_ledger_id'],$_POST['from_ledger_id_amount'],$_POST['remarks'],0,0,$_POST['qty']);
				if($result=="success")
				{	
