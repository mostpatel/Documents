...
if(isset($_SESSION['ledgerGroupEntriess']['group_id']) && validateForNull($_SESSION['ledgerGroupEntriess']['group_id'])) { 
if($_SESSION['ledgerGroupEntriess']['group_id']==-5)
$display_name="CASH GROUP (".$from; 
else if($_SESSION['ledgerGroupEntriess']['group_id']!=-1 && $_SESSION['ledgerGroupEntriess']['group_id']!=-2) $display_name = getLedgerGroupNameByID($_SESSION['ledgerGroupEntriess']['group_id'])." (".$from;
...
$display_name = $display_name." - ALL";	  
 ...
 <?php
	...
	$net_opening_balance = $net_opening_balance + $openingBalance;
	 ?>    
...
<span style="display:block;float:right;font-weight:bold;margin-right:50px;">NET CLOSING BALANCE = <?php if($net_balance>=0) echo $net_balance." DR"; else echo -$net_balance."CR"; ?></span>
</div>
<span  id="net_opening_balance" style="display:block;float:right;font-weight:bold;position:absolute;top:0px;right:30px;">NET OPENING BALANCE = <?php if($net_opening_balance>=0) echo $net_opening_balance." DR"; else echo -$net_opening_balance."CR"; ?></span>
