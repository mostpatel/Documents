...
<h4 class="headingAlignment"> <?php echo $transaction_array['head_name']; ?> - <?php echo $current_company[2];  echo ' ['.$from.'-'.$to."]";  ?></h4>
        	...
        	<td><?php echo $i++; ?></td>
			   ...
			   $ledgers=$transaction_array['ledgers'];
				...
				foreach($ledgers as $ledger)
				{
					...
					{
						$no_of_trans=getNumberOfTransactionsForLedgerForDate($ledger['id'],$period[0],$period[1]);
						if($no_of_trans==0)
						continue;
					}
			    ...
			    ?>
				 <tr class="resultRow <?php if(startsWith($ledger['id'],"L") && $head_id==13) echo "dangerRow"; ?>">
					<td class="no_print"><input type="checkbox" class="selectTR" name="selectTR"  /></td>
        	<td><?php echo $i++; ?></td>
