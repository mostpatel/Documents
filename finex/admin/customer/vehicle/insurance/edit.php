...
<td>
<input type="text" name="policy_no" id="policy_no" value="<?php echo $insurance['policy_no'] ?>" placeholder="Only Digits And Alphabets!"/>
</td>
</tr>
...
<td>
 <input type="text"  name="cover_note_no" id="cover_note_no" value="<?php echo $insurance['cover_note_no'] ?>" placeholder="Only Digits And Alphabets!" />
</td>
</tr>
...
<td>
 <textarea name="remarks" id="remarks" ><?php $insurance['remarks']; ?></textarea>
</td>
</tr>
