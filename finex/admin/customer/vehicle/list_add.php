					...
					<select id="vehicle_company" name="vehicle_company_id" onchange="createDropDownModelCompany(this.value)">
                        ...
                        <?php
                            ...
                            foreach($companies as $super)
                             ...
                             <option value="<?php echo $super['vehicle_company_id'] ?>" <?php if($others_company_id==$super['vehicle_company_id']) { ?> selected="selected" <?php } ?>><?php echo $super['company_name'] ?></option					>
                             <?php } ?>
...
<td>Vehicle Model<span class="requiredField">* </span> : </td>
				<td>
					<select id="vehicle_model" name="model_id" onchange="createDropDownRtoAgentWork()">
                        <option value="-1" >--Please Select Model--</option>
                        <?php $models = getModelsFromCompanyID($others_company_id); foreach($models as $model) { ?>
                        <option value="<?php echo $model['model_id'] ?>" <?php if($model['model_id']==$others_model_id) { ?> selected = "selected"<?php } ?>><?php echo $model['model_name']; ?></option>
                        <?php } ?>
                            </select> 
                            </td>
</tr>
...
<td>Vehicle Dealer<span class="requiredField">* </span> : </td>
				<td>
					<select id="dealer" name="vehicle_dealer_id">
                       ...
                       <?php $models = getDealersFromCompanyID($others_company_id); foreach($models as $model) { ?>
                        <option value="<?php echo $model['dealer_id'] ?>" <?php if($model['dealer_id']==$others_dealer_id) { ?> selected = "selected"<?php } ?>><?php echo $model['dealer_name']; ?></option>
                        <?php } ?>
					...
					<select id="type" name="vehicle_type_id">
                        ...
                        <?php
                            ...
                            foreach($types as $super)
                             ...
                             <option value="<?php echo $super['vehicle_type_id'] ?>" <?php if($others_vehicle_type_id == $super['vehicle_type_id']) { ?> selected="selected" <?php } ?>><?php echo $super['vehicle_type'] ?></option					>
                             <?php } ?>
...
<td>
 <input type="text" size="12"  placeholder="Click to select Date!"  name="vehicle_reg_date" class="datepicker1 date" onchange="onChangeDate(this.value,this)" value="01/01/1970"/><span class="ValidationErrors contactNoError">Please select a date!</span>
</td>
</tr>
...
<td>
<input type="text" id="vehicle_engine_no" value="na" name="vehicle_engine_no"  placeholder="Only Digits!" onblur="checkAvailibilty(this,'agerror','ajax/engineNo.php','')"/><span id="agerror" class="availError">Engine Number already taken!</span>	
...
<td>
<input type="text" id="vehicle_chasis_no" value="na" name="vehicle_chasis_no" placeholder="Only Digits!" onblur="checkAvailibilty(this,'agerror','ajax/chasisNo.php','')"/><span id="agerror" class="availError">Chasis Number already taken!</span>	
...
<td>
<input type="text" placeholder="Click to select Date!" name="fitness_exp_date" class="datepicker2 date" onchange="onChangeDate(this.value,this)" value="01/01/1970"/><span class="ValidationErrors contactNoError">Please select a date!</span>
</td>
</tr>
...
<td>
<input type="text"  placeholder="Click to select Date!" name="permit_exp_date" class="datepicker3 date" onchange="onChangeDate(this.value,this)" value="01/01/1970"/><span class="ValidationErrors contactNoError">Please select a date!</span>
</td>
</tr>
...
<tr>
<td class="firstColumnStyling">
Tax Exp Date<span class="requiredField">* </span> : 
</td>

<td>
<input type="text"  placeholder="Click to select Date!" name="tax_exp_date" class="datepicker3 date" onchange="onChangeDate(this.value,this)" value="01/01/1970"/><span class="ValidationErrors contactNoError">Please select a date!</span>
</td>
</tr>
