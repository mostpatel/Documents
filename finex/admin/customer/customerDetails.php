...
$unreceived_welcome_letters = listUnreceivedCustomerWelcomesForFileID($file_id);
?>
...
<td>
                             ...
                             <?php echo $customer['secondary_customer_name']; ?>					
...
<td>
                             ...
                             <?php echo $customer['secondary_customer_address']; ?>					
...
<td>Image : </td>
				<td>
                             ...
                             <a href="<?php echo WEB_ROOT."images/customer_proof/".str_replace('.JPG','.jpg',$img['customer_proof_img_href']); ?>"><img style="height:100px;" src="<?php echo WEB_ROOT."images/customer_proof/".str_replace('.JPG','.jpg',$img['customer_proof_img_href']); ?>" /></a>
                            </td>
</tr>
