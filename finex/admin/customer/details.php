...
?>
<div id="emer_del_button"
 class="addDetailsBtnStyling no_print">
...
if(is_array($file) && $file!="error")
{
   ...
   //$guarantor=getGuarantorDetailsByFileId($file_id);
	...
	{
		echo "Errors In Loan Inputs! Please Delete File and reneter Again!";
		exit;
	}
...
<td > <?php if($customer_image!="error") { ?>  <a href="<?php echo WEB_ROOT."images/customer_proof/".str_replace('.JPG','.jpg',$customer_image); ?>"><img style="height:100px;" src="<?php echo WEB_ROOT."images/customer_proof/".str_replace('.JPG','.jpg',$customer_image); ?>" /></a></td> <?php } ?>
</tr>
...
<table class="insertTableStyling detailStylingTable chequeReturnTable" id="chequeReturnTable" border="1"  style="width:100%">
    <thead>
    	<tr>
        	<th class="heading">No</th>
            <th class="heading">Date</th>
             <th class="heading">Chq NO</th>
    ...
    <tbody>
		...
		foreach($cheque_return_detais as $cheque_return)
		{
		 ?>
         <tr class="resultRow">
        	<td style=""><?php echo ++$no; ?>
            </td>
  ...
  <td colspan="5" class="no_print"> <a href="<?php echo WEB_ROOT; ?>admin/customer/index.php?view=chequeReturnDetails&id=<?php echo $file_id; ?>&state=<?php echo $customer_id; ?>"><button title="View this entry" class="btn viewBtn"><span class="view">View All</span></button></a>
   </td>        
</tr> 
         </tbody>
    </table>
...
<a class="no_print" href="<?php echo WEB_ROOT; ?>/admin/deleteAllPayments.php&file_id=<?php echo $file_id; ?>" style="font-size:12px; color:#d00;"> <button class="btn btn-danger" style="float:right;position:relative;top:10px;margin-right:10px;"  > Delete All Payments </button></a>
 </div>
