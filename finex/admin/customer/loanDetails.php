    ...
    <tbody>
		...
		{	
         ...
         <tr class="resultRow">
            ...
            <td><?php  echo number_format($row['emi'],2); ?> 
            </td>
             <td><?php echo number_format($row['interest'],2); ?> 
			 </td>
              <td><?php echo number_format($row['principal'],2); ?> 
			 </td>
            <td><?php  if($no==count($full_table)) echo 0;else  echo number_format($row['balance'],2); ?> 
			 </td>
