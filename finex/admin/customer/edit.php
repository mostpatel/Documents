...
<td>
<input type="text" name="secondary_customer_name" <?php if(SECONDARY_LANG_TRANSLATION==1) { ?> id="transliterateTextarea" <?php } ?> class="person_name" placeholder="Only Letters" value="<?php echo $customer['secondary_customer_name']; ?>"/>
</td>
</tr>
<?php } ?>
...
<tr>
<td>
Seoondary Address<span class="requiredField">* </span> : 
</td>

<td>
<textarea name="secondary_customer_address" <?php if(SECONDARY_LANG_TRANSLATION==1) { ?> id="transliterateTextarea2" <?php } ?> class="address" cols="5" rows="6"><?php $address=str_replace(array('<pre>','</pre>'),"",$customer['secondary_customer_address']);  echo $address; ?></textarea>
</td>
</tr>
