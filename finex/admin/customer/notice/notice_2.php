...
<?php if(isset($contactNos[0]['our_company_contact_no'])) { ?>
<div  style="float:left; ">
Ph: <?php echo $contactNos[0]['our_company_contact_no']; ?>
</div>
<?php if(isset($contactNos[1]['our_company_contact_no'])) { ?>
<div  style="float:Right; ">
Ph: <?php echo $contactNos[1]['our_company_contact_no']; ?>
</div>
<?php }} ?>
