...
<h4 class="headingAlignment"> Update Notice </h4>
<?php 
...
<input name="notice_id" value="<?php echo $notice_id; ?>" type="hidden" />
<table id="insertInsuranceTable" class="insertTableStyling no_print">
<tr>
<td>Notice Date : </td>
				<td>
					<input placeholder="Click to select Date!" type="text" id="welcome_date" name="welcome_date" value="<?php echo date('d/m/Y',strtotime($notice['notice_date'])); ?>" disabled="disabled" class="datepicker1 date"  onchange="onChangeDate(this.value,this)" /><span class="ValidationErrors contactNoError">Please select a date!</span>
                            </td>
</tr>
<tr>
...
<td>
<input type="text" name="reg_ad" id="reg_ad" value="<?php  echo $notice['reg_ad']; ?>" autofocus />
</td>
</tr>
...
<tr id="not_received_reason_tr" <?php if($notice['received']!=2)  {?> style="display:none;" <?php } ?>>
<td class="firstColumnStyling">
Not Received Reason : 
</td>
