...
if(isset($_GET['action']))
{
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=insertLoanChequeReturn($_POST['file_id'],$_POST["cheque_no"],$_POST['cheque_date'],$_POST['bank_name'],$_POST['branch_name'],$_POST['slip_no'],$_POST['remarks'],$_POST['cheque_amount'],$_POST['type']);
				
				if($result!="error" && is_numeric($result))
				{
				$_SESSION['ack']['msg']="Cheque Return successfully added!";
				$_SESSION['ack']['type']=1; // 1 for insert
				header("Location: ".WEB_ROOT."admin/customer/legal_notice/index.php?id=".$_POST['file_id']."&cheque_return_id=".$result);
				exit;
				}
				else{
				...
				header("Location: ".WEB_ROOT."admin/customer/cheque_return/index.php?id=".$_POST['file_id']);
				exit;
				}
			}
			else
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				deleteLoanChequeReturn($_GET["lid"]);
				
				$_SESSION['ack']['msg']="Cheque Return deleted Successfuly!";
				$_SESSION['ack']['type']=3; // 3 for delete
				
				header("Location: ".WEB_ROOT."admin/customer/cheque_return/index.php?id=".$_GET['id']);
				exit;
			}
			else
			{	
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{ 
				updateChequeReturn($_POST["cheque_return_id"],$_POST["cheque_no"],$_POST['cheque_date'],$_POST['bank_name'],$_POST['branch_name'],$_POST['slip_no'],$_POST['remarks'],$_POST['cheque_amount'],$_POST['received_status'],$_POST['not_received_reason'],$_POST['received_date']);
				
				$_SESSION['ack']['msg']="Item updated Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
				
				header("Location: ".WEB_ROOT."admin/customer/cheque_return/index.php?view=edit&lid=".$_POST['cheque_return_id']);
			exit;
			}
			else
			{	
...
if(isset($link))
$selectedLink=$link;
$jsArray=array("jquery.validate.js","jquery-ui/js/jquery-ui.min.js","validators/notice.js","addInsuranceProof.js","customerDatePicker.js","validators/addChequeReturn.js");
