...
<h4 class="headingAlignment no_print">Add Extra Customer Details</h4>

<form id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=addExtraCustomer'; ?>" method="post" enctype="multipart/form-data" onsubmit="return submitOurCompany()">
...
<td>
<input type="text" name="secondary_guarantor_name" id="transliterateTextarea" class="person_name" placeholder="Only Letters" value="<?php echo $guarantor['secondary_guarantor_name']; ?>"/>
</td>
</tr>
...
<td>
<textarea name="secondary_guarantor_address" id="transliterateTextarea2" class="address" cols="5" rows="6"><?php $address=str_replace(array('<pre>','</pre>'),"",$guarantor['secondary_guarantor_address']);  echo $address;?></textarea>
</td>
</tr>
