...
<td width="220px">Penalty For <?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
				...
				<td>
					<input value="<?php echo $penalty['days_paid']; ?>" type="text" name="days_paid" id="days" placeholder="Only Digits!" /><span class="DateError customError"><?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
