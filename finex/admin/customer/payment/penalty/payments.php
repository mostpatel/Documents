 ...
 <div class="no_print" style="width:100%;">
    ...
    <thead>
    	<tr>
            ...
            <th class="heading">No Of <?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo " Days"; else if(PENALTY_IN_DAYS==1) echo " Months"; ?></th>
            <th class="heading">Amount/<?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo "Day"; else if(PENALTY_IN_DAYS==1) echo "Month"; ?></th>
