...
Penalty <?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
...
Amount/<?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo "Day"; else if(PENALTY_IN_DAYS==1) echo "Month"; ?> : 
</td>
...
<div class="rasid">
<b> <i> the sum of Rupees :</b>  </i> <?php echo numberToWord((floatval($penalty['days_paid'])*floatval($penalty['amount_per_day'])))." Only"; ?>
</div>
...
<div class="lowerLeftDiv">
        ...
        <div class="rectangle">
            ...
            <div class="amount">
            <?php echo number_format((floatval($penalty['days_paid'])*floatval($penalty['amount_per_day'])))." /- "; ?>
            </div>
...
<div class="lowerRightdiv">
      ...
      <div class="aboveSign">
      For, <?php if(is_numeric($file['agency_id']))  {echo  getAgencyHeadingById($file['agency_id']);} else  echo getOurCompanyNameByID($file['oc_id']); ?>
      </div>
