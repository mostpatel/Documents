		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
				...
				$result=addPenaltyToLoan(0,$_POST["payment_date"],$_POST['mode'],0,$_POST['rasid_no'],$_POST['paid_by'],$_POST['loan_id'],$_POST['file_id'],NULL,$_POST['amount'],$_POST['rasid_type_id'],$_POST['paid'],$_POST['bank_name'],$_POST['branch_name'],$_POST['cheque_no'],$_POST['cheque_date'],$_POST['bank_account'],$_POST['auto_rasid_no']);			
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=editPenalty($_POST["lid"],0,$_POST["payment_date"],$_POST['mode'],0,$_POST['rasid_no'],$_POST['paid_by'],$_POST['loan_id'],$_POST['file_id'],$_POST['amount'],$_POST['rasid_type_id'],$_POST['paid'],$_POST['bank_name'],$_POST['branch_name'],$_POST['cheque_no'],$_POST['cheque_date'],$_POST['bank_account']);
				if($result=="success")
				{
