...
<h4 class="headingAlignment"> Generate Sale Notice </h4>
<?php 
...
?>
<form  id="addNoticeForm" action="<?php echo $_SERVER['../notice - Copy/PHP_SELF'].'?action=add'; ?>" method="post">
...
<td>
<input type="text" name="paid_emis" id="bucket" placeholder="Only Digits!" value="<?php echo $emis_paid; ?>"/>
</td>
</tr>
...
<td>
<input type="text" name="paid_amount" id="bucket_amount" placeholder="Only Digits!" value="<?php echo $total_payment; ?>"/>
</td>
</tr>
...
<h4 class="headingAlignment">List of Sale Notices</h4>
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
    ...
    <thead>
    	<tr>
            ...
            <th class="heading">Total Amount Paid</th>
    ...
    <tbody>
        ...
        <?php
		$admins=listSaleNoticesForFileID($file_id);
		$no=0;
		foreach($admins as $admin)
		{
         ...
         <tr class="resultRow">
            ...
            <td><?php echo date('d/m/Y',strtotime($admin['sale_notice_date'])); ?>
            </td>
             <td><?php echo number_format($admin['total_emis_paid'],2); ?>
            </td>
            <td><?php echo number_format($admin['total_amount_paid'],2); ?>
            </td>
            
            <td class="no_print"> <a href="<?php echo $_SERVER['PHP_SELF'].'?view=notice&id='.$admin['sale_notice_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo $_SERVER['PHP_SELF'].'?action=delete&lid='.$admin['sale_notice_id'].'&id='.$admin['file_id'] ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
        </tr>
         <?php }?>
         </tbody>
