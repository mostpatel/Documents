...
<b>Office Address</b><br />23/1 NEW BABUNAGAR,<br>VAGHESWARY ROAD,<br>
OPP SARVODAY SCHOOL,<br> CHANDLODIA
AHMEDABAD<br>
</div>
...
<div style="text-align:center; font-weight:bolder; text-decoration:underline; line-height:20px; width:100%;"></div>
 ...
 Hirer : <?php echo $customer['customer_name']; ?> <br>
...
<br>Dear Sir, <br>
<span style="font-weight:bold;text-align:center;width:100%;font-size:22px;display:block;">Sub:  No dues certificate   -  Two  wheeler loan agreement no.  <?php echo $file['file_agreement_no']; ?></span>
 </div>

<div style="font-size:20px;line-height:26px;padding-top:30px;">

This is to certify that two wheeler loan a/c of  Mr. <?php echo $customer['customer_name']; ?> has been adjusted on 
<?php echo date('d/m/Y',strtotime($noc['noc_date'])); ?>. <br><br> There is no outstanding in  this loan a/c. Our Hypothecation charge on vehicle no. <?php echo $vehicle['vehicle_reg_no']; ?> has been released.<br><br>We forward herewith the HP termination form no. 35 in duplicate duly signed by us for the needful.                                            
