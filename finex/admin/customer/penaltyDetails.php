...
<td>
                             ...
                             <?php  echo $total_penalty;  if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
...
<td>
                             ...
                             <?php  echo $days_paid; if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo " Days"; else if(PENALTY_IN_DAYS==1) echo " Months"; ?>					
...
<td>
                             ...
                             <?php echo ($total_penalty-$days_paid); if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo " Days"; else if(PENALTY_IN_DAYS==1) echo " Months"; ?>					
...
<td width="220px">Penalty Mode<span class="requiredField">* </span> : </td>
				<td>
					<Select name="penalty_mode" id="penalty_mode" >
                    	<option value="1">Amount/<?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo "Day"; else if(PENALTY_IN_DAYS==1) echo "Month"; ?></option>
                     <?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) { ?>   <option value="2">Flat Rate of Interest</option> <?php } ?>
                    </Select>
</td>
...
<tr>
<td>
(Amount/<?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo "Day"; else if(PENALTY_IN_DAYS==1) echo "Month"; ?>) OR Interest<span class="requiredField">* </span> : 
</td>
<td>
<input type="text"  name="amount_interest" id="amount_interest" value="<?php if(defined('PENALTY_IN_DAYS') && PENALTY_IN_DAYS==1) echo ((PENALTY_IN_MONTHS_LOAN_PERCENT/100) * $loan['loan_amount']); ?>" />
</td>
</tr>
...
<td>
<span id="penalty_paid"><?php echo $amount_paid; ?></span>
</td>
</tr>
 ...
 <div class="no_print" style="width:100%;">
    ...
    <thead>
    	<tr>
            ...
            <th class="heading">Penalty <?php if(!defined('PENALTY_IN_DAYS') || PENALTY_IN_DAYS==0) 
					echo " Days"; else if(PENALTY_IN_DAYS==1) echo " Months"; ?></th>
    ...
    <tbody>
		...
		if(isset($payment) && is_array($payment) && count($payment)>0)
		{
			foreach($payment as $p) {
				 ...
				 if($p['amount']>=0) {$valid=1;} $emi=$p['emi']; $actualDate=$p['actual_date']; }
		}
