...
{
	$guarantor=getExtraCustomerDetailsByFileId($file_id);
	$guarantor_id=$guarantor['extra_customer_id'];
...
<form id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=editExtraCustomer'; ?>" method="post" enctype="multipart/form-data" onsubmit="return submitOurCompany()">
...
<td>
<input type="text" name="guarantor_name" id="guarantor_name" class="person_name" placeholder="Only Letters" value="<?php echo $guarantor['extra_customer_name']; ?>"/>
</td>
</tr>
...
<td>
<textarea name="guarantor_address" id="guarantor_address" class="address" cols="5" rows="6"><?php $address=str_replace(array('<pre>','</pre>'),"",$guarantor['extra_customer_address']);  echo $address;?></textarea>
</td>
</tr>
...
<td width="220px" class="firstColumnStyling">
Secondary  Name<span class="requiredField">* </span> : 
</td>

<td>
<input type="text" name="secondary_guarantor_name" id="transliterateTextarea" class="person_name" placeholder="Only Letters" value="<?php echo $guarantor['secondary_extra_customer_name']; ?>"/>
</td>
</tr>

<tr>
<td>
Secondary Address<span class="requiredField">* </span> : 
</td>

<td>
<textarea name="secondary_guarantor_address" id="transliterateTextarea2" class="address" cols="5" rows="6"><?php $address=str_replace(array('<pre>','</pre>'),"",$guarantor['secondary_extra_customer_address']);  echo $address;?></textarea>
</td>
</tr>
...
<table style="margin-top:0px;margin-bottom:10px;display:none;">
<tr>
<td width="250px;">  </td>
