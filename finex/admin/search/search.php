...
<td>Vehicle Number : </td>
				<td>
				 <input type="text"  name="reg_no" id="reg_no" placeholder="Only Letters and numbers" autocomplete="off" autofocus/>	
                 </td>
</tr>
...
<td>Guarantor's Name : </td>
				<td>
				 <input type="text"  name="gua_name" id="gua_name" placeholder="Only Letters" autocomplete="off"/>	
                </td>
</tr>
...
<script>
 ...
 $( "#fileNumber" ).autocomplete({
      minLength: 1,
    source:  function(request, response) {
                $.getJSON ('<?php echo WEB_ROOT; ?>json/file_no.php?from=1',
                { term: request.term }, 
                response );
            },
	 select: function( event, ui ) {
...
$( "#name" ).autocomplete({
	...
	$( "#gua_name" ).autocomplete({
      minLength: 1,
    source:  function(request, response) {
                $.getJSON ('<?php echo WEB_ROOT; ?>json/guarantor_name.php',
                { term: request.term }, 
                response );
            },
	 select: function( event, ui ) {
			$( "#gua_name" ).val(ui.item.label);
			return false;
		}
    });				
