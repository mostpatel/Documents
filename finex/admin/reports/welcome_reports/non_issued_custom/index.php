...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalNonIssuedWelcomeReports($from,$to,$agency_id);
		
		$_SESSION['cNonWelcomeReport']['emi_array']=$reportArray;
		$_SESSION['cNonWelcomeReport']['from']=$from;
		$_SESSION['cNonWelcomeReport']['to']=$to;
		$_SESSION['cNonWelcomeReport']['reg_ad']=$reg_ad;
		$_SESSION['cNonWelcomeReport']['received']=$received;
		$_SESSION['cNonWelcomeReport']['agency_id']=$agency_id;
		$_SESSION['cNonWelcomeReport']['file_status']=$file_status;
	...
	$to=$to->format('d/m/Y');
		...
		$_SESSION['cNonWelcomeReport']['from']=$from;
		$_SESSION['cNonWelcomeReport']['to']=$to;
		$_SESSION['cNonWelcomeReport']['win_gt']=$win_gt;
		$_SESSION['cNonWelcomeReport']['win_lt']=$win_lt;
		$_SESSION['cNonWelcomeReport']['emi_gt']=$emi_gt;
		$_SESSION['cNonWelcomeReport']['emi_lt']=$emi_lt;
		$_SESSION['cNonWelcomeReport']['balance_gt']=$balance_gt;
		$_SESSION['cNonWelcomeReport']['balance_lt']=$balance_lt;
		$_SESSION['cNonWelcomeReport']['city_id']=$city_id;
		$_SESSION['cNonWelcomeReport']['area_id_array']=$area_array;
		$_SESSION['cNonWelcomeReport']['agency_id']=$agency_id;
		$_SESSION['cNonWelcomeReport']['file_status']=$file_status;
