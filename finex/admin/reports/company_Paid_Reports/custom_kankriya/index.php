...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalEMIReportsCompanyDate($from,$to,$win_gt,$win_lt,$emi_gt,$emi_lt,$balance_gt,$balance_lt,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string,1,$vehicle_type_string,$from_emi_date,$to_emi_date,NULL,$_POST['view_type'],$file_id_array,$show_legal);
		
		$_SESSION['cKankriyaCompanyPaidReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaCompanyPaidReport']['from']=$from;
		$_SESSION['cKankriyaCompanyPaidReport']['to']=$to;
		$_SESSION['cKankriyaCompanyPaidReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaCompanyPaidReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaCompanyPaidReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaCompanyPaidReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaCompanyPaidReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaCompanyPaidReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaCompanyPaidReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaCompanyPaidReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaCompanyPaidReport']['city_id']=$city_id;
		$_SESSION['cKankriyaCompanyPaidReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaCompanyPaidReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaCompanyPaidReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaCompanyPaidReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaCompanyPaidReport']['file_status']=$file_status;
		$_SESSION['cKankriyaCompanyPaidReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaCompanyPaidReport']['show_legal']=$_POST['show_legal'];
		$_SESSION['cKankriyaCompanyPaidReport']['view_type']=$_POST['view_type'];
