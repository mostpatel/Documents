...
<tr>
    ...
    <td>
    	...
    	<input  type="radio" name="file_status" id="closed_unpaid" value="5" <?php if(isset($_SESSION['cSeizeReport']['file_status'])){ if( $_SESSION['cSeizeReport']['file_status']==5 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed_unpaid">Closed & unpaid</label>
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cSeizeReport']['file_status'])){ if( $_SESSION['cSeizeReport']['file_status']==6 ) { ?> checked="checked" <?php }} else  { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
    	<input  type="radio" name="file_status" id="both"  <?php if(isset($_SESSION['cSeizeReport']['file_status']) && ($_SESSION['cSeizeReport']['file_status']!=1 && $_SESSION['cSeizeReport']['file_status']!=2 && $_SESSION['cSeizeReport']['file_status']!=5 && $_SESSION['cSeizeReport']['file_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
...
<tr>
    ...
    <td>
		...
		<input  type="radio" name="sold" id="yes" value="1" <?php if(isset($_SESSION['cSeizeReport']['sold'])){ if( $_SESSION['cSeizeReport']['sold']==1 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="yes">Yes</label>
