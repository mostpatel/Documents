...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalPaymentRemianderReports($from,$to,$remainder_status,$city_id,$area_id_string,$file_status,$agency_id,$dated);
		$_SESSION['cPaymentRemainderReport']['remainder_array']=$reportArray;
		
		$_SESSION['cPaymentRemainderReport']['from']=$from;
		$_SESSION['cPaymentRemainderReport']['to']=$to;
		$_SESSION['cPaymentRemainderReport']['remainder_status']=$remainder_status;
		$_SESSION['cPaymentRemainderReport']['city_id']=$city_id;
		$_SESSION['cPaymentRemainderReport']['area_id_array']=$area_array;

		$_SESSION['cPaymentRemainderReport']['agency_id']=$agency_id;
		$_SESSION['cPaymentRemainderReport']['file_status']=$file_status;
		$_SESSION['cPaymentRemainderReport']['dated']=$dated;
	...
	if(isset($_POST['remainder_status']))
		...
		$_SESSION['cPaymentRemainderReport']['remainder_status']=$remainder_status;
		$_SESSION['cPaymentRemainderReport']['city_id']=$city_id;
		$_SESSION['cPaymentRemainderReport']['area_id']=$area;
		$_SESSION['cPaymentRemainderReport']['agency_id']=$agency_id;
		$_SESSION['cPaymentRemainderReport']['file_status']=$file_status;
