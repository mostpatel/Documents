...
<tr>
	<td>Type:</td>
    <td>
    	<input  type="radio" name="dated" id="reminder" value="1" <?php if(isset($_SESSION['eRemainderReport']['dated'])){ if(  $_SESSION['eRemainderReport']['dated']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="reminder">Reminder</label>
		<input  type="radio" name="dated" id="remarks" value="0" <?php if(isset($_SESSION['eRemainderReport']['dated'])){ if( $_SESSION['eRemainderReport']['dated']==0 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="remarks">Remarks</label>
    	<input  type="radio" name="dated" id="bothh"  <?php if(!isset($_SESSION['eRemainderReport']['dated']) || ($_SESSION['eRemainderReport']['dated']!=1 && $_SESSION['eRemainderReport']['dated']!=0)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="bothh">Both</label>
    </td>
</tr>
