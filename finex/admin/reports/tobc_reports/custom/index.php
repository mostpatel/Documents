...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalToBCReports($from,$to,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string);
		
		$_SESSION['cToBCReport']['emi_array']=$reportArray;
		
		$_SESSION['cToBCReport']['from']=$from;
		...
		$_SESSION['cToBCReport']['agency_id']=$agency_id;
		$_SESSION['cToBCReport']['file_status']=$file_status;
