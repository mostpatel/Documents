...
<h4 class="headingAlignment no_print">TOBC Reports</h4>
<?php 
...
<tr>
    ...
    <td>
        ...
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cToBCReport']['file_status'])){ if( $_SESSION['cToBCReport']['file_status']==6 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
...
<hr class="firstTableFinishing" />
 <h3>NOTE: Seized Vehicles Not Included</h3>
