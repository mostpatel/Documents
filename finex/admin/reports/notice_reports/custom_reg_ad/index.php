...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		if(isset($_POST['notice_stage']))
		{
		$notice_stage=$_POST['notice_stage'];
		}
		else
		$notice_stage=null;
		...
		$reportArray=generalNoticeReportsRegAd($from,$to,$agency_id,$reg_ad,$received,$notice_stage);
		
		$_SESSION['cNoticeRegAdReport']['emi_array']=$reportArray;
		$_SESSION['cNoticeRegAdReport']['from']=$from;
		$_SESSION['cNoticeRegAdReport']['to']=$to;
		$_SESSION['cNoticeRegAdReport']['reg_ad']=$reg_ad;
		$_SESSION['cNoticeRegAdReport']['notice_stage']=$notice_stage;
		$_SESSION['cNoticeRegAdReport']['received']=$received;
		$_SESSION['cNoticeRegAdReport']['agency_id']=$agency_id;
		$_SESSION['cNoticeRegAdReport']['file_status']=$file_status;
	...
	$to=$to->format('d/m/Y');
		...
		$_SESSION['cNoticeRegAdReport']['from']=$from;
		$_SESSION['cNoticeRegAdReport']['to']=$to;
		$_SESSION['cNoticeRegAdReport']['win_gt']=$win_gt;
		$_SESSION['cNoticeRegAdReport']['win_lt']=$win_lt;
		$_SESSION['cNoticeRegAdReport']['emi_gt']=$emi_gt;
		$_SESSION['cNoticeRegAdReport']['emi_lt']=$emi_lt;
		$_SESSION['cNoticeRegAdReport']['balance_gt']=$balance_gt;
		$_SESSION['cNoticeRegAdReport']['balance_lt']=$balance_lt;
		$_SESSION['cNoticeRegAdReport']['city_id']=$city_id;
		$_SESSION['cNoticeRegAdReport']['area_id_array']=$area_array;
		$_SESSION['cNoticeRegAdReport']['agency_id']=$agency_id;
		$_SESSION['cNoticeRegAdReport']['file_status']=$file_status;
