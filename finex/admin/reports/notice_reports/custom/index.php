...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalNoticeReports($from,$to,$agency_id);
		
		$_SESSION['cNoticeReport']['emi_array']=$reportArray;
		
		$_SESSION['cNoticeReport']['from']=$from;
		$_SESSION['cNoticeReport']['to']=$to;
		$_SESSION['cNoticeReport']['win_gt']=$win_gt;
		$_SESSION['cNoticeReport']['win_lt']=$win_lt;
		$_SESSION['cNoticeReport']['emi_gt']=$emi_gt;
		$_SESSION['cNoticeReport']['emi_lt']=$emi_lt;
		$_SESSION['cNoticeReport']['balance_gt']=$balance_gt;
		$_SESSION['cNoticeReport']['balance_lt']=$balance_lt;
		$_SESSION['cNoticeReport']['city_id']=$city_id;
		$_SESSION['cNoticeReport']['area_id_array']=$area_array;
		$_SESSION['cNoticeReport']['broker_id_array']=$broker_array;
		$_SESSION['cNoticeReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cNoticeReport']['agency_id']=$agency_id;
		$_SESSION['cNoticeReport']['file_status']=$file_status;
		$_SESSION['cNoticeReport']['seized']=$_POST['seized'];
