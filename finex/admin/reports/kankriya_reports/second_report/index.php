...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		else if($_POST['view_type']==3)
		{
			...
			{
				$bulk_notice_id=insertBulkNotices($file_id_array);
				header("Location: ".WEB_ROOT."admin/customer/notice/index.php?view=notice&bulk=1&id=".$bulk_notice_id);		
				exit;
			}
		}
		...
		$_SESSION['cKankriyaSecondReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaSecondReport']['from']=$from;
		$_SESSION['cKankriyaSecondReport']['to']=$to;
		$_SESSION['cKankriyaSecondReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaSecondReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaSecondReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaSecondReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaSecondReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaSecondReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaSecondReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaSecondReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaSecondReport']['city_id']=$city_id;
		$_SESSION['cKankriyaSecondReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaSecondReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaSecondReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaSecondReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaSecondReport']['file_status']=$file_status;
		$_SESSION['cKankriyaSecondReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaSecondReport']['view_type']=$_POST['view_type'];
