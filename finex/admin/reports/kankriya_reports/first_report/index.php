...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cKankriyaFirstReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaFirstReport']['from']=$from;
		$_SESSION['cKankriyaFirstReport']['to']=$to;
		$_SESSION['cKankriyaFirstReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaFirstReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaFirstReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaFirstReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaFirstReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaFirstReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaFirstReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaFirstReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaFirstReport']['city_id']=$city_id;
		$_SESSION['cKankriyaFirstReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaFirstReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaFirstReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaFirstReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaFirstReport']['file_status']=$file_status;
		$_SESSION['cKankriyaFirstReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaFirstReport']['view_type']=$_POST['view_type'];
