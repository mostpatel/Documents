...
<div class="jvp"><?php if(isset($_SESSION['cKankriyaFirstReport']['agency_id']) && $_SESSION['cKankriyaFirstReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaFirstReport']['agency_id']);  } ?></div>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment no_print">TVR Reports (Step 1)</h4>
<?php 
...
<td>From Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="start_date" id="start_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['from'])) echo $_SESSION['cKankriyaFirstReport']['from']; ?>" />	
                 </td>
</tr>
...
<td>To Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="end_date" id="end_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['to'])) echo $_SESSION['cKankriyaFirstReport']['to']; ?>" />	
                 </td>
</tr> -->
<input type="hidden" name="start_date" value="<?php echo  date('d/m/Y',strtotime(getTodaysDate())); ?>"  />
...
<td>From Date (EMI date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="from_emi_date" id="from_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaFirstReport']['from_emi_date'])) echo $_SESSION['cKankriyaFirstReport']['from_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>To Date (EMI date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="to_emi_date" id="to_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaFirstReport']['to_emi_date'])) echo $_SESSION['cKankriyaFirstReport']['to_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>Bucket(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_gt" id="win_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['win_gt'])) echo $_SESSION['cKankriyaFirstReport']['win_gt']; else echo "0.001"; ?>" />	
                 </td>
</tr>
...
<td>Bucket(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_lt" id="win_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['win_lt'])) echo $_SESSION['cKankriyaFirstReport']['win_lt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_gt" id="emi_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['emi_gt'])) echo $_SESSION['cKankriyaFirstReport']['emi_gt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_lt" id="emi_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['emi_lt'])) echo $_SESSION['cKankriyaFirstReport']['emi_lt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_gt" id="balance_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['balance_gt'])) echo $_SESSION['cKankriyaFirstReport']['balance_gt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_lt" id="balance_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFirstReport']['balance_lt'])) echo $_SESSION['cKankriyaFirstReport']['balance_lt']; ?>" />	
                 </td>
</tr>
					...
					<select id="customer_city_id" name="city_id" class="city"   onchange="createDropDownAreaReports(this.value)">
                        ...
                        <?php
                            ...
                            foreach($cities as $super)
                             ...
                             <option value="<?php echo $super['city_id'] ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['city_id'])){ if( $super['city_id'] == $_SESSION['cKankriyaFirstReport']['city_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['city_name'] ?></option					>
                             <?php } ?>
...
<td>Area : </td>
				<td>
					<select name="area[]" class="city_area selectpicker" multiple="multiple"  id="city_area1" >
                    	 <option value="-1" >--Please Select--</option>
                          <?php
						  if(isset($_SESSION['cKankriyaFirstReport']['city_id'])){
                            $areas = listAreasFromCityIdWithGroups($_SESSION['cKankriyaFirstReport']['city_id']);
                            foreach($areas as $area)
                              {
                             ?>
                             
                             <option value="<?php echo $area['area_id'] ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['area_id_array'])){ if(in_array($area['area_id'],$_SESSION['cKankriyaFirstReport']['area_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $area['area_name'] ?></option					>
                             <?php } 
						  }
							 ?>
                    </select>
					...
					<select id="agency_id" name="agency_id">
                        ...
                        <?php
                            ...
                            foreach($agencies as $super)
                             ...
                             <option value="ag<?php echo $super['agency_id'] ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['agency_id'])){ if( "ag".$super['agency_id'] == $_SESSION['cKankriyaFirstReport']['agency_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['agency_name'] ?></option>
                             ...
                             <option value="oc<?php echo $com['our_company_id'] ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['agency_id'])){ if( "oc".$com['our_company_id'] == $_SESSION['cKankriyaFirstReport']['agency_id'] ) { ?> selected="selected" <?php }} ?> ><?php echo $com['our_company_name'] ?></option>
					...
					<select name="broker[]" class="broker selectpicker" multiple="multiple"  id="broker" >
						  ...
						  $brokers=listBrokers();
                            ...
                            foreach($brokers as $broker)
                              {
                             ?>
                             <option value="<?php echo $broker['broker_id'] ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['broker_id_array'])){ if(in_array($broker['broker_id'],$_SESSION['cKankriyaFirstReport']['broker_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $broker['broker_name'] ?></option					>
                             <?php } 
...
<td>
	<select id="type_rasid" name="vehicle_type[]" class="city_area selectpicker" multiple="multiple" >
                       <?php $vehicle_types= listVehicleTypes(); foreach($vehicle_types as $vehicle_type) { ?>
                             ...
                             <option value="<?php echo $vehicle_type['vehicle_type_id']; ?>" <?php if(isset($_SESSION['cKankriyaFirstReport']['vehicle_type_array'])){ if(in_array($vehicle_type['vehicle_type_id'],$_SESSION['cKankriyaFirstReport']['vehicle_type_array']))  { ?> selected="selected" <?php }} ?>><?php echo $vehicle_type['vehicle_type']; ?></option>
...
<tr>
	<td>File Status :</td>
    <td>
    	<input  type="radio" name="file_status" id="open" value="1" <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status'])){ if(  $_SESSION['cKankriyaFirstReport']['file_status']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="open">Open</label>
		<input  type="radio" name="file_status" id="closed" value="2" <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status'])){ if( $_SESSION['cKankriyaFirstReport']['file_status']==2 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed">Closed</label>
    	<input  type="radio" name="file_status" id="closed_unpaid" value="5" <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status'])){ if( $_SESSION['cKankriyaFirstReport']['file_status']==5 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed_unpaid">Closed & unpaid</label>
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status'])){ if( $_SESSION['cKankriyaFirstReport']['file_status']==6 ) { ?> checked="checked" <?php }} else  { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
    	<input  type="radio" name="file_status" id="both"  <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status']) && ($_SESSION['cKankriyaFirstReport']['file_status']!=1 && $_SESSION['cKankriyaFirstReport']['file_status']!=2 && $_SESSION['cKankriyaFirstReport']['file_status']!=5 && $_SESSION['cKankriyaFirstReport']['file_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
...
<tr>
    ...
    <td>
    	<input  type="radio" name="seized" id="yes" value="1"  <?php if(isset($_SESSION['cKankriyaFirstReport']['seized'])){ if(  $_SESSION['cKankriyaFirstReport']['seized']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="yes">Yes</label>
		<input  type="radio" name="seized" id="no" value="0" <?php if(isset($_SESSION['cKankriyaFirstReport']['seized'])){ if( $_SESSION['cKankriyaFirstReport']['seized']==0 ) { ?> checked="checked" <?php }} ?> checked="checked"  /> <label style="display:inline-block;top:3px;position:relative;" for="no">No</label>
...
<tr>
	<td>View :</td>
    <td>
    	<input  type="radio" name="view_type" id="view_type_normal"  value="1"  <?php if(isset($_SESSION['cKankriyaFirstReport']['view_type'])){ if(  $_SESSION['cKankriyaFirstReport']['view_type']==1 ) { ?> checked="checked" <?php }} ?> checked="checked" /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="view_type_normal">TVR View</label>
		<input  type="radio" name="view_type" id="view_type_print"  value="0" <?php if(isset($_SESSION['cKankriyaFirstReport']['view_type'])){ if( $_SESSION['cKankriyaFirstReport']['view_type']==0 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="view_type_print">Collection Notice View</label>
...
<hr class="firstTableFinishing" />
 ...
 <?php if(isset($_SESSION['cKankriyaFirstReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cKankriyaFirstReport']['emi_array'];
		
	if($_SESSION['cKankriyaFirstReport']['view_type']==1)
	{	
	 ?>    
     <div class="no_print">
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    ...
    <tbody>
		...
		foreach($emi_array as $emi)
		{
			...
			$seieze=false;
			if(($_SESSION['cKankriyaFirstReport']['seized']==1 && $seieze) || !$seieze)
			{
		 ?>
         <tr class="resultRow <?php if(strtotime($ten_days_befor_date)>=strtotime($emi['payment_date']) && strtotime($reminder_date)<=strtotime($emi['payment_date'])) echo "dangerRow"; else if(strtotime($reminder_date)>strtotime($emi['payment_date'])) echo "shantiRow"; ?>">
    ...
    <tr>
    	<td> From : <?php if(isset($_SESSION['cKankriyaFirstReport']['from']) && $_SESSION['cKankriyaFirstReport']['from']!="") echo $_SESSION['cKankriyaFirstReport']['from']; else echo "NA"; ?></td>
        <td> To : <?php if(isset($_SESSION['cKankriyaFirstReport']['to']) && $_SESSION['cKankriyaFirstReport']['to']!="") echo $_SESSION['cKankriyaFirstReport']['to']; else echo "NA"; ?></td>
    	<td> Bucket(>=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['win_gt']) && $_SESSION['cKankriyaFirstReport']['win_gt']!="") echo $_SESSION['cKankriyaFirstReport']['win_gt']; else echo "NA"; ?></td>
        <td> Bucket(<=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['win_lt']) && $_SESSION['cKankriyaFirstReport']['win_lt']!="") echo $_SESSION['cKankriyaFirstReport']['win_lt']; else echo "NA"; ?></td>
        <td> EMI(>=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['emi_gt']) && $_SESSION['cKankriyaFirstReport']['emi_gt']!="") echo $_SESSION['cKankriyaFirstReport']['emi_gt']; else echo "NA"; ?></td>
        <td> EMI(<=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['emi_lt']) && $_SESSION['cKankriyaFirstReport']['emi_lt']!="") echo $_SESSION['cKankriyaFirstReport']['emi_lt']; else echo "NA"; ?></td>
        <td> Balance(>=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['balance_gt']) && $_SESSION['cKankriyaFirstReport']['balance_gt']!="") echo $_SESSION['cKankriyaFirstReport']['balance_gt']; else echo "NA"; ?></td>
        <td> balance(<=) : <?php if(isset($_SESSION['cKankriyaFirstReport']['balance_lt']) && $_SESSION['cKankriyaFirstReport']['balance_lt']!="") echo $_SESSION['cKankriyaFirstReport']['balance_lt']; else echo "NA"; ?></td>
        <td> City : <?php if(isset($_SESSION['cKankriyaFirstReport']['city_id']) && $_SESSION['cKankriyaFirstReport']['city_id']!="") {$city=getCityByID($_SESSION['cKankriyaFirstReport']['city_id']); echo $city['city_name']; } else echo "NA"; ?></td>
       
        <td> Agency : <?php if(isset($_SESSION['cKankriyaFirstReport']['agency_id']) && $_SESSION['cKankriyaFirstReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaFirstReport']['agency_id']);  } else echo "NA"; ?></td>
        <td> File Status : <?php if(isset($_SESSION['cKankriyaFirstReport']['file_status']) && $_SESSION['cKankriyaFirstReport']['file_status']!="") { if($_SESSION['cKankriyaFirstReport']['file_status']==1) echo "OPEN";else if($_SESSION['cKankriyaFirstReport']['file_status']==2) echo "CLOSED";  } else echo "BOTH"; ?></td>
    </tr>
    </table> 
