...
<div class="jvp"><?php if(isset($_SESSION['cKankriyaApprovalReport']['agency_id']) && $_SESSION['cKankriyaApprovalReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaApprovalReport']['agency_id']);  } ?></div>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment no_print">Custom Report By Loan Approval Date</h4>
<?php 
...
<td>From Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="start_date" id="start_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['from'])) echo $_SESSION['cKankriyaApprovalReport']['from']; ?>" />	
                 </td>
</tr>
...
<td>To Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="end_date" id="end_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['to'])) echo $_SESSION['cKankriyaApprovalReport']['to']; ?>" />	
                 </td>
</tr> -->
<tr>
<td>up to Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="start_date" id="start_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['from'])) echo $_SESSION['cEMIReportPaymentDate']['from']; ?>" />	
                 </td>
</tr>
...
<td>From Date (Loan Approval date) : </td>
				<td>
				 <input autocomplete="off" type="text" class="datepicker1"  name="from_emi_date" id="from_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['from_emi_date'])) echo $_SESSION['cKankriyaApprovalReport']['from_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>To Date (Loan Approval date) : </td>
				<td>
				 <input autocomplete="off" type="text" class="datepicker3"  name="to_emi_date" id="to_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['to_emi_date'])) echo $_SESSION['cKankriyaApprovalReport']['to_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>Bucket(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_gt" id="win_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['win_gt'])) echo $_SESSION['cKankriyaApprovalReport']['win_gt']; else echo "0.001"; ?>" />	
                 </td>
</tr>
...
<td>Bucket(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_lt" id="win_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['win_lt'])) echo $_SESSION['cKankriyaApprovalReport']['win_lt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_gt" id="emi_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['emi_gt'])) echo $_SESSION['cKankriyaApprovalReport']['emi_gt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_lt" id="emi_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['emi_lt'])) echo $_SESSION['cKankriyaApprovalReport']['emi_lt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_gt" id="balance_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['balance_gt'])) echo $_SESSION['cKankriyaApprovalReport']['balance_gt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_lt" id="balance_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaApprovalReport']['balance_lt'])) echo $_SESSION['cKankriyaApprovalReport']['balance_lt']; ?>" />	
                 </td>
</tr>
					...
					<select id="customer_city_id" name="city_id" class="city"   onchange="createDropDownAreaReports(this.value)">
                        ...
                        <?php
                            ...
                            foreach($cities as $super)
                             ...
                             <option value="<?php echo $super['city_id'] ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['city_id'])){ if( $super['city_id'] == $_SESSION['cKankriyaApprovalReport']['city_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['city_name'] ?></option					>
                             <?php } ?>
...
<td>Area : </td>
				<td>
					<select name="area[]" class="city_area selectpicker" multiple="multiple"  id="city_area1" >
                    	 <option value="-1" >--Please Select--</option>
                          <?php
						  if(isset($_SESSION['cKankriyaApprovalReport']['city_id'])){
                            $areas = listAreasFromCityIdWithGroups($_SESSION['cKankriyaApprovalReport']['city_id']);
                            foreach($areas as $area)
                              {
                             ?>
                             
                             <option value="<?php echo $area['area_id'] ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['area_id_array'])){ if(in_array($area['area_id'],$_SESSION['cKankriyaApprovalReport']['area_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $area['area_name'] ?></option					>
                             <?php } 
						  }
							 ?>
                    </select>
					...
					<select id="agency_id" name="agency_id">
                        ...
                        <?php
                            ...
                            foreach($agencies as $super)
                             ...
                             <option value="ag<?php echo $super['agency_id'] ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['agency_id'])){ if( "ag".$super['agency_id'] == $_SESSION['cKankriyaApprovalReport']['agency_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['agency_name'] ?></option>
                             ...
                             <option value="oc<?php echo $com['our_company_id'] ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['agency_id'])){ if( "oc".$com['our_company_id'] == $_SESSION['cKankriyaApprovalReport']['agency_id'] ) { ?> selected="selected" <?php }} ?> ><?php echo $com['our_company_name'] ?></option>
					...
					<select name="broker[]" class="broker selectpicker" multiple="multiple"  id="broker" >
						  ...
						  $brokers=listBrokers();
                            ...
                            foreach($brokers as $broker)
                              {
                             ?>
                             <option value="<?php echo $broker['broker_id'] ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['broker_id_array'])){ if(in_array($broker['broker_id'],$_SESSION['cKankriyaApprovalReport']['broker_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $broker['broker_name'] ?></option					>
                             <?php } 
...
<td>
	<select id="type_rasid" name="vehicle_type[]" class="city_area selectpicker" multiple="multiple" >
                       <?php $vehicle_types= listVehicleTypes(); foreach($vehicle_types as $vehicle_type) { ?>
                             ...
                             <option value="<?php echo $vehicle_type['vehicle_type_id']; ?>" <?php if(isset($_SESSION['cKankriyaApprovalReport']['vehicle_type_array'])){ if(in_array($vehicle_type['vehicle_type_id'],$_SESSION['cKankriyaApprovalReport']['vehicle_type_array']))  { ?> selected="selected" <?php }} ?>><?php echo $vehicle_type['vehicle_type']; ?></option>
...
<tr>
	<td>File Status :</td>
    <td>
    	<input  type="radio" name="file_status" id="open" value="1" <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status'])){ if(  $_SESSION['cKankriyaApprovalReport']['file_status']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="open">Open</label>
		<input  type="radio" name="file_status" id="closed" value="2" <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status'])){ if( $_SESSION['cKankriyaApprovalReport']['file_status']==2 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed">Closed</label>
    	<input  type="radio" name="file_status" id="closed_unpaid" value="5" <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status'])){ if( $_SESSION['cKankriyaApprovalReport']['file_status']==5 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed_unpaid">Closed & unpaid</label>
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status'])){ if( $_SESSION['cKankriyaApprovalReport']['file_status']==6 ) { ?> checked="checked" <?php }} else  { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
    	<input  type="radio" name="file_status" id="both"  <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status']) && ($_SESSION['cKankriyaApprovalReport']['file_status']!=1 && $_SESSION['cKankriyaApprovalReport']['file_status']!=2 && $_SESSION['cKankriyaApprovalReport']['file_status']!=5 && $_SESSION['cKankriyaApprovalReport']['file_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
...
<tr>
    ...
    <td>
    	<input  type="radio" name="seized" id="yes" value="1"  <?php if(isset($_SESSION['cKankriyaApprovalReport']['seized'])){ if(  $_SESSION['cKankriyaApprovalReport']['seized']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="yes">Yes</label>
		<input  type="radio" name="seized" id="no" value="0" <?php if(isset($_SESSION['cKankriyaApprovalReport']['seized'])){ if( $_SESSION['cKankriyaApprovalReport']['seized']==0 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?>  /> <label style="display:inline-block;top:3px;position:relative;" for="no">No</label>
...
<tr>
    ...
    <td>
    	<input  type="radio" name="show_legal" id="legal_yes" value="1"  <?php if(isset($_SESSION['cKankriyaApprovalReport']['show_legal'])){ if(  $_SESSION['cKankriyaApprovalReport']['show_legal']==1 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="legal_yes">Yes</label>
		<input  type="radio" name="show_legal" id="legal_no" value="0" <?php if(isset($_SESSION['cKankriyaApprovalReport']['show_legal'])){ if( $_SESSION['cKankriyaApprovalReport']['show_legal']==0 ) { ?> checked="checked" <?php }}  ?> /> <label style="display:inline-block;top:3px;position:relative;" for="legal_no">No</label>
...
<tr>
	<td>View :</td>
    <td>
    	<input  type="radio" name="view_type" id="view_type_normal"  value="1"  <?php if(isset($_SESSION['cKankriyaApprovalReport']['view_type'])){ if(  $_SESSION['cKankriyaApprovalReport']['view_type']==1 ) { ?> checked="checked" <?php }} ?> checked="checked" /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="view_type_normal">TVR View</label>
		<input  type="radio" name="view_type" id="view_type_print"  value="0" <?php if(isset($_SESSION['cKankriyaApprovalReport']['view_type'])){ if( $_SESSION['cKankriyaApprovalReport']['view_type']==0 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="view_type_print">Collection Notice View</label>
...
<hr class="firstTableFinishing" />
 ...
 <?php if(isset($_SESSION['cKankriyaApprovalReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cKankriyaApprovalReport']['emi_array'];
		
	if($_SESSION['cKankriyaApprovalReport']['view_type']==1)
	{	
	 ?>    
     <div class="no_print">
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    ...
    <tbody>
		...
		foreach($emi_array as $emi)
		{
			...
			$seieze=false;
			if(($_SESSION['cKankriyaApprovalReport']['seized']==1 && $seieze) || !$seieze)
			{
		 ?>
    ...
    <tr>
    	<td> From : <?php if(isset($_SESSION['cKankriyaApprovalReport']['from']) && $_SESSION['cKankriyaApprovalReport']['from']!="") echo $_SESSION['cKankriyaApprovalReport']['from']; else echo "NA"; ?></td>
        <td> To : <?php if(isset($_SESSION['cKankriyaApprovalReport']['to']) && $_SESSION['cKankriyaApprovalReport']['to']!="") echo $_SESSION['cKankriyaApprovalReport']['to']; else echo "NA"; ?></td>
    	<td> Bucket(>=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['win_gt']) && $_SESSION['cKankriyaApprovalReport']['win_gt']!="") echo $_SESSION['cKankriyaApprovalReport']['win_gt']; else echo "NA"; ?></td>
        <td> Bucket(<=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['win_lt']) && $_SESSION['cKankriyaApprovalReport']['win_lt']!="") echo $_SESSION['cKankriyaApprovalReport']['win_lt']; else echo "NA"; ?></td>
        <td> EMI(>=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['emi_gt']) && $_SESSION['cKankriyaApprovalReport']['emi_gt']!="") echo $_SESSION['cKankriyaApprovalReport']['emi_gt']; else echo "NA"; ?></td>
        <td> EMI(<=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['emi_lt']) && $_SESSION['cKankriyaApprovalReport']['emi_lt']!="") echo $_SESSION['cKankriyaApprovalReport']['emi_lt']; else echo "NA"; ?></td>
        <td> Balance(>=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['balance_gt']) && $_SESSION['cKankriyaApprovalReport']['balance_gt']!="") echo $_SESSION['cKankriyaApprovalReport']['balance_gt']; else echo "NA"; ?></td>
        <td> balance(<=) : <?php if(isset($_SESSION['cKankriyaApprovalReport']['balance_lt']) && $_SESSION['cKankriyaApprovalReport']['balance_lt']!="") echo $_SESSION['cKankriyaApprovalReport']['balance_lt']; else echo "NA"; ?></td>
        <td> City : <?php if(isset($_SESSION['cKankriyaApprovalReport']['city_id']) && $_SESSION['cKankriyaApprovalReport']['city_id']!="") {$city=getCityByID($_SESSION['cKankriyaApprovalReport']['city_id']); echo $city['city_name']; } else echo "NA"; ?></td>
       
        <td> Agency : <?php if(isset($_SESSION['cKankriyaApprovalReport']['agency_id']) && $_SESSION['cKankriyaApprovalReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaApprovalReport']['agency_id']);  } else echo "NA"; ?></td>
        <td> File Status : <?php if(isset($_SESSION['cKankriyaApprovalReport']['file_status']) && $_SESSION['cKankriyaApprovalReport']['file_status']!="") { if($_SESSION['cKankriyaApprovalReport']['file_status']==1) echo "OPEN";else if($_SESSION['cKankriyaApprovalReport']['file_status']==2) echo "CLOSED";  } else echo "BOTH"; ?></td>
    </tr>
    </table> 
