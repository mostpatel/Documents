...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalEMIReportsPaymentDate($from,$to,$win_gt,$win_lt,$emi_gt,$emi_lt,$balance_gt,$balance_lt,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string,null,$vehicle_type_string,$from_emi_date,$to_emi_date,NULL,$_POST['view_type'],$file_id_array,$show_legal,1);
		
		$_SESSION['cKankriyaApprovalReport']['emi_array']=$reportArray;
		$_SESSION['cKankriyaApprovalReport']['from']=$from;
		$_SESSION['cKankriyaApprovalReport']['to']=$to;
		$_SESSION['cKankriyaApprovalReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaApprovalReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaApprovalReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaApprovalReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaApprovalReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaApprovalReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaApprovalReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaApprovalReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaApprovalReport']['city_id']=$city_id;
		$_SESSION['cKankriyaApprovalReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaApprovalReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaApprovalReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaApprovalReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaApprovalReport']['file_status']=$file_status;
		$_SESSION['cKankriyaApprovalReport']['seized']=$_POST['seized'];
			$_SESSION['cKankriyaApprovalReport']['show_legal']=$_POST['show_legal'];
		$_SESSION['cKankriyaApprovalReport']['view_type']=$_POST['view_type'];
