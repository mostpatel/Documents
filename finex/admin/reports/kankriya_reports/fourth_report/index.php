...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		else if($_POST['view_type']==3)
		{
			...
			{
				$bulk_notice_id=insertBulkNotices($file_id_array,2,$_POST['advocate_id']);
				header("Location: ".WEB_ROOT."admin/customer/notice/index.php?view=advocate_notice&bulk=1&id=".$bulk_notice_id);		
				exit;
			}
		}
		
		
		$reportArray=generalEMIReportsPaymentDate($from,$to,$win_gt,$win_lt,$emi_gt,$emi_lt,$balance_gt,$balance_lt,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string,NULL,$vehicle_type_string,$from_emi_date,$to_emi_date,NULL,$_POST['view_type'],$file_id_array,0);
		
		$_SESSION['cKankriyaFifthReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaFifthReport']['from']=$from;
		$_SESSION['cKankriyaFifthReport']['to']=$to;
		$_SESSION['cKankriyaFifthReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaFifthReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaFifthReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaFifthReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaFifthReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaFifthReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaFifthReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaFifthReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaFifthReport']['city_id']=$city_id;
		$_SESSION['cKankriyaFifthReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaFifthReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaFifthReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaFifthReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaFifthReport']['file_status']=$file_status;
		$_SESSION['cKankriyaFifthReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaFifthReport']['view_type']=$_POST['view_type'];
