<?php $payment_should_be_done_after_date = getTodaysDateTimeBeforeMonthsAndDays(3,25);
$payment_should_be_done_before_date = getTodaysDateTimeBeforeMonthsAndDays(3,5); ?>
<div class="jvp"><?php if(isset($_SESSION['cKankriyaFifthReport']['agency_id']) && $_SESSION['cKankriyaFifthReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaFifthReport']['agency_id']);  } ?></div>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment no_print">Advocate Notice Report (Step 5)</h4>
<?php 
...
<td>From Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="start_date" id="start_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['from'])) echo $_SESSION['cKankriyaFifthReport']['from']; ?>" />	
                 </td>
</tr>
...
<td>To Date (Payment date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="end_date" id="end_date" placeholder="Click to select Date!" class="datepicker2" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['to'])) echo $_SESSION['cKankriyaFifthReport']['to']; ?>" />	
                 </td>
</tr> -->
...
<td>From Date (EMI date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="from_emi_date" id="from_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaFifthReport']['from_emi_date'])) echo $_SESSION['cKankriyaFifthReport']['from_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>To Date (EMI date) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="to_emi_date" id="to_emi_date" placeholder="Click to select Date!"  value="<?php if(isset($_SESSION['cKankriyaFifthReport']['to_emi_date'])) echo $_SESSION['cKankriyaFifthReport']['to_emi_date']; ?>" />	
                 </td>
</tr>
...
<td>Bucket(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_gt" id="win_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['win_gt'])) echo $_SESSION['cKankriyaFifthReport']['win_gt']; else echo "0.001"; ?>" />	
                 </td>
</tr>
...
<td>Bucket(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_lt" id="win_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['win_lt'])) echo $_SESSION['cKankriyaFifthReport']['win_lt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_gt" id="emi_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['emi_gt'])) echo $_SESSION['cKankriyaFifthReport']['emi_gt']; ?>" />	
                 </td>
</tr>
...
<td>EMI(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="emi_lt" id="emi_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['emi_lt'])) echo $_SESSION['cKankriyaFifthReport']['emi_lt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_gt" id="balance_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['balance_gt'])) echo $_SESSION['cKankriyaFifthReport']['balance_gt']; ?>" />	
                 </td>
</tr>
...
<td>Balance(<=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="balance_lt" id="balance_lt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cKankriyaFifthReport']['balance_lt'])) echo $_SESSION['cKankriyaFifthReport']['balance_lt']; ?>" />	
                 </td>
</tr>
					...
					<select id="customer_city_id" name="city_id" class="city"   onchange="createDropDownAreaReports(this.value)">
                        ...
                        <?php
                            ...
                            foreach($cities as $super)
                             ...
                             <option value="<?php echo $super['city_id'] ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['city_id'])){ if( $super['city_id'] == $_SESSION['cKankriyaFifthReport']['city_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['city_name'] ?></option					>
                             <?php } ?>
...
<td>Area : </td>
				<td>
					<select name="area[]" class="city_area selectpicker" multiple="multiple"  id="city_area1" >
                    	 <option value="-1" >--Please Select--</option>
                          <?php
						  if(isset($_SESSION['cKankriyaFifthReport']['city_id'])){
                            $areas = listAreasFromCityIdWithGroups($_SESSION['cKankriyaFifthReport']['city_id']);
                            foreach($areas as $area)
                              {
                             ?>
                             
                             <option value="<?php echo $area['area_id'] ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['area_id_array'])){ if(in_array($area['area_id'],$_SESSION['cKankriyaFifthReport']['area_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $area['area_name'] ?></option					>
                             <?php } 
						  }
							 ?>
                    </select>
					...
					<select id="agency_id" name="agency_id">
                        ...
                        <?php
                            ...
                            foreach($agencies as $super)
                             ...
                             <option value="ag<?php echo $super['agency_id'] ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['agency_id'])){ if( "ag".$super['agency_id'] == $_SESSION['cKankriyaFifthReport']['agency_id'] ) { ?> selected="selected" <?php }} ?>><?php echo $super['agency_name'] ?></option>
                             ...
                             <option value="oc<?php echo $com['our_company_id'] ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['agency_id'])){ if( "oc".$com['our_company_id'] == $_SESSION['cKankriyaFifthReport']['agency_id'] ) { ?> selected="selected" <?php }} ?> ><?php echo $com['our_company_name'] ?></option>
					...
					<select name="broker[]" class="broker selectpicker" multiple="multiple"  id="broker" >
						  ...
						  $brokers=listBrokers();
                            ...
                            foreach($brokers as $broker)
                              {
                             ?>
                             <option value="<?php echo $broker['broker_id'] ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['broker_id_array'])){ if(in_array($broker['broker_id'],$_SESSION['cKankriyaFifthReport']['broker_id_array'])) { ?> selected="selected" <?php }} ?>><?php echo $broker['broker_name'] ?></option					>
                             <?php } 
...
<td>
	<select id="type_rasid" name="vehicle_type[]" class="city_area selectpicker" multiple="multiple" >
                       <?php $vehicle_types= listVehicleTypes(); foreach($vehicle_types as $vehicle_type) { ?>
                             ...
                             <option value="<?php echo $vehicle_type['vehicle_type_id']; ?>" <?php if(isset($_SESSION['cKankriyaFifthReport']['vehicle_type_array'])){ if(in_array($vehicle_type['vehicle_type_id'],$_SESSION['cKankriyaFifthReport']['vehicle_type_array']))  { ?> selected="selected" <?php }} ?>><?php echo $vehicle_type['vehicle_type']; ?></option>
...
<tr>
	<td>File Status :</td>
    <td>
    	<input  type="radio" name="file_status" id="open" value="1" <?php if(isset($_SESSION['cKankriyaFifthReport']['file_status'])){ if(  $_SESSION['cKankriyaFifthReport']['file_status']==1 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="open">Open</label>
		<input  type="radio" name="file_status" id="closed" value="2" <?php if(isset($_SESSION['cKankriyaFifthReport']['file_status'])){ if( $_SESSION['cKankriyaFifthReport']['file_status']==2 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed">Closed</label>
    	<input  type="radio" name="file_status" id="closed_unpaid" value="5" <?php if(isset($_SESSION['cKankriyaFifthReport']['file_status'])){ if( $_SESSION['cKankriyaFifthReport']['file_status']==5 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed_unpaid">Closed & unpaid</label>
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cKankriyaFifthReport']['file_status'])){ if( $_SESSION['cKankriyaFifthReport']['file_status']==6 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
    	<input  type="radio" name="file_status" id="both"  <?php if(isset($_SESSION['cKankriyaFourthReport']['file_status']) && ($_SESSION['cKankriyaFifthReport']['file_status']!=1 && $_SESSION['cKankriyaFifthReport']['file_status']!=2 && $_SESSION['cKankriyaFifthReport']['file_status']!=5 && $_SESSION['cKankriyaFifthReport']['file_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
...
<tr>
    ...
    <td>
    	<input  type="radio" name="seized" id="yes" value="1"  <?php if(isset($_SESSION['cKankriyaFifthReport']['seized'])){ if(  $_SESSION['cKankriyaFifthReport']['seized']==1 ) { ?> checked="checked" <?php }} ?> checked="checked" /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="yes">Yes</label>
		<input  type="radio" name="seized" id="no" value="0" <?php if(isset($_SESSION['cKankriyaFifthReport']['seized'])){ if( $_SESSION['cKankriyaFifthReport']['seized']==0 ) { ?> checked="checked" <?php }}  else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="no">No</label>
...
<tr>
	<td>View :</td>
    <td>
    	<input  type="radio" name="view_type" id="view_type_normal"  value="2"  <?php if(isset($_SESSION['cKankriyaFifthReport']['view_type'])){ if(  $_SESSION['cKankriyaFifthReport']['view_type']==2 ) { ?> checked="checked" <?php }} ?> checked="checked" /> <label style="display:inline-block; top:3px;position:relative;margin-right:10px;" for="view_type_normal">TVR View</label>
		<input  type="radio" name="view_type" id="view_type_print"  value="0" <?php if(isset($_SESSION['cKankriyaFifthReport']['view_type'])){ if( $_SESSION['cKankriyaFifthReport']['view_type']==0 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="view_type_print">Collection Notice View</label>
          <input  type="radio" name="view_type" id="view_type_bulk"  value="3" <?php if(isset($_SESSION['cKankriyaThirdReport']['view_type'])){ if( $_SESSION['cKankriyaThirdReport']['view_type']==3 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="view_type_bulk">Bulk Notice</label>
...
<hr class="firstTableFinishing" />
 ...
 <?php if(isset($_SESSION['cKankriyaFifthReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cKankriyaFifthReport']['emi_array'];

	if($_SESSION['cKankriyaFifthReport']['view_type']==2)
	{	
	 ?>    
     	<div class="no_print">
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    ...
    <tbody>
		...
		foreach($emi_array as $emi)
		{
			...
			$last_notice_date = getLatestNoticeDateForFileId($emi['file_id'],2);
			...
			if(($_SESSION['cKankriyaFifthReport']['seized']==1 && $seieze) || !$seieze)
			{
		 ?>
             ...
             <br />(<?php   echo $emi['balance']; 
              ...
              <td   style="word-break:break-all;min-width:150px;"><?php   if(is_array($extraCustomer) && isset($extraCustomer['extra_customer_id']) && is_numeric($extraCustomer['extra_customer_id'])) {
               ...
               <td  style="word-break:break-all;min-width:150px;"><?php  if(isset( $emi['guarantor']['guarantor_name'])) { if(validateForNull($emi['guarantor']['secondary_guarantor_name'])) echo $emi['guarantor']['secondary_guarantor_name']; else if(validateForNull($emi['guarantor']['guarantor_name'])) echo $emi['guarantor']['guarantor_name']; else echo "-"; } ?><br /><hr style="margin:5px 0px" /><?php if(isset( $emi['guarantor']['guarantor_name'])) {  $contactArray = $emi['guarantor']['contact_no']; 
                 ...
                 <td><?php echo date('d/m/Y',strtotime($last_notice_date)); ?></td>
    ...
    <tr>
    	<td> From : <?php if(isset($_SESSION['cKankriyaFifthReport']['from']) && $_SESSION['cKankriyaFifthReport']['from']!="") echo $_SESSION['cKankriyaFifthReport']['from']; else echo "NA"; ?></td>
        <td> To : <?php if(isset($_SESSION['cKankriyaFifthReport']['to']) && $_SESSION['cKankriyaFifthReport']['to']!="") echo $_SESSION['cKankriyaFifthReport']['to']; else echo "NA"; ?></td>
    	<td> Bucket(>=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['win_gt']) && $_SESSION['cKankriyaFifthReport']['win_gt']!="") echo $_SESSION['cKankriyaFifthReport']['win_gt']; else echo "NA"; ?></td>
        <td> Bucket(<=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['win_lt']) && $_SESSION['cKankriyaFifthReport']['win_lt']!="") echo $_SESSION['cKankriyaFifthReport']['win_lt']; else echo "NA"; ?></td>
        <td> EMI(>=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['emi_gt']) && $_SESSION['cKankriyaFifthReport']['emi_gt']!="") echo $_SESSION['cKankriyaFifthReport']['emi_gt']; else echo "NA"; ?></td>
        <td> EMI(<=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['emi_lt']) && $_SESSION['cKankriyaFifthReport']['emi_lt']!="") echo $_SESSION['cKankriyaFifthReport']['emi_lt']; else echo "NA"; ?></td>
        <td> Balance(>=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['balance_gt']) && $_SESSION['cKankriyaFifthReport']['balance_gt']!="") echo $_SESSION['cKankriyaFifthReport']['balance_gt']; else echo "NA"; ?></td>
        <td> balance(<=) : <?php if(isset($_SESSION['cKankriyaFifthReport']['balance_lt']) && $_SESSION['cKankriyaFifthReport']['balance_lt']!="") echo $_SESSION['cKankriyaFifthReport']['balance_lt']; else echo "NA"; ?></td>
        <td> City : <?php if(isset($_SESSION['cKankriyaFifthReport']['city_id']) && $_SESSION['cKankriyaFifthReport']['city_id']!="") {$city=getCityByID($_SESSION['cKankriyaFifthReport']['city_id']); echo $city['city_name']; } else echo "NA"; ?></td>
       
        <td> Agency : <?php if(isset($_SESSION['cKankriyaFifthReport']['agency_id']) && $_SESSION['cKankriyaFifthReport']['agency_id']!="") { echo getAgecnyIdOrOCidNameFromAgnecySelectInput($_SESSION['cKankriyaFifthReport']['agency_id']);  } else echo "NA"; ?></td>
        <td> File Status : <?php if(isset($_SESSION['cKankriyaFifthReport']['file_status']) && $_SESSION['cKankriyaFifthReport']['file_status']!="") { if($_SESSION['cKankriyaFifthReport']['file_status']==1) echo "OPEN";else if($_SESSION['cKankriyaFifthReport']['file_status']==2) echo "CLOSED";  } else echo "BOTH"; ?></td>
    </tr>
    </table> 
