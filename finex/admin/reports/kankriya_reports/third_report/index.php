...
require_once "../../../../lib/collection-list-functions.php";
...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		if($_POST['view_type']==0)
		{
			...
			{
				$bulk_notice_id=insertCollectionList($file_id_array,getTodaysDate());
			}
		...
		$_SESSION['cKankriyaFourthReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaFourthReport']['from']=$from;
		$_SESSION['cKankriyaFourthReport']['to']=$to;
		$_SESSION['cKankriyaFourthReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaFourthReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaFourthReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaFourthReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaFourthReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaFourthReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaFourthReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaFourthReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaFourthReport']['city_id']=$city_id;
		$_SESSION['cKankriyaFourthReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaFourthReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaFourthReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaFourthReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaFourthReport']['file_status']=$file_status;
		$_SESSION['cKankriyaFourthReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaFourthReport']['view_type']=$_POST['view_type'];
