...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		else if($_POST['view_type']==3)
		{
			...
			{
				$bulk_notice_id=insertBulkNotices($file_id_array,1);
				header("Location: ".WEB_ROOT."admin/customer/notice/index.php?view=notice_2&bulk=1&id=".$bulk_notice_id);		
				exit;
			}
		}
		...
		$_SESSION['cKankriyaThirdReport']['emi_array']=$reportArray;
		
		$_SESSION['cKankriyaThirdReport']['from']=$from;
		$_SESSION['cKankriyaThirdReport']['to']=$to;
		$_SESSION['cKankriyaThirdReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaThirdReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaThirdReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaThirdReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaThirdReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaThirdReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaThirdReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaThirdReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaThirdReport']['city_id']=$city_id;
		$_SESSION['cKankriyaThirdReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaThirdReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaThirdReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaThirdReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaThirdReport']['file_status']=$file_status;
		$_SESSION['cKankriyaThirdReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaThirdReport']['view_type']=$_POST['view_type'];
