...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalEMIReportsPaymentDate($from,$to,"","",$emi_gt,$emi_lt,$balance_gt,$balance_lt,$city_id,$area_id_string,$file_status,$agency_id,$broker_id_string,NULL,$vehicle_type_string,$from_emi_date,$to_emi_date,NULL,$_POST['view_type'],$file_id_array,$show_legal,3);
		
		$_SESSION['cKankriyaPercentReport']['emi_array']=$reportArray;
		$_SESSION['cKankriyaPercentReport']['from']=$from;
		$_SESSION['cKankriyaPercentReport']['to']=$to;
		$_SESSION['cKankriyaPercentReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaPercentReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaPercentReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaPercentReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaPercentReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaPercentReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaPercentReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaPercentReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaPercentReport']['city_id']=$city_id;
		$_SESSION['cKankriyaPercentReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaPercentReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaPercentReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaPercentReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaPercentReport']['file_status']=$file_status;
		$_SESSION['cKankriyaPercentReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaPercentReport']['show_legal']=$_POST['show_legal'];
		$_SESSION['cKankriyaPercentReport']['view_type']=$_POST['view_type'];
