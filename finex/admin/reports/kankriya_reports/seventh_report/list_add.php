...
$payment_should_be_done_before_date = getTodaysDateTimeBeforeMonthsAndDays(5,0); ?>
...
<h4 class="headingAlignment no_print">Seventh Report</h4>
<?php 
...
<tr>
    ...
    <td>
		...
		<input  type="radio" name="seized" id="no" value="0" <?php if(isset($_SESSION['cEMIReportPaymentDate']['seized'])){ if( $_SESSION['cEMIReportPaymentDate']['seized']==2 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="no">No</label>
