...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cKankriyaSixthReport']['emi_array']=$reportArray;
		$_SESSION['cKankriyaSixthReport']['from']=$from;
		$_SESSION['cKankriyaSixthReport']['to']=$to;
		$_SESSION['cKankriyaSixthReport']['from_emi_date']=$from_emi_date;
		$_SESSION['cKankriyaSixthReport']['to_emi_date']=$to_emi_date;
		$_SESSION['cKankriyaSixthReport']['win_gt']=$win_gt;
		$_SESSION['cKankriyaSixthReport']['win_lt']=$win_lt;
		$_SESSION['cKankriyaSixthReport']['emi_gt']=$emi_gt;
		$_SESSION['cKankriyaSixthReport']['emi_lt']=$emi_lt;
		$_SESSION['cKankriyaSixthReport']['balance_gt']=$balance_gt;
		$_SESSION['cKankriyaSixthReport']['balance_lt']=$balance_lt;
		$_SESSION['cKankriyaSixthReport']['city_id']=$city_id;
		$_SESSION['cKankriyaSixthReport']['area_id_array']=$area_array;
		$_SESSION['cKankriyaSixthReport']['broker_id_array']=$broker_array;
		$_SESSION['cKankriyaSixthReport']['vehicle_type_array']=$vehicle_type_array;
		$_SESSION['cKankriyaSixthReport']['agency_id']=$agency_id;
		$_SESSION['cKankriyaSixthReport']['file_status']=$file_status;
		$_SESSION['cKankriyaSixthReport']['seized']=$_POST['seized'];
		$_SESSION['cKankriyaSixthReport']['view_type']=$_POST['view_type'];
		$_SESSION['cKankriyaSixthReport']['reg_ad'] = $_POST['reg_ad'];
