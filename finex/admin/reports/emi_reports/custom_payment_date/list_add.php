...
<td>Bucket(>=) : </td>
				<td>
				 <input autocomplete="off" type="text"  name="win_gt" id="win_gt" placeholder="Only Digits!" value="<?php if(isset($_SESSION['cEMIReportPaymentDate']['win_gt'])) echo $_SESSION['cEMIReportPaymentDate']['win_gt']; ?>" />	
                 </td>
</tr>
					...
					<select id="bs3Select" name="group_array[]" data-live-search="true" class="city_area selectpicker" multiple="multiple" >
                        ...
                        <?php
                            ...
                            foreach($listFileGroups as $customerGroup)
                             ...
                             <option value="<?php echo $customerGroup['group_id'] ?>" <?php if(in_array($customerGroup['group_id'], $_SESSION['cEMIReportPaymentDate']['group_array'])) { ?> selected="selected" <?php } ?>> <?php echo $customerGroup['group_name'] ?>
...
<tr>
    ...
    <td>
        ...
        <input  type="radio" name="file_status" id="running" value="6" <?php if((isset($_SESSION['cEMIReportPaymentDate']['file_status']))){ if( $_SESSION['cEMIReportPaymentDate']['file_status']==6 ) { ?> checked="checked" <?php }} else { ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>     
    <div class="showColumns">
        ...
        <input class="showCB" type="checkbox" id="10" checked="checked"  /><label class="showLabel" for="10">Area</label> 
        <input class="showCB" type="checkbox" id="11" checked="checked"  /><label class="showLabel" for="11">Address</label> 
        <input class="showCB" type="checkbox" id="12" checked="checked"  /><label class="showLabel" for="12">Contact No</label>
		...
		foreach($emi_array as $emi)
		{
         ...
         <tr class="resultRow">
           ...
           <td>
            ...
            <td><?php echo getAreaNameByID($emi['area_id']); ?></td>
