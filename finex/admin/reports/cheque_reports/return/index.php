...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalChequeReturnReports($from,$to,$agency_id);
		$_SESSION['cheque_return_report']['return_array']=$reportArray;
		$_SESSION['cheque_return_report']['from']=$from;
		$_SESSION['cheque_return_report']['to']=$to;
		$_SESSION['cheque_return_report']['agency_id']=$agency_id;
