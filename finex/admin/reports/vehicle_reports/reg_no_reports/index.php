...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=generalVehicleReports($from,$to,$city_id,$area_id_string,$file_status,$agency_id);
		$_SESSION['cVehicleAddedReport']['remainder_array']=$reportArray;
		
		$_SESSION['cVehicleAddedReport']['from']=$from;
		$_SESSION['cVehicleAddedReport']['to']=$to;
		$_SESSION['cVehicleAddedReport']['remainder_status']=$remainder_status;
		$_SESSION['cVehicleAddedReport']['city_id']=$city_id;
		$_SESSION['cVehicleAddedReport']['area_id_array']=$area_array;
		$_SESSION['cVehicleAddedReport']['agency_id']=$agency_id;
		$_SESSION['cVehicleAddedReport']['file_status']=$file_status;
