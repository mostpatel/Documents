...
<tr>
    ...
    <td>
        ...
        <input  type="radio" name="file_status" id="closed_unpaid" value="5" <?php if(isset($_SESSION['cAccountReport']['file_status'])){ if( $_SESSION['cAccountReport']['file_status']==5 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="closed_unpaid">Closed & unpaid</label>
        <input  type="radio" name="file_status" id="running" value="6" <?php if(isset($_SESSION['cAccountReport']['file_status'])){ if( $_SESSION['cAccountReport']['file_status']==6 ) { ?> checked="checked" <?php }} ?> /> <label style="display:inline-block;top:3px;position:relative;" for="running">Running</label>
    	<input  type="radio" name="file_status" id="both"  <?php if(!isset($_SESSION['cAccountReport']['file_status']) || ($_SESSION['cAccountReport']['file_status']!=1 && $_SESSION['cAccountReport']['file_status']!=2 && $_SESSION['cAccountReport']['file_status']!=5 && $_SESSION['cAccountReport']['file_status']!=6)){  ?> checked="checked" <?php } ?> /> <label style="display:inline-block;top:3px;position:relative;" for="both">All</label>
    </td>
</tr>
