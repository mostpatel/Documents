...
if(isset($_GET['action']))
{
	if($_GET['action']=='add')
	{
		...
		$result=insertRtoWork($_POST["name"], $_POST["address"], $_POST["contactNo"]);
		if($result=="success")
				{
				$_SESSION['ack']['msg']="Rto Work successfully added!";
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=deleteRtoWork($_GET["lid"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Rto Work deleted Successfuly!";
		...
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$result=updateRtoWork($_POST["lid"],$_POST["name"], $_POST["address"],  $_POST["contactNo"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Rto Work updated Successfuly!";
