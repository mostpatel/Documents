<div class="addDetailsBtnStyling no_print"> <a href="index.php?view=all"><button class="btn btn-success">View All Items</button></a> <a href="index.php?view=upload"><button class="btn btn-warning">Upload New Item Excel</button></a> </div>
