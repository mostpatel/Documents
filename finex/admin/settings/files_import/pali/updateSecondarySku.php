...
<h4 class="headingAlignment no_print">Update Secondary SKU</h4>
<?php 
...
?>
<form id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=updateSkus'; ?>" method="post" onSubmit="return ValidateForm(this);" enctype="multipart/form-data">
