...
<?php
if(checkDuplicateMarkImportant($enquiry_form_id, 1))
{
...
<!-- Database generated SMS Buttons START -->

<div class="addDetailsBtnStyling no_print">

<?php
foreach($smsButtonsArray as $smsButtons)
{
?>

<a href="<?php echo WEB_ROOT ?>admin/customer/index.php?action=sendDatabaseSMS&id=<?php echo $customer_id ?>&state=<?php echo $smsButtons['custom_sms_id'] ?>&state2=<?php echo $enquiry_form_id?>">
<input type="button" value="<?php echo $smsButtons['sms_button_name'] ?>" class="btn btn-warning" />
</a>
...
<!-- Database generated SMS Buttons END -->
...
<td>1st Follow Up Date : </td>
				<td>
							 ...
							 if(date('d/m/Y H:i:s', strtotime($enquiryDetails['follow_up_date']))=="01/01/1970")
							 {
							  ...
							  echo date('d/m/Y H:i:s', strtotime($followUpDetails[0]['next_follow_up_date']));
							  }
