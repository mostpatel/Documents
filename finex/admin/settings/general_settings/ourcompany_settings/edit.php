...
<input type="text" name="name" id="txtname" value="<?php echo $company['our_company_name']; ?>"/>
 ...
 <tr>
				...
				<td class="firstColumnStyling">
                Secondary Company Name<span class="requiredField">* </span> : 
                </td>
                
                <td>
                <input type="text" name="secondary_name" id="transliterateTextarea"   value="<?php echo $company['secondary_company_name']; ?>"/>
                </td>
			</tr>
...
<tr>
<td> Rasid Counter : </td>
<td><input type="text" name="rasid_counter"  id="rasid_counter" value="<?php echo $company['rasid_counter']; ?>" /></td>
</tr> 
