...
if(isset($_GET['action']))
{
		if($_GET['action']=='add')
		{
			...
			$result=insertOurCompany($_POST["name"], $_POST["secondary_name"], $_POST["address"], $_POST["pincode"], $_POST["city"], $_POST["prefix"],$_POST['sub_heading'],$_POST["contact"]);
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['adminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=updateOurCompany($_POST["id"],$_POST["name"], $_POST["secondary_name"], $_POST["address"], $_POST["pincode"], $_POST["city"], $_POST["prefix"], $_POST['sub_heading'],$_POST["contact"],$_POST['rasid_counter']);
...
$jsArray=array("generateContactNo.js","jquery.validate.js","validators/ourCompanies.js",'jsapi',"cScript.ashx","transliteration.I.js");
