...
function listVehicleCompanies(){
	...
	try
	{
		$sql="SELECT vehicle_company_id, company_name
			  FROM edms_vehicle_company ORDER BY company_name";
		$result=dbQuery($sql);
...
function insertVehicleCompany($name){
	try
	{
		...
		{
			$sql="INSERT INTO 
				edms_vehicle_company(company_name)
				VALUES ('$name')";
		$result=dbQuery($sql);
...
function deleteVehicleCompany($id){
	...
	try
	{
		...
		{
		$sql="DELETE FROM edms_vehicle_company
...
function updateVehicleCompany($id,$name){
	...
	try
	{
		...
		{
		$sql="UPDATE edms_vehicle_company
