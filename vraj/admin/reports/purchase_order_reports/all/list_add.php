...
<td> Job Card Type  : </td>
				<td>
				  <table>
               			<tr><td><input type="radio"   name="type"  value="1" checked="checked"></td><td>Finalized</td></tr>
            			<tr><td><input type="radio"  name="type"  value="0" ></td><td>Pending</td>
               </tr> 
            		</table>  
                 </td>
</tr>
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>  
    ...
    <tbody>
		...
		else if ($job_card['type']=="SALES"  || ($job_card['type']=='RECEIPT' && $job_card['auto_rasid_type']==5 ))
		{
			...
			if(is_numeric($ledger_type) && $ledger_type==0) $type =1;
			else $type=0;
			}
			else
			$type=0;
