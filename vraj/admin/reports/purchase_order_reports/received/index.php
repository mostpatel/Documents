...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$reportArray=receivedPurchaseOrderReports($from,$to,$id);
		
		$_SESSION['cReceivedPurchaseOrderRpoert']['emi_array']=$reportArray;
		$_SESSION['cReceivedPurchaseOrderRpoert']['to']=$to;
		$_SESSION['cReceivedPurchaseOrderRpoert']['from']=$from;
		$_SESSION['cReceivedPurchaseOrderRpoert']['city_id']=$city_id;
		$_SESSION['cReceivedPurchaseOrderRpoert']['area_id_array']=$area_array;
		$_SESSION['cReceivedPurchaseOrderRpoert']['agency_id']=$agency_id_array;
		$_SESSION['cReceivedPurchaseOrderRpoert']['ledger_id']=$id;
		$_SESSION['cReceivedPurchaseOrderRpoert']['outstanding_amount']=$_POST['outstanding_amount'];
