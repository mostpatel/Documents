...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['emi_array']=$reportArray;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['to']=$to;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['from']=$from;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['city_id']=$city_id;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['area_id_array']=$area_array;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['agency_id']=$agency_id_array;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['ledger_id']=$id;
		$_SESSION['cUnreceivedPurchaseOrderRpoert']['outstanding_amount']=$_POST['outstanding_amount'];
