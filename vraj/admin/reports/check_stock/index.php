...
if(isset($_GET['action']))
{
	if($_GET['action']=='generateReport')
	{
		...
		$_SESSION['cCheckStockReport']['emi_array']=$reportArray;
		$_SESSION['cCheckStockReport']['to']=$to;
		$_SESSION['cCheckStockReport']['from']=$from;
		$_SESSION['cCheckStockReport']['city_id']=$city_id;
		$_SESSION['cCheckStockReport']['area_id_array']=$area_array;
		$_SESSION['cCheckStockReport']['agency_id']=$agency_id_array;
		$_SESSION['cCheckStockReport']['ledger_id']=$id;
		$_SESSION['cCheckStockReport']['outstanding_amount']=$_POST['outstanding_amount'];
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$_SESSION['cCheckStockReport']['emi_array']=$return_array;
