...
<hr class="firstTableFinishing" />
 ...
 <?php if(isset($_SESSION['cCheckStockReport']['emi_array']))
{
	
	$emi_array=$_SESSION['cCheckStockReport']['emi_array'];
	unset($_SESSION['cCheckStockReport']['emi_array']);	
...
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>  
    ...
    <tr>
    	<td> From : <?php if(isset($_SESSION['cCheckStockReport']['from']) && $_SESSION['cCheckStockReport']['from']!="") echo $_SESSION['cCheckStockReport']['from']; else echo "NA"; ?></td>
        <td> To : <?php if(isset($_SESSION['cCheckStockReport']['to']) && $_SESSION['cCheckStockReport']['to']!="") echo $_SESSION['cCheckStockReport']['to']; else echo "NA"; ?></td>
    </tr>
    </table> 
