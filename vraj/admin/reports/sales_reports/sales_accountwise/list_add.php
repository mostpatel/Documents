		...
		if($total_amount-$receipt_amount>=$outstanding_amount)
		{
		 ...
		 ?>
          ...
          <td class="no_print"><input type="checkbox" class="selectTR" name="selectTR"  /></td>
            ...
            <a href="<?php echo WEB_ROOT.'admin/customer/index.php?view=details&id='.$customer_id; ?>"><button title="View Customer Profile" class="btn viewBtn"><span class="view">C</span></button></a>
            </td>
        ...
        <td class="no_print"><input type="checkbox" class="selectTR" name="selectTR"  /></td>
           ...
           <td><?php echo $sales['invoice_no'] ?></td>
            ...
            <td><?php echo ($sales['amount']+$tax_amount)." Rs"; ?>
             ...
             <td align="center" ><?php echo number_format($remaining_amount)." Rs"; ?>  <br />  <?php if($type!=1 || !isset($type)) { ?> <a class="no_print" href="<?php echo WEB_ROOT.'admin/accounts/transactions/receipt/index.php?sales_id='.$job_card['sales_id'] ?>"><button title="View this entry" class="btn viewBtn btn-warning">Add Payment</button></a> <?php } ?>
            </td>
            ...
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/sales_inventory/index.php?view=details&id='.$sales['sales_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            	<?php if(is_numeric($job_card['to_customer_id'])) {?>
                                  <a href="<?php echo WEB_ROOT.'admin/customer/index.php?view=details&id='.$job_card['to_customer_id']; ?>"><button title="View Customer Profile" class="btn viewBtn"><span class="view">C</span></button></a>
                                  <?php } ?>
            </td>
