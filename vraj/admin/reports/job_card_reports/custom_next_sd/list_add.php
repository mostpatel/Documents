...
<h4 class="headingAlignment no_print">JobCard Reports By Service Date</h4>
<?php 
    	...
    	<tr>
        	...
        	<th class="heading">No</th>
             ...
             <th class="heading date">Date</th>
              <th class="heading date">Next Service</th>
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td><?php echo date('d/m/Y',strtotime($job_card['job_card_datetime'])); ?>
             ...
             <td><?php echo date('d/m/Y',strtotime($job_card['next_service_date'])); ?>
            </td>
