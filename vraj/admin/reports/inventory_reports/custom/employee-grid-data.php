...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = utf8_encode($row["item_code"]);
	$nestedData[] = utf8_encode($row["mfg_item_code"]);
	$nestedData[] = utf8_encode($row["qty_in_stock"]);
	$nestedData[] = "<span class='editable' id='$item_id'>".utf8_encode($row["godown_name"])."</span>";
	$nestedData[] = utf8_encode($row["ledger_name"]);
	$nestedData[] = utf8_encode($row["manufacturer_name"]);
