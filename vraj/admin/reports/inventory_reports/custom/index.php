...
if(isset($_GET['action']))
{
	...
	if($_GET['action']=='clearFilters')
	{
		unset($_SESSION['homePage']['supplier_id_string']);
	    unset($_SESSION['homePage']['supplier_id_array']);
		unset($_SESSION['homePage']['manufacturer_id_string']);
	    unset($_SESSION['homePage']['manufacturer_id_array']);
	...
	if($_GET['action']=='setFilters')
	{
		...
		$suppliers_array = $_POST['supplier_id'];
		$manufacturer_array = $_POST['manufacturer_id'];
		if(!empty($suppliers_array) && checkForNumeric($suppliers_array[0]))
		{
		
		$supllier_id_string = implode(",",$suppliers_array);
		$_SESSION['homePage']['supplier_id_string']=$supllier_id_string;
		$_SESSION['homePage']['supplier_id_array']=$suppliers_array;
		}
		else
		{
			unset($_SESSION['homePage']['supplier_id_string']);
		...
		if(!empty($manufacturer_array) && checkForNumeric($manufacturer_array[0]))
		{
		$manufacturer_id_string = implode(",",$manufacturer_array);
		$_SESSION['homePage']['manufacturer_id_string']=$manufacturer_id_string;
		$_SESSION['homePage']['manufacturer_id_array']=$manufacturer_array;
		}
		else
		{
			unset($_SESSION['homePage']['manufacturer_id_string']);
	...
	if($_GET['action']=='generateReport')
	{
		...
		$to = date('d/m/Y',strtotime(getNextDate($to)));
		
		$reportArray=getClosingStockForDateItemwise($to);
...
$selectedLink="home";
$jsArray=array("jquery.validate.js","dropDown.js","jquery-ui/js/jquery-ui.min.js","customerDatePicker.js","calculateTotalSalesReport.js");
