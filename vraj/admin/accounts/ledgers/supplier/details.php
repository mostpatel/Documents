...
<h4 class="headingAlignment">Supplier Details</h4>
<?php 
...
<td></td>
<td>
<a href="<?php echo WEB_ROOT ?>admin/accounts/ledgers/supplier/index.php?view=edit&lid=<?php echo $ledger_id; ?>"><input type="submit" value="Edit" class="btn btn-warning" /></a>
<a href="<?php echo WEB_ROOT ?>admin/accounts/ledgers/supplier"><input type="button" value="back" class="btn btn-success" /></a>
</td>
</tr>
</table>
</form>
