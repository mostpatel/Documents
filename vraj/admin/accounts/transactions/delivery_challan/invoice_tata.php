...
<div class="mainInvoiceContainer" style="width:95%;page-break-after: always;">
   ...
   <div class="sectionOne">
       ...
       <div class="leftSectionOne" style="padding-top:6%">
          ...
          <div class="rightSectionOne">
             ...
             <img src="<?php echo WEB_ROOT."images/eni-logo-new.png" ?>" style="max-width:500px;float:right;top:20px;position:relative" id="tata_logo" />   
