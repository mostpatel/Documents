...
<span style="width:95%;text-align:center;font-size:30px;text-transform:uppercase;position:relative;display:block;"><?php echo $our_company['our_company_name']; ?></span>
<span style="width:95%;text-align:center;font-size:20px;text-transform:uppercase;position:relative;display:block;">S/9, Silver point,
Nr. Nidhi Hospital,Navrangpura, Ahmedabad.</span>
</div>
<?php } ?>
   <div class="sectionOne" style="min-height:0;border-bottom:0;<?php if(!isset($_GET['show_header'])) { ?> margin-top:220px;  <?php } ?>">
       ...
       <div class="leftSectionOne" style="width:69.75%;text-align:left;padding:0;box-sizing:border-box;">
      
            
            <div style="border:1px solid black;height:125px;height:125px;padding-left:5px;">
           ...
           <?php if(is_numeric($sales['to_ledger_id']))  echo getLedgerNameFromLedgerId($sales['to_ledger_id']); else
		{
          ...
          <div class="rightSectionOne" style="width:30%;float:right;padding:0;border-right:none;border:1px solid black;height:125px;">
          		
                
          		<table class="sales_info_table" width="100%"  style="border-top:0;border-bottom:0;border-right:0;border-left:0;"  >
                <tr>
                <td style="border-bottom:1px solid black;padding-left:5px;height:62.5px;font-size:18px;font-weight:bold;" valign="middle">
                	  Bill No : <b><?php echo $sales['invoice_no']; ?></b>
                </td>
                </tr>
                <tr>
                <td style="padding-left:5px;font-size:18px;font-weight:bold;" valign="middle">Bill Date : <b> <?php echo date('d/m/Y',strtotime($sales['trans_date'])); ?></b>
        </td>
            </tr>
            </table>
        ...
        <div style="text-align:center;width:100%;padding-top:5px;padding-bottom:5px;border:1px solid black;border-bottom:none;margin-top:5px;box-sizing:border-box;">
        	Dear Sir, &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; I present herewith the statement of my fees for proofessional service rendered.
        </div>
        ...
        <div class="sectionFour" style="margin:0">
          ...
          <table class="vaibhavTable" style="border-right:1px solid #000;border-left:1px solid #000;">
            ...
            <td align="left"> <b><?php echo getItemNameFromItemId($inventory_item['item_id']); ?><?php echo $inventory_item['item_desc'] ?></b></td>
		...
		else
		{
            ...
            <td align="left"> <b><?php echo getItemNameFromItemId($inventory_item['item_id']); ?> F.Y. <?php echo $inventory_item['item_desc'] ?></b> </td>
           
            <td style="border-right:none;font-weight:bold;"> <?php  echo round($inventory_item['net_amount'],2); ?> </td>
            </tr>
        ...
        <?php $total_rows=$i;
            ...
            <td style="border-right:none;"> <b><?php  if($page==$no_of_pages-1) { ?><?php echo number_format(round($total),2); ?><?php } ?></b> </td>
