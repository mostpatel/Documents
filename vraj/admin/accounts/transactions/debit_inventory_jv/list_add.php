...
<h4 class="headingAlignment">Inwards Inventory JV </h4>
<?php 
...
?>
<form  name="f" onsubmit="return submitPayment();" id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=add'; ?>" method="post" enctype="multipart/form-data" >
<input type="hidden" name="oc_id" value="<?php echo $oc_id ?>" />
<table id="insertInsuranceTable" class="insertTableStyling no_print">

<tr>
<td width="160px">Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="payment_date" id="payment_date" class="datepicker1" placeholder="click to select date!" value="<?php echo date('d/m/Y',strtotime(getTodaysDate())); ?>" autofocus /><span class="DateError customError">Please select a date!</span>
                            </td>
</tr>
...
<td>Ledger / Customer <span class="requiredField">* </span> : </td>
				<td>
					<input type="text" id="to_ledger" name="to_ledger_id" placeholder="Start Typing For Suggestions" /> 
...
<h4 class="headingAlignment">Inwards (Min One Item Required)</h4>
<table width="100%" style="margin-top:20px;margin-bottom:20px;">
<tr>
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable ns_inventory_table" id="productPurchaseTable">
    		<tr>
            ...
            <tbody style="display:none" id="p0">
            	<tr>
                    <td><input onkeypress="return SendTab(document.forms['f'], this, event);" type="text" name="ns_item_id[]" class="inventory_item_autocomplete1" placeholder="Select Only From Avl Suggestions" /></td>
                      <td><select class="selectpicker" name="ns_godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);">
                      ...
                      <?php  $godowns = listGodowns();
                         ...
                         <td><input type="text" name="ns_quantity[]" class="item_quantity" style="width:25px;" value="1" onchange="onchangeQuantity(this);" /><span style="color:#f00;font-size:12px;"></span><select style="width:50px;display:none;" name="unit_id[]" class="item_unit">
            ...
            <tbody id="ns<?php echo $i; ?>">
            	<tr >
                    <td><input type="text" onkeypress="return SendTab(document.forms['f'], this, event);" name="ns_item_id[]" class="inventory_item_autocomplete" placeholder="Select Only From Avl Suggestions"  /></td>
                    <td><select class="selectpicker" name="ns_godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);">
...
<td>
<textarea name="remarks" placeholder="Your Remarks Go Here.." id=""></textarea>
</td>
</tr>
...
<td width="160px"></td>
<td>
<input id="disableSubmit" type="submit" value="Add Inwards JV"  class="btn btn-warning">
...
<h4 class="headingAlignment">List of Inventory Inwards</h4>
