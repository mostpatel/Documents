	...
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable" id="productPurchaseTable">
            ...
            <tbody style="display:none" id="p0">
            	<tr>
                    <td><input onkeypress="return SendTab(document.forms['f'], this, event);" type="text" name="ns_item_id[]" class="inventory_item_autocomplete1" /></td>
            ...
            <tbody id="ns<?php echo $i; ?>">
            	<tr >
                    <td><input onkeypress="return SendTab(document.forms['f'], this, event);" type="text" name="ns_item_id[]" class="inventory_item_autocomplete" value="<?php echo getUPCFromItemId($sales_item['item_id']); ?>"  /></td>
                    ...
                    <td><input type="text" name="ns_quantity[]" class="item_quantity" style="width:35px;"  onchange="onchangeQuantity(this);" value="<?php echo $sales_item['quantity']; ?>" <?php if($in_use==1) { ?> readonly title="Delete Further Transaction to Edit!" <?php } ?> /><span style="color:#f00;font-size:12px;"><?php echo getRemainingQuanityForItemForDate($sales_item['item_id'],$sales_item['godown_id']); ?></span></td>
                     <td><input type="text" name="ns_rate[]" class="item_rate" style="width:55px;" value="<?php echo $sales_item['rate']; ?>" onchange="onchangeRate(this);" /></td>
            ...
            <tbody id="p<?php echo $i; ?>">
            	 <tbody id="p<?php echo $i; ?>">
            	<tr >
                    <td><input onkeypress="return SendTab(document.forms['f'], this, event);" type="text" name="ns_item_id[]" class="inventory_item_autocomplete" /></td>
                    <td><select class="selectpicker" name="ns_godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);">
