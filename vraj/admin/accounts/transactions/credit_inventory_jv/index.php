		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,$admin_rights)))
			{
						...
						$result=insertInventoryJV($_POST["item_id"],$_POST['rate'],$_POST['quantity'],$_POST["ns_item_id"],$_POST['ns_rate'],$_POST['ns_quantity'],$_POST['payment_date'],$_POST['remarks'],$_POST['godown_id'],$_POST['ns_godown_id'],$_POST['jv_type'],2,$to_ledger_id); // $cheque_return is 0 when inserting a payment			
				...
				if(checkForNumeric($result))
				{
					...
					header("Location: ".WEB_ROOT."admin/accounts/transactions/credit_inventory_jv/index.php");
					exit;
				}
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				...
				header("Location: ".WEB_ROOT."admin/accounts/transactions/credit_inventory_jv/index.php?view=details&id=".$_GET['lid']);
				exit;
				}
			}
			else
		...
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				...
				$to_ledger_id=getCustomerLedgerIDFromLedgerNameLedgerId($_POST['to_ledger_id']);
				$result=updateInventoryNonStockItemJV($_POST["id"],$_POST["item_id"],$_POST['rate'],$_POST['quantity'],$_POST["ns_item_id"],$_POST['ns_rate'],$_POST['ns_quantity'],$_POST['payment_date'],$_POST['remarks'],$_POST['godown_id'],$_POST['ns_godown_id'],$_POST['jv_type'],$to_ledger_id);
				if($result=="success")
				{	
				$_SESSION['ack']['msg']="Inventory JV updated Successfuly!";
				$_SESSION['ack']['type']=2; // 2 for update
				header("Location: ".WEB_ROOT."admin/accounts/transactions/credit_inventory_jv/index.php?view=details&id=".$_POST['id']);
				exit;
				}
				else{
			...
			{	
					$_SESSION['ack']['msg']="Authentication Failed! Not enough access rights!";
					$_SESSION['ack']['type']=5; // 5 for access
					header("Location: ".WEB_ROOT."admin/accounts/transactions/credit_inventory_jv/index.php?view=details&id=".$_POST['lid']);
				exit;
			}
