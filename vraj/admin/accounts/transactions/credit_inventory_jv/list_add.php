...
<h4 class="headingAlignment">Outwards Inventory Transaction </h4>
<?php 
	...
	<td >
    	<table width="100%" class="adminContentTable productPurchaseTable inventory_table" id="productPurchaseTable">
            ...
            <tbody style="display:none" id="p0">
            	<tr>
                    <td>
                    	<input onkeypress="return SendTab(document.forms['f'], this, event);" name="item_id[]" type="text" class="inventory_item_autocomplete1" placeholder="Select Only From Avl Suggestions"  /></td>
                      <td><select class="selectpicker" name="godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);" >
                    ...
                    <td><input type="text" name="quantity[]" class="item_quantity" style="width:35px;" value="1" onchange="onchangeQuantity(this);" /><span style="color:#f00;font-size:12px;"></span><select style="width:50px;display:none;" name="unit_id[]" class="item_unit">
            ...
            <tbody id="p<?php echo $i; ?>">
            	<tr >
                    <td>
                    	<input onkeypress="return SendTab(document.forms['f'], this, event);" type="text" name="item_id[]" class="inventory_item_autocomplete" placeholder="Select Only From Avl Suggestions"  /></td>
                     <td><select class="selectpicker"  name="godown_id[]" style="width:150px;" onchange="getRateQuantityAndTaxForSalesFromGodwonId(this.value,this);" >
                    ...
                    <td><input type="text" name="quantity[]" class="item_quantity" style="width:35px;" value="1" onchange="onchangeQuantity(this);" /><span style="color:#f00;font-size:12px;margin-left:2px;margin-right:2px;"></span><select style="width:100px;display:none;" name="unit_id[]" class="item_unit">
                    	<option value="-1">-- Unit --</option>
                    </select></td>
                     <td><input type="text" name="rate[]" class="item_rate" style="width:35px;" value="0" onchange="onchangeRate(this);" /></td>
                     <td><input type="text" class="item_amount uneditable-input" style="width:75px;" disabled="disabled" value="0"  /></td>
...
<td width="160px"></td>
<td>
<input id="disableSubmit" type="submit" value="Add Ourwards JV"  class="btn btn-warning">
