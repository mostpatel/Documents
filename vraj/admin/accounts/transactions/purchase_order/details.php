...
$regular_ns_items = getNonStockItemForPurchaseOrderId($purchase_id);

}
else
exit; ?>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment"> Purchase Order Details</h4>
<?php 
...
<tr>
<td width="220px">Purchase Order Date : </td>
				<td>
...
<td>Po Number : </td>
				<td>
                    ...
                    <?php
				echo 	$purchase['purchase_order_ref'];
					?>
...
<td>Supplier : </td>
				<td>
                    ...
                    <?php
				echo 	getLedgerNameFromLedgerId($purchase['from_ledger_id']);
					?>
...
<h4 class="headingAlignment">Items</h4>
...
<a href="<?php echo WEB_ROOT."admin/accounts/transactions/purchase_order" ?>"><input type="button" class="btn btn-success" value="Back"/></a>
</td>
</tr>
