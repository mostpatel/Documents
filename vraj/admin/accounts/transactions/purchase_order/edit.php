...
?>
<form onsubmit="return submitPayment();" name="f" id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=edit'; ?>" method="post" enctype="multipart/form-data" >
    	...
    	<table width="100%" class="adminContentTable productPurchaseTable" id="productPurchaseTable">
    		<tr>
            	<th>Item Name / Code</th>
                 ...
                 <th style="display:none;">Shelf</th>
                 <th></th>
            </tr>
            ...
            <tbody id="p<?php echo $i; ?>">
            	<tr >
                    <td><input name="item_id[]" type="text" class="inventory_item_autocomplete" value="<?php echo getFullItemNameFromItemId($purchase_item['item_id'],1); ?>" onkeypress="return SendTab(document.forms['f'], this, event);" /></td>
