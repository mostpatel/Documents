...
$sales=getRecentlyAddedPurchaseOrders();
 ?>
<div class="addDetailsBtnStyling no_print">  <a href="index.php?view=upload"><button class="btn btn-warning">Upload New Item Excel</button></a> </div>
<div class="insideCoreContent adminContentWrapper wrapper">
<h4 class="headingAlignment"> Purchase Order </h4>
<?php 
...
?>
<form onsubmit="return submitTransaction(1);" id="addLocForm" action="<?php echo $_SERVER['PHP_SELF'].'?action=add'; ?>" method="post" enctype="multipart/form-data" name="f" >
...
<td width="220px">PO Number<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="purchase_order_ref" id="purchase_order_ref" value="<?php echo $purchase['purchase_order_ref']; ?>" />
                            </td>
</tr> 
    	...
    	<table width="100%" class="adminContentTable productPurchaseTable" id="productPurchaseTable">
    		<tr>
            	<th>Item Name / Code</th>
                 ...
                 <th style="display:none;">Godown</th>
                 <th></th>
            </tr>
            <tbody style="display:none" id="p0">
            	<tr>
                    <td><input name="item_id[]" type="text" class="inventory_item_autocomplete1" onkeypress="return SendTab(document.forms['f'], this, event);" /></td>
                    <td><input type="text" name="quantity[]" class="item_quantity1" style="width:35px;" value="1" onchange="onchangeQuantity(this);" /><span style="color:#f00;font-size:12px;"></span></td>
                     <td><input type="text" name="rate[]" class="item_rate1" style="width:35px;" value="0" onchange="onchangeRate(this);" /></td>
            ...
            <tbody id="p<?php echo $i; ?>">
            	<tr >
                    <td><input name="item_id[]" type="text" class="inventory_item_autocomplete" onkeypress="return SendTab(document.forms['f'], this, event);" /></td>
...
<td>purchase Ref<span class="requiredField">* </span> : </td>
				<td>
...
<td width="250px;"></td>
<td>
<input id="disableSubmit" type="submit" value="Add Purchase Order"  class="btn btn-warning">
...
<h4 class="headingAlignment">List of Recently Added Purchase Orders </h4>
<div class="printBtnDiv no_print"><button class="printBtn btn"><i class="icon-print"></i> Print</button></div>
    ...
    <tbody>
		...
		foreach($sales as $receipt)
		{
			...
			{
				$debit_name = getLedgerNameFromLedgerId($receipt['from_ledger_id']);
			}
			else 
			{
				$debit_name = getCustomerNameByCustomerId($receipt['from_customer_id']);
			}
		 ?>
          <tr class="resultRow">
        	<td><?php echo ++$no; ?>
            ...
            <td><?php echo $receipt['purchase_order_ref']; ?>
            </td>
            <td><?php echo $debit_name; ?>
            </td>
          	 
           
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/purchase_order/index.php?view=details&id='.$receipt['purchase_order_id'] ?>"><button title="View this entry" class="btn viewBtn"><span class="view">V</span></button></a>
            </td>
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/purchase_order/index.php?view=edit&id='.$receipt['purchase_order_id']; ?>"><button title="Edit this entry" class="btn splEditBtn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/accounts/transactions/purchase_order/index.php?action=delete&lid='.$receipt['purchase_order_id'];  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
