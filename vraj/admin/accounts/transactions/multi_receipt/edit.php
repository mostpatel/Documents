...
<td width="220px">Payment Date<span class="requiredField">* </span> : </td>
				<td>
					<input type="text" name="payment_date" id="payment_date" class="datepicker1" placeholder="click to select date!" value="<?php echo date('d/m/Y',strtotime($payment[0]['trans_date'])); ?>" autofocus="autofocus"/><span class="DateError customError">Please select a date!</span>
                            </td>
</tr>
...
<td width="220px">Receipt Type<span class="requiredField">* </span> : </td>
				<td>
                   ...
                   <select class="ref_type" name="ref_type[]" onchange="changeRefFeildMulti(this)" >
                        ...
                        <option value="2"  <?php if($p['receipt_ref_type']==2) { ?> selected="selected" <?php } ?> >Against Sales</option>
...
<td>Receipt Ref<span class="requiredField">* </span> : </td>
				<td>
					...
					$label = $s['invoice_no']." ".date("d/m/Y",strtotime($s['trans_date']))." ".$s['outstanding_amount']." Rs";
						 ?>
					<option value="<?php echo $s['sales_id'] ?>" <?php if($p['receipt_ref']==$s['sales_id']) { ?> selected="selected" <?php } ?>><?php echo $label; ?></option>
