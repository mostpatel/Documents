...
<tr>
<tr>
            <td> Tax Invoice Counter<span class="requiredField">* </span> : </td>
            <td> <input id="txtsubheading" type="text" name="tax_invoice_counter" value="<?php echo $company['tax_invoice_counter']; ?>"/> </td>
            </tr>
            

<tr>
<tr>
            <td> Retail Invoice Counter<span class="requiredField">* </span> : </td>
            <td> <input id="txtsubheading" type="text" name="retail_invoice_counter" value="<?php echo $company['invoice_counter']; ?>"/> </td>
            </tr>
