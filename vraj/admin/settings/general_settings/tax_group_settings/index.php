...
if(isset($_GET['action']))
{
	...
	{ 
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(2,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=insertTaxGroup($_POST["group_name"],$_POST['display_name'],$_POST["tax_array"],$_POST['tax_class_id']);
				if($result!="error")
				{
				$_SESSION['ack']['msg']="Tax Group successfully added!";
	...
	if($_GET['action']=='delete')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(4,$admin_rights) || in_array(7,					$admin_rights)))
			{	
				$result=deleteTaxGroup($_GET["lid"]);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Tax Group deleted Successfuly!";
				$_SESSION['ack']['type']=3; // 3 for delete
				}
				else
				{
					$_SESSION['ack']['msg']="Cannot delete Tax Group! Tax Group already in use!";
	...
	if($_GET['action']=='edit')
	{
		if(isset($_SESSION['edmsAdminSession']['admin_rights']) && (in_array(3,$admin_rights) || in_array(7,					$admin_rights)))
			{
				$result=editTaxGroup($_POST["lid"],$_POST["grp_name"],$_POST['display_name'],$_POST["tax_array"],$_POST['tax_class_id']);
				if($result=="success")
				{
				$_SESSION['ack']['msg']="Tax Group updated Successfuly!";
...
$jsArray=array("generateContactNo.js","jquery.validate.js","validators/tax_group.js","jquery.jeditable.js","editable/branchname.js");
