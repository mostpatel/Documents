...
<a href="<?php echo  WEB_ROOT."admin/customer/index.php?view=details&id=".$customer['customer_id']; ?>"><input type="button" class="btn btn-success" value="Back"/></a>
		...
		foreach($receipts as $receipt)
		{
		 ...
		 ?>
          <tr class="resultRow">
            ...
            <td class="no_print"> <a href="<?php echo WEB_ROOT.'admin/customer/financer_receipt/index.php?view=edit&id='.$receipt['receipt_id']; ?>"><button title="Edit this entry" class="btn splEditBtn"><span class="delete">E</span></button></a>
            </td>
            <td class="no_print"> 
            <a href="<?php echo WEB_ROOT.'admin/customer/financer_receipt/index.php?action=delete&lid='.$receipt['receipt_id'].'&customer_id='.$customer_id;  ?>"><button title="Delete this entry" class="btn delBtn"><span class="delete">X</span></button></a>
            </td>
